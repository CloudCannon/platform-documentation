...
<comp.DocShot docshot_key="CloudCannon-Documentation-CloudCannon-Documentation-Content-Editor-Sidebar" alt="A screenshot of the Content Editor sidebar shows several Inputs for editing structure data in a file." title="The Content Editor sidebar" type="ui-snippet"/>
