...
Just like the Visual Editor, the Content Editor has a sidebar on the left of the editing interface for editing structured data in the front matter of your markup file. Front matter fields contain data that does not appear in the main body of the content. You can open or close the sidebar using the arrow button on the right of the panel.
