...
In this guide we’ll cover how to create an account, create your first site, turn SvelteKit into an SSG and update it to use file data, and configure SvelteKit for the best CloudCannon experience.
