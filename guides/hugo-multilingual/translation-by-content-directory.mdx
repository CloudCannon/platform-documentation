...
<comp.Annotation number="1">
  This assigns all branch index files within the `path` to this collection. The assigned collection changes how the `filter`
   is handled, as well as what input configuration and schemas are applied.
  
  In this case, the `content/*/blog/_index.md` are part of this collection, rather than the Posts collection of that language.
</comp.Annotation>
