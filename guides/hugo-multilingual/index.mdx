...
The approach you choose does change the editing experience, as CloudCannon collections are based around folders. This guide outlines the best practices for each approach.
