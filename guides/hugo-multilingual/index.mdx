...
The approach you choose is your preference. It does change the editing experience as CloudCannon collections are based around folders. This guide outlines the best practices for each approach.

Note that Hugo does not support using both approaches at the same time, so only choose one.
