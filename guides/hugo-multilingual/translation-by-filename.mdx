...
related_links: null
---
This approach is when you have a language specified per file, as an extension prefix (e.g. `content/blog/my-post.es.md`). Hugo calls this [Translation by filename](https://gohugo.io/content-management/multilingual/#translation-by-filename).
