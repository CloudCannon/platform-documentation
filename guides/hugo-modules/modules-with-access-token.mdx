...
related_links:
---
Some Hugo Modules won't be a good fit for [Site Mounting](/documentation/articles/site-mounting/), particularly if they are hosted on a private repository and require a complex setup. In this case, we can configure your CloudCannon site to install private Hugo Modules.
