...
By default, these files are accessible on this site's [Testing Domain](/documentation/articles/testing-domain/). To prevent access to the testing domain, switch the module site to [password authentication](/documentation/articles/enable-password-authentication/) and do not set a password.
