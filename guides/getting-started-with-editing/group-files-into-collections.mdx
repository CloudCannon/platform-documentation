...
Use the checkboxes next to each folder to indicate which *Collections* you want to add to your *Site*. When you select a folder, CloudCannon will update the
