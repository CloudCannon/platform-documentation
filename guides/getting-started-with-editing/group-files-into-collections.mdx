...
The name of each *Collection* is the *Key* in title case form (i.e., `travel_blog` becomes "Travel Blog"). You can override this by configuring a *Display Name* later (we cover this in the [Configure your Collections](/documentation/guides/configure-your-collections/) guide).
