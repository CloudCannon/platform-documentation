...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Dashboard-Tour-Collections-Task" alt="A screenshot of the Tour a Collection Browser task in the Getting Started in-app guide shows a Start your tour button." title="The Site Dashboard" type="screenshot"/>
...
The *View* *menu* allows you to change how your files appear in the *Collection Browser*. You can switch between three view options: *List*, *Cards*, and *Gallery*.
