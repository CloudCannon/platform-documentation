...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Dashboard-No-Collections" alt="A screenshot of the Site Dashboard shows the Getting Started in-app guide and a purple Add Collections button in the Site Navigation." title="The Site Dashboard" type="screenshot"/>
