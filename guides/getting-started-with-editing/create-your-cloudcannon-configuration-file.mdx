...
You might also notice a new UI element next to the *Save* button. This is the *Configuration Mode* switch. Now that we have a *Configuration File*, we can use *Configuration Mode* to customize our *Site* and store our preferences. Let's start by grouping the files we want to edit into *Collections* and reviewing them in a user-friendly interface called a *Collection Browser*.

In the next step of this guide, we'll cover *Collections*, including what they are and how to add them to your *Site Navigation* using *Configuration Mode*.