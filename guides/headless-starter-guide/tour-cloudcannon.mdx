...
<comp.CommonContent data={{ _file: "/usr/local/__site/src/_common_content/starter-guides/tour-cloudcannon.mdx" }}>
  ...
  <comp.SlotContent name="Collections-tour">
    All your <a href="https://cloudcannon.com/documentation/articles/what-is-a-collection/" target="_blank" rel="noopener">Collections</a> are the are listed in your *Site Navigation*. We encountered Collections in the configuration file section of this guide, but if you need a reminder, a Collection is a group of related content (e.g., a folder of blog article or product descriptions).
