...
In this guide, you will create two users: one from CloudCannon to S3, and one from S3 to imgix. We recommend naming these users them some variant of “CloudCannon-to-S3” and “S3-to-imgix”. As CloudCannon and imgix require different permissions to function, we recommend creating separate policies.

This ensures that CloudCannon has access to upload to your S3 DAM and preview your assets, while imgix only has the permissions required to serve your assets.
...
<comp.Notice info_type="info">
  ...
  * In Step Six and Seven of this guide, use the Access Key ID and Secret Access Key of your single user to give imgix and CloudCannon the same access to your S3 content.
</comp.Notice>