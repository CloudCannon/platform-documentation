...
<comp.Notice info_type="important">
  Earlier in this guide, we created two S3 users. When you connect your Amazon S3 DAM to CloudCannon, make sure to use the *Access Key ID* and *Secret Access Key* from the CloudCannon-to-S3 user.
</comp.Notice>
...
8. Enter the *Access Key ID* and *Secret Access Key* from your IAM user in the *IAM Access Key* and *IAM Access Secret* fields, respectively. If you chose to create two users, select the keys from the CloudCannon-to-S3 user.
