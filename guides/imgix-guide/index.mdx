...
This guide assumes you already have IMGIX and AWS S3 accounts, as well as an Amazon S3 bucket. To create an Amazon S3 bucket, please read the [AWS documentation](https://docs.aws.amazon.com/AmazonS3/latest/userguide/creating-bucket.html).