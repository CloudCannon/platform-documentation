...
To power the live editing experience, Bookshop depends on a few extra packages. Unlike the previous plugin we installed, these dependencies have no impact on your production site: they only provide Bookshop tooling locally on your machine and within the CloudCannon Visual Editor.
...
And a layout that uses that frontmatter to render a component:
