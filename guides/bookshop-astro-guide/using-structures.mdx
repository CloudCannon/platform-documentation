...
To get started with CloudCannon structures we first need to add Bookshop data files for our components.
The Bookshop data file for a component is created next to that component and has the same name. If you're
