...
<comp.CommonContent data={{ _file: "/usr/local/__site/src/_common_content/starter-guides/starter-guide-step-3.mdx" }}>
  <comp.SlotContent name="SSG_Organization_Strictness_Paragraph">
    ...
    With your content nicely organized, you'll then need to fetch this data into your page components. This can be done by using <a rel="noopener noreferrer" href="https://www.gatsbyjs.com/docs/how-to/querying-data/page-query/#add-the-graphql-query">Gatsby's GraphQL queries</a>.
  </comp.SlotContent>
</comp.CommonContent>