...
<comp.CommonContent data={{ _file: "/usr/local/__site/src/_common_content/starter-guides/starter-guide-step-7.mdx", SSG_Name: "Hugo" }}>
  <comp.SlotContent name="SSG_Snippets_Paragraph">
    ...
    We’ve talked about Snippets earlier in the guide, but now is your opportunity to set up custom Snippets! To get started, read our <a rel="noopener noreferrer" target="_blank" href="https://cloudcannon.com/documentation/articles/editing-with-hugo-shortcodes/#custom-hugo-shortcodes">Custom Hugo Shortcodes guide</a> or <a rel="noopener noreferrer" target="_blank" href="https://cloudcannon.com/documentation/support/">reach out to our support team</a>.
