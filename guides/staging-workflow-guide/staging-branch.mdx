...
"Publishing" is the term CloudCannon uses for merging one branch into another. For more details, read [our documentation on publishing](/documentation/articles/setting-up-a-publish-branch-with-merging-or-pull-requests/).
