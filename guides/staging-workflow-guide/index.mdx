...
One of the advantages of using CloudCannon is being able to leverage workflows from Git when maintaining your site. This guide will talk about the benefits of a staging workflow, then explore how to set this up in CloudCannon.
...
One of the most obvious advantages of this workflow is that it allows you to work on the site without the end users seeing any unfinished changes.
