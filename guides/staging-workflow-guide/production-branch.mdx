...
The `production` branch is what you show to your end-users. You might do this by [adding a Custom Domain in CloudCannon](/documentation/articles/what-is-a-custom-domain/) or [outputting the built files to another Git branch to be hosted elsewhere](/documentation/articles/configure-build-deploys/).
