...
The `production` branch is what you show to your end-users. You might do this by [adding a custom domain in CloudCannon](/documentation/articles/hosting-your-site-on-a-custom-domain/) or [outputting the built files to another Git branch to be hosted elsewhere](/documentation/articles/output-a-built-site-from-cloudcannon-to-an-external-provider/).
