...
It's best to explicitly specify which version of Rosey you want to run, to ensure your CloudCannon build matches what your local development environment. Consider adding `rosey` as a dependency in your package.json.
