...
For this step of the guide, we need to copy some details from the *Single Sign-On* page on CloudCannon into Okta: the *Consume URL (SSO URL)*, which Okta calls the *Single sign-on URL*. The *Consume URL* on the *Single Sign-On* page should look like `https://app.cloudcannon.com/saml/xxxxx/consume`, except the `x` characters will be your CloudCannon Organization ID.
