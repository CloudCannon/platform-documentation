...
If you followed the previous [Getting set up](/documentation/articles/getting-set-up/) section of this guide,
...
Here's a hypothetical component that uses a bit more liquid syntax:
