...
These are the main keys that should be specified to define a component, see the full
list of `spec` keys in the [Bookshop reference](/TODO).
...
Component blueprints contain some other powerful features for helping create your Structures. We'll cover some of
those in [Nesting components](/TODO), and the full feature set can be found in the [Bookshop reference](/TODO).
