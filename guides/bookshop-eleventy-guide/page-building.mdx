...
Once you have a few more components built out, an ideal frontmatter section might look like:
...
content_blocks:
  ...
  - _bookshop_name: image
    ...
    image_alt: The bird that screams loudest and most persistenly gets to own the branch
...
In this setup, each component individually will update to changes live,
...
instead in the `shared/eleventy` folder. This is a location for you to put templating
