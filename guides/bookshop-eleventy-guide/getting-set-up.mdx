...
After running this command, the following directory structure should have been created:
...
To connect Bookshop and Eleventy, the `@bookshop/eleventy-bookshop` plugin on npm should be installed and added to your config:
...
<comp.Annotation number="1">
   Make sure that `bookshopLocations` points to the component library
you just created, relative to your Eleventy source.
</comp.Annotation>
