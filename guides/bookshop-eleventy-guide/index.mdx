...
As a developer working locally, Bookshop firstly provides an Eleventy plugin that is used to load your components.
...
use the templating language of your SSG, and in most cases can be migrated from your existing templating directly.
