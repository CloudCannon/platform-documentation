...
One thing to note is that Bookshop is tied to [CloudCannon's collection model](https://cloudcannon.com/documentation/articles/define-your-collections/), not Eleventy's.
