...
One thing to note is that Bookshop is tied to [CloudCannon's collection model](https://cloudcannon.com/documentation/articles/defining-your-collections/), not Eleventy's.
...
which means it does need to be defined using [data_config in your CloudCannon configuration file](https://cloudcannon.com/documentation/articles/defining-your-data/).
...
Avoid accessing data and collections from the layout around your components,
