...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Dashboard-Configure-Build-Task" alt="A screenshot of the Configure your Site's build settings task." title="The Site Dashboard" type="ui-snippet"/>
