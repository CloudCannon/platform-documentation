...
Let's complete the next task in the *Set up Visual Editing* in-app guide: *Make your arrays visually editable*.

<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Dashboard-Component-Editable-Regions-Task" alt="A screenshot of the Make your arrays visually editable task from the Set up Visual Editing in-app guide." title="The component visual editing task" type="screenshot"/>

In this step of the guide, we'll cover how to add *Editable Regions* to simple arrays and enable page building with editable complex arrays. If you don't have any appropriate files or don't want to add this type of *Editable Region*, you can skip this step of the guide.
...
Our "Quotes" page is generated using an HTML layout and populated by a data file containing testimonial content. This file is the Quotes page, containing structured data keys for `image`, `image_alt`, `name`, `job_title`, and `quote`.
...
This file is the About page, containing the structured data key `contentBlocks`.
...
<div data-editable="array" data-prop="stats">
    ...
    return <div data-editable="array-item">
        <p data-editable="text" data-prop="figure">{figure}</p>
