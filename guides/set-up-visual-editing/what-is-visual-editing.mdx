...
In CloudCannon, you can use the [Visual Editor](/documentation/articles/the-visual-editor/) to visually edit any file that outputs to an HTML webpage at build time.
