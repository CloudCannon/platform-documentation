...
nav_title: 'TODO: Editable Regions for Components'
order: 7
published: true
start_nav_group:
image: >-
...
A component is a resuable piece of code, ranging from a small snippet of HTML, like a `<meta>` tag that make SEO easier, to UI elements like a header, profile card, or entire page layout.

Components render to HTML at build time, just like the preview of your webpages in the Visual Editor, so you can visually edit your components.
...
<comp.CodeBlock language="Markdown" source="page.mdx">
``````````
