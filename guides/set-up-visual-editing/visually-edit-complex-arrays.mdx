...
Just like the [previous step of this guide](/documentation/guides/set-up-visual-editing/visually-edit-components/), we need to install CloudCannon's *Editable Regions* NPM package and update our Astro config file (if applicable). Next, we can register each of our content blocks as a component.
