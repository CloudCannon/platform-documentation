...
description: >-
  ...
  reorder array items in a simple array.
---
...
Arrays can be simple, where each item has the same structure (e.g., a testimonial component), or more complex, where each item has a different structure (e.g., a page with various components). For simple arrays, you can use Array and Array Item *Editable Regions* to enable your team to visually edit arrays, including adding, deleting, and reordering items. We'll cover complex arrays in a [later step of this guide](/documentation/guides/set-up-visual-editing/visually-edit-complex-arrays/).
