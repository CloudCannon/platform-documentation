...
In our example above, each blog file contains two text front matter keys we want to edit inline: `title` and `author`.

&nbsp;

&nbsp;

In the blog layout, the `<span data-cms-snippet-type="inline" data-cms-snippet-id="abec2e01-f1c2-4e29-8a10-b7f9bcfb3a07" data-cms-snippet-data="eyJ0ZW1wbGF0ZSI6InRpdGxlIiwiX2hpZGRlbiI6dHJ1ZSwiX3NuaXBwZXRfdHlwZSI6Il9jY19tZHhfdW5rbm93bl90ZW1wbGF0ZSIsIl9tZXRhIjp7InRlbXBsYXRlIjp7Im9yaWdpbmFsRGF0YSI6W3siX3R5cGUiOiJ0ZXh0IiwidGV4dCI6InRpdGxlIn1dfX19"></span>` templating inside the `<h1>` tag is populated by the value of the `title` key in the front matter of each blog file. To allow CloudCannon to re-render this field in the Visual Editor for inline editing, we need to add the `data-editable=""` and `data-prop=""` attributes to the `<h1>` tag in the blog layout.
...
In the blog layout, the `<span data-cms-snippet-type="inline" data-cms-snippet-id="bc90ef8a-e7c6-4d48-a9e7-51e29b8ed7e4" data-cms-snippet-data="eyJ0ZW1wbGF0ZSI6ImF1dGhvciIsIl9oaWRkZW4iOnRydWUsIl9zbmlwcGV0X3R5cGUiOiJfY2NfbWR4X3Vua25vd25fdGVtcGxhdGUiLCJfbWV0YSI6eyJ0ZW1wbGF0ZSI6eyJvcmlnaW5hbERhdGEiOlt7Il90eXBlIjoidGV4dCIsInRleHQiOiJhdXRob3IifV19fX0="></span>` templating inside the `<p>` tag is populated by the value of the `author` key in the front matter of each blog file. Just like the title example, we need to add the `data-editable="text"` and `data-prop="author"` attributes to enable inline editing in the Visual Editor. However, if we add those attributes directly to the `<p>` tag, we won't be able to see the "By:" plain text that prepends the author value.
...
To avoid this issue, we can specifically wrap the `<span data-cms-snippet-type="inline" data-cms-snippet-id="dfbedf24-a1d6-44a5-a5b6-20852db71b4c" data-cms-snippet-data="eyJ0ZW1wbGF0ZSI6ImF1dGhvciIsIl9oaWRkZW4iOnRydWUsIl9zbmlwcGV0X3R5cGUiOiJfY2NfbWR4X3Vua25vd25fdGVtcGxhdGUiLCJfbWV0YSI6eyJ0ZW1wbGF0ZSI6eyJvcmlnaW5hbERhdGEiOlt7Il90eXBlIjoidGV4dCIsInRleHQiOiJhdXRob3IifV19fX0="></span>` templating in a `<text-editable>` web component. The `<text-editable>` component replaces the need for the `data-editable="text"` attribute, telling CloudCannon what type of data we are editing. This is useful if you want to edit an element that can't take attributes or a specific section of a string. We can add the `data-prop="author"` attribute to this web component.
