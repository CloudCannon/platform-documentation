...
You and any content creators on your team probably spend the majority of your time editing content files, such as when writing a new blog or updating a product image, so it's essential to have an intuitive editing interface. Therefore, content files are an excellent starting point for configuring visual editing.

Let's complete the next task in the *Set up Visual Editing* in-app guide: *Make your content files visually editable*.

<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Dashboard-Content-Editable-Regions-Task" alt="A screenshot of the Make your content files visually editable task from the Set up Visual Editing in-app guide." title="The content visual editing task" type="screenshot"/>
