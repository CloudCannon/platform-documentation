...
### Filter \_defaults.md with a glob or schema

If you still use the deprecated  `_defaults.md` file, CloudCannon will no longer filter this file from your collection by default. Please use a collection glob (i.e., `collections_config.*.glob`) or a schema to filter the `_defaults.md` file from your collection browser.
...
### Configure tabbed Object inputs
