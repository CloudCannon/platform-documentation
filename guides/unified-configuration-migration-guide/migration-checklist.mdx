...
<comp.Conditional ssgs={["Hugo"]}>
  ...
  <comp.Notice info_type="info">
    Hugo will automatically add index files excluded from their collections to the pages collection.
  </comp.Notice>
