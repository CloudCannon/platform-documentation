...
Prior to Unified Configuration, CloudCannon could infer the path for each collection during your Site build step (e.g., Jekyll Sites automatically assume your posts collect are in the `_posts` folder).
...
Once you have completed the migration checklist,

Then, you can save your changes and merge your branch with your main Site branch.

If you have any question about thie migration guide, or need