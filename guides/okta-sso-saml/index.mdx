...
explicit_canonical:
---
We know that configuring SSO/SAML can be difficult. Every provider uses different names and finding the right information can be confusing. Don't worry! In this guide, we'll walk you through adding Okta SSO to your CloudCannon Organization.
