...
* **Single sign-on URL** — The CloudCannon address to which Okta will redirect users after they enter their login in details. CloudCannon calls this the *Consume URL (SSO URL)*.
* **Audience URI (SP Entity ID)** — The intended recipient for your SAML assertion. In this case, the intended recipient is CloudCannon.
