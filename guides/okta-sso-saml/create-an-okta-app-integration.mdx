...
To set up SAML 2.0, Okta needs the following details:

* **Single sign-on URL** — The CloudCannon address to which Okta will redirect users after they enter their login in details. CloudCannon calls this the *SSO URL*.
* **Audience URI (SP Entity ID)** — The intended recipient for your SAML assertion, also known as the Service Provider (SP). CloudCannon calls this the *Entity ID (Issuer)*.

We can copy these details from the *Single Sign-On* page on CloudCannon.
