...
Docusaurus is less opinionated and has a number of plugins which can change where and how content is stored.
This means that for Docusaurus, CloudCannon out of the box only has the source editor available.
