...
<comp.DocShot docshot_key="CloudCannon-Documentation-Visual-Editor-Component-Editable-Region" alt="A screenshot of the Visual Editor displays a webpage preview on the right and a sidebar with input fields on the left." title="The Visual Editor" type="screenshot"/>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-WYSIWYG-Toolbar" alt="A screenshot of the WYSIWYG toolbar in the Content Editor." title="The WYSIWYG toolbar" type="ui-element"/>
