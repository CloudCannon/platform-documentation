...
<comp.Notice info_type="info">
  *Snippets* are pre-built content blocks that you can add to your content with just a click. Think of them as reusable templates for common content types like testimonials, call-to-action sections, or product cards. Your developer sets up *Snippets* for your *Site*, so if you don't see any *Snippets* available or want to add new ones, talk to your developer.
</comp.Notice>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Data-Editor" alt="A screenshot of the Data Editor shows organized information fields in a simple list." title="The Data Editor" type="screenshot"/>
...
* Use the *Content Editor* when you're working with longer written content like blog posts or articles and want a focused, distraction-free editing experience. It's similar to using a word processor.
