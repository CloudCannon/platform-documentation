...
The *Visual Editor* does require some configuration, and may not be available for all file types. If you have any questions about using the *Visual Editor* for a specific file, talk to your developer or the friendly CloudCannon [support team](https://cloudcannon.com/support/).
