...
The *Visual Editor* does require some configuration, and may not be available for all file types. If you have any questions about using the *Visual Editor* for a specific file, talk to your developer or the friendly CloudCannon <a href="https://cloudcannon.com/support/" rel="noreferrer">support team</a>.
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-WYSIWYG-Toolbar" alt="A screenshot of the WYSIWYG toolbar in the Content Editor." title="The WYSIWYG toolbar" type="ui-snippet"/>
