...
<comp.DocShot docshot_key="CloudCannon-Documentation-Collection-Browser-Edited-File-Context-Menu" alt="A screenshot of the Collection Browser shows file cards with an open Context Menu." title="File cards with Context Menu" type="screenshot"/>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-File-Browser" alt="A screenshot of the File Browser shows several folders and files organized in folders." title="The File Browser" type="screenshot"/>
