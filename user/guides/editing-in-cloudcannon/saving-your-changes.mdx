...
<comp.DocShot docshot_key="CloudCannon-Documentation-Save-Changes-Modal" alt="A screenshot of the Save Changes modal shows all files with unsaved changes, organized into sections." title="The Review changes modal" type="ui-snippet"/>
...
/\* TODO: Add DocShot showing required input fields in the Save Changes modal \*/
