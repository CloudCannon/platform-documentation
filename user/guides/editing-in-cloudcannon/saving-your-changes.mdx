...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Header-After-Build-Tools" alt="A screenshot of the Testing Domain in the Site Header." title="The Testing Domain" type="ui-snippet"/>
