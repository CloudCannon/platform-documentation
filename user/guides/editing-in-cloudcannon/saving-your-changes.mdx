...
As you make changes, you'll notice a red notification appear on the *Save* in the top right of your *Editing Interface* and *Site Header*. The *Save* button notification shows you how many files have unsaved changes.

<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Header-Tools" alt="A screenshot of the Save Button in the Site Header shows a notification of unsaved changes." title="The Save Button" type="ui-snippet"/>
...
/* TODO: Add DocShot showing the testing domain URL */
