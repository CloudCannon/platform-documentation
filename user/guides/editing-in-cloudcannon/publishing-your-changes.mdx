...
<comp.DocShot docshot_key="CloudCannon-Documentation-Publishing-Page-Publishing-Info-Box" alt="A screenshot of the Publishing Info Box on the Publishing Page shows the status, number of commits, and Git provider." title="The Publishing Info Box" type="ui-snippet"/>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Publishing-Page-Merge-Immediately" alt="A screenshot of the Publishing Page shows the Publish button for immediately publishing changes to the Publish Branch." title="The Publishing Page" type="screenshot"/>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Publishing-Page-Create-Pull-Request" alt="A screenshot of the Publishing Page shows fields for Title and Body, and the Create Pull Request Button." title="The Publish Page" type="screenshot"/>
...
<comp.Notice info_type="info">
  ...
  <comp.DocShot docshot_key="CloudCannon-Documentation-Publishing-Page-Create-Pull-Request-with-Template" alt="A screenshot of the Publishing Page shows fields for Title and Body, and the Create Pull Request Button." title="The Publish Page" type="screenshot"/>
</comp.Notice>
