...
CloudCannon publishes your changes to your *Publish Branch*. A *Publish Branch* is the copy of your website that you want to update with your changes. This could be:

* Your live public website
* A staging website where you review changes before making them public
* Another branch that other team members are also publishing to

Think of your *Publish Branch* as the destination where your changes will end up. Your developer sets up which branch is your *Publish Branch* when they configure your *Site*.

### When do you need to publish vs just save?

Understanding the difference between saving and publishing will help you know when to use each:

**Saving your changes:**
* Creates a permanent record of your changes in your website's files (your developer can undo these changes, if necessary)
* Makes your changes visible on your *Testing Domain* (your free preview URL)
* Is required before you can publish

**Publishing your changes:**
* Moves your saved changes to your *Publish Branch* (often your public website)
* Makes your changes visible to visitors on your public website
* May require approval from a team member, depending on your *Site's* configuration

**Simple rule**: Always save first, then publish if you want your changes on your public website. If your *Site* doesn't use a publishing workflow, saving is all you need to do.
...
* The *Summary* tab shows you what will happen when you publish and gives you the button to publish your changes.
...
* **Commit summary**: The subtitle shows how many times you saved changes (called "commits") and which branch your changes will be published to.
* **Compare link**: The "Compare changes on \[Git provider\]" link takes you to a detailed view of your changes. You may not have access to this because it requires access to your Git provider (a separate tool your developer uses to manage your website's files).
