...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Header-Tools-Post-Build" alt="A screenshot of the Site Header tools shows avatars of team members viewing or editing the file." title="Avatars in the Site Header" type="ui-snippet"/>
