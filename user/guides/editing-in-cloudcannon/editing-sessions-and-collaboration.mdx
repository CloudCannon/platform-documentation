...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Header-Tools-New-Config" alt="A screenshot of the Editing Interface shows avatars of team members viewing or editing the file." title="Avatars in the Editing Interface" type="ui-snippet"/>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Viewing-Mode" alt="A banner at the bottom of the Editing Interface reads 'Heather Scott is currently editing' alongside a Switch to editing button." title="The Switch to editing banner" type="screenshot"/>
