...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Deleted-File-Context-Menu" alt="A screenshot of the Content Editor shows the Context Menu is open for a file." title="The Content Editor" type="screenshot"/>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Collection-Browser-Rename-File-Popup" alt="A screenshot of the Collection Browser shows the Rename file pop up." title="The Collection Browser" type="screenshot"/>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Collection-Browser-File-Card-Badges" alt="A screenshot of the Collection Browser shows file cards with different badges (New, Edited, Deleted)." title="The Collection Browser with file card badges" type="screenshot"/>
