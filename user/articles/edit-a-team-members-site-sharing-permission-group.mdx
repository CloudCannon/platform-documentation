...
<comp.DocsImage path="https://cc-dam.imgix.net/documentation/images/sharing/site-sharing/2024-05/CloudCannon-Documentation-Edit-Site-Sharing-Permission-Group-Modal.png" alt="A screenshot of the Edit Permission Group modal shows one field to select which Site Sharing Permission Group a team member belongs to." title="The Edit Permission Group modal" type="screenshot"/>