...
<comp.Notice info_type="info">
  If you want to give someone access to all Sites in your Organization or give them more permissions than a Technical Editor, consider [adding them to a Global Permission Group](/documentation/developer-articles/add-a-team-member-to-a-permission-group/).
</comp.Notice>
