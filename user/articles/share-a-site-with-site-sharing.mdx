...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Site-Sharing" alt="A screenshot of the Site Sharing page shows team members who have access to this site." type="screenshot" />

Site Sharing Permission Groups will appear under the *Groups* tab on the *Team* page if there is one or more members.

<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Settings-Team-Groups-Tab" alt="A screenshot of the Groups tab on the Team page shows a list of Permission Groups." type="screenshot" />
