...
Setting up your first Site build requires some configuration. For more information, please read our documentation on [configuring your first build](/documentation/articles/configuring-your-build/). Once you have completed your first build you can trigger subsequent builds at any time.
