...
To use a Custom Domain on CloudCannon you can [connect a Custom Domain to your Organization](/documentation/articles/connect-a-custom-domain-to-your-organization/), then [add a Custom Domain to your Site](/documentation/developer-articles/add-a-custom-domain-to-your-site/). Every time you [save changes](/documentation/articles/save-your-changes/) to your Site's content, CloudCannon will [build your Site](/documentation/articles/what-is-a-site-build/) and serve the new content on your Custom Domain.
...
For more information on adding and managing subdomains and subpaths, please read our documentation on [adding a Custom Domain to your Site](/documentation/developer-articles/add-a-custom-domain-to-your-site/) and [updating the fallback redirect for your Custom Domain](/documentation/articles/update-the-fallback-redirect-for-your-custom-domain/).