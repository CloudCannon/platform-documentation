...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Settings-Team-Member-Page" alt="A screenshot of the Team Member page shows one Permission Group and the Remove from Organization button." type="screenshot" />
