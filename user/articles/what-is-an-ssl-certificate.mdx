...
* If you are using an [external DNS provider](/documentation/developer-articles/configure-external-dns/), some additional configuration is required. For more information, please read our documentation on [adding TXT DNS records](/documentation/articles/add-an-auto-generated-ssl-certificate/#add-txt-dns-records).
