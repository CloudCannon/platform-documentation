...
author_notes:
  ...
  ui: ok
  notes: |
    Audit-relevant gap for readers verifying access controls: the page
    describes accountless password access but doesn't frame the no-named-
    identity behaviour as an intentional design tradeoff with Site Sharing
    as the named-identity alternative. Add an explicit "when to choose
    Client Sharing vs Site Sharing" section addressing the audit trail
    difference.
---
