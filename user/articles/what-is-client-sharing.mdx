...
<comp.DocsImage path="/documentation/assets/external_screenshots/client-login-page.png" alt="A screenshot of the Client Login page with a field for the site-specific password and a Sign In button." title="The Client Login page" type="screenshot"/>
