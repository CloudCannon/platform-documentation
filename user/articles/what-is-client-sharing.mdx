...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Settings-Client-Shares-Page" alt="A screenshot of the Client Shares page shows one Site with Client Sharing enabled." type="screenshot" />