...
<comp.DocsImage path="https://cc-dam.imgix.net/documentation/images/editing/save-changes/2024-03/CloudCannon-Documentation-Save-Changes-Modal.png" alt="The Review changes modal with unsaved changes to three files." title="Unsaved changes in the Review changes modal" type="ui-snippet"/>
