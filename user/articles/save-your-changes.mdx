...
<comp.DocShot docshot_key="CloudCannon-Documentation-Save-Button-Unsaved-Changes-Notification" alt="The Save button with a red notification badge indicating three unsaved changes." type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Save-Changes-Modal" alt="The Save Changes modal with unsaved changes to three files." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Save-Changes-Model-Syncing-Paused-Element" alt="The Review changes modal shows the Needs attention heading with a Syncing is paused warning and an affected file." type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Save-Changes-Modal-Input-Validation-Element" alt="The Save Changes modal with required inputs to save the file." type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Save-Changes-Modal-Commit-Message-Element" alt="The Save Changes modal with a commit message describing the changes made to the site." type="ui-snippet" />
