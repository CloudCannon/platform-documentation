...
<comp.DocShot docshot_key="CloudCannon-Documentation-Collection-Browser-File-Context-Menu" alt="A closeup of the Collection Browser shows the file Context Menu with the Delete item option." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Deleted-File-Banner" alt="The Content Editor in the CloudCannon app shows a 'This file has been deleted' banner with the option to 'Restore file'." type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Collection-Browser-Edited-File-Context-Menu" alt="A closeup of the Collection Browser shows the Context Menu for an edited file with the option to discard unsaved changes." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Collection-Browser-Deleted-File-Context-Menu" alt="A closeup of the Collection Browser shows the Context Menu for a deleted file with the option to restore." type="screenshot" />
