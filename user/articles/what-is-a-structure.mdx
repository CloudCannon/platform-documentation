...
article_category:
  - Explanation
tags: []
related_articles: ["ae82e1f0-0906-4843-b440-47b7d43962cb"]
related_links: []
---
A structure is a predefined, custom template that determines what should populate an [Array](/documentation/articles/configure-your-array-inputs/) or [object input](/documentation/articles/configure-your-object-inputs/). With the click of a button, you can easily add fields to an array or object from your list of predefined structures.
...
Structures and arrays go hand-in-hand. The [Array input](/documentation/articles/configure-your-array-inputs/) contains an ordered list of related items, while a structure is a template that determines what data CloudCannon should add to new array items. By creating structures, you can define different objects that your team members can add to arrays within your site.
...
<comp.Notice info_type="info">
  Alternatively, [configure inline Array inputs](/documentation/articles/configure-your-array-inputs/#inline-values) to set which input is used for array items. Inline array inputs also allow an array to be empty.
</comp.Notice>

## Structures and objects

Structures also work for individual objects. The [object input](/documentation/articles/configure-your-object-inputs/) can contain a maximum of one value. After you reference a structure key from an object input, team members can select which structure they want to add to that object. Once a value is selected, you cannot add more until the value is replaced or deleted.