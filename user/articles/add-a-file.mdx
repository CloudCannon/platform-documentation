...
_created_at: 2023-12-20T22:06:36.000Z
details:
  title: Add a file
...
author_notes:
  ...
  ui: ok
  notes: |
    References "Editor Default Permission Group"; the correct term per
    `what-are-default-permission-groups.mdx` is "Editors Default Permission
    Group" (plural). Align the capitalisation/plural.
---
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Collection-Browser-Controls-Add-Menu-Dropdown" title="The Collection Browser" alt="A closeup of the Collection Browser shows the option to add a file in the Add dropdown." type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-File-Browser-Controls-Add-Menu-Dropdown" title="The File Browser" alt="A closeup of the File Browser shows the options to Upload files and Upload a folder in the Add dropdown." type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Collection-Browser-File-Context-Menu" title="The Collection Browser" alt="A closeup of the Collection Browser shows the file Context Menu with options including Duplicate item." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Image-Input-Dropdown-Open" title="The File input with the dropdown open" alt="A closeup of the file input shows the options to upload or explore existing files in the input dropdown." type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-File-Input-File-Browser-Add-Dropdown" title="The File Browser with the Add dropdown open" alt="The file browser shows existing files with the Add button dropdown open, providing options to upload new files." type="screenshot" />
