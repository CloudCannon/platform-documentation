...
<comp.DocShot docshot_key="CloudCannon-Documentation-Collection-Browser-File-Context-Menu" alt="A closeup of the Collection Browser shows the file Context Menu with options including Duplicate item." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-File-Input-File-Browser-Add-Dropdown" alt="The file browser shows existing files with the Add button dropdown open, providing options to upload new files." type="screenshot" />
