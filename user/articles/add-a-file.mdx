...
<comp.DocShot docshot_key="CloudCannon-Documentation-Collection-Browser-Controls-Add-Menu-Dropdown" alt="A closeup of the Collection Browser shows the option to add a file in the Add dropdown." type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-File-Browser-Controls-Add-Menu-Dropdown" alt="A closeup of the File Browser shows the options to Upload files and Upload a folder in the Add dropdown." type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Collection-Browser-File-Context-Menu" alt="A closeup of the Collection Browser shows the file Context Menu with options including Clone item." type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Sidebar" alt="The Content Editor sidebar shows file inputs where you can upload or select files." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Image-Input-Dropdown-Open" alt="A closeup of the file input shows the options to upload or explore existing files in the input dropdown." type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-File-Input-File-Browser" alt="The file browser shows existing files that you can select or upload new files to." type="screenshot" />
