...
details:
  ...
  description: >-
    Your source files are the most important part of any site. Learn how Git works
    on CloudCannon.
  image: >-
    https://cc-dam.imgix.net/documentation/images/default-thumbnail/2023-Q4/CloudCannon-Documentation-Thumbnail.png
  category:
    - Explanation
  related_articles: ["a01c2606-bd15-4d5e-877f-1018cb6e2f72","887f0816-64a1-4a4e-b468-4f6816314b7a","bfb04fef-6986-4fd6-8eaf-1fec366e08f2","60c3442a-e6d5-4fd5-b4f1-ff96fa681b3a","35ebcf9d-da25-4f28-bda9-1a1f99983e61"]
author_notes:
  docshots:
---
...
1. [Merging](/documentation/articles/merging-and-pull-requests/): A direct merge with no review process.
2. [Pull requests](/documentation/articles/merging-and-pull-requests/): An audit flow built into Git providers that requires reviewers and automated testing to pass.
...
[Projects](/documentation/articles/create-a-project/) allow you to configure branching and have a high level overview of the sites that are using the same repository. Creating a project allows the rest of the team to create new branches. These newly created branches are connected to a site and built using the predefined build settings. New sites are configured to publish back to the branch they were originally created from.
