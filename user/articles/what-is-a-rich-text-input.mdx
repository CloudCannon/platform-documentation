...
Rich Text inputs have a text area for your content and a WYSIWYG toolbar for formatting your content. You can configure the WYSIWYG toolbar for a Rich Text input in the same way you configure the toolbar for the [Content Editor](/documentation/articles/what-is-the-content-editor/). For more information, please read our documentation on [configuring your Rich Text editors](/documentation/articles/configure-your-rich-text-editors/).
