...
details:
  ...
  description: Learn about the features of CloudCannon's Source Editor. This editing interface is an in-browser code editor, great for making minor changes to the source code of your files.
...
For more information about the *Editing interface navigation* and the *Context Menu* at the top of the Source Editor, read our documentation on [editing your files](/documentation/developer-articles/edit-your-files).
