...
nav_title: Optimize your Site
published: true
image: /documentation/static/CloudCannonDocumentationog.jpg
description: >-
  CloudCannon optimizes sites to load as fast as possible. CloudCannon minifies
  CSS with clean-css and JavaScript with esbuild. Externally hosted assets are
  not optimized.
article_category:
article_topic:
tags:
