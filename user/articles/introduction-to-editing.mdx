...
_created_at: 2023-11-14T00:06:25.000Z
details:
...
author_notes:
  docshots: null
---
Editing on CloudCannon enables anyone on your team to contribute to your <comp.GlossaryTerm term="/user/glossary/g/git-repository.yml">Git repository</comp.GlossaryTerm>, regardless of technical expertise.

Traditional Content Management Systems (<comp.GlossaryTerm term="/user/glossary/c/cms.yml">CMSs</comp.GlossaryTerm>) use databases to store your content. CloudCannon takes a different approach. By storing your content in <comp.GlossaryTerm term="/user/glossary/f/file.yml">files</comp.GlossaryTerm> alongside your code, your content can benefit from the Git workflow (versioning, accountability, branching, etc.).
...
<comp.Notice info_type="info">
  If this is your first time creating a site on CloudCannon, or you need a refresher, check out our [Starter Guides](/documentation/developer-guides/) — we have one for every <comp.GlossaryTerm term="/user/glossary/s/ssg.yml">SSG</comp.GlossaryTerm> we support!
</comp.Notice>

In the Editing section of our documentation, we cover how to:

* [Create your CloudCannon configuration file](/documentation/developer-articles/create-your-cloudcannon-configuration-file/) — create the file at the heart of CloudCannon customization.
* [Define your collections](/documentation/user-articles/what-is-a-collection/) — groups of related files that form the start of any new site.
* Editing interfaces — the [Visual](/documentation/user-articles/what-is-the-visual-editor/), [Content](/documentation/user-articles/what-is-the-content-editor/), [Data](/documentation/user-articles/what-is-the-data-editor/), and [Source](/documentation/user-articles/what-is-the-source-editor/) Editors.
* [Edit your files](/documentation/user-articles/edit-your-files/) — cooperate on file changes with live editing.
* [Save your changes](/documentation/user-articles/save-your-changes/) — learn how to review changes made by your team and save back to your Git repository.
* [Inputs](/documentation/user-articles/what-are-inputs/) — configure your structured data to create an intuitive interface.
* [Create a structure](/documentation/developer-articles/what-is-a-structure/) — create predefined objects to add to your content.
* Create a <comp.GlossaryTerm term="/user/glossary/s/snippet.yml">Snippet</comp.GlossaryTerm> — create structured components in Markup using:
...
* [Define your collections](/documentation/developer-articles/configure-your-collections/)
...
Combination files use structured data and markup in the same file. CloudCannon expects structured data to be at the top of the file in the <comp.GlossaryTerm term="/user/glossary/f/front-matter.yml">front matter</comp.GlossaryTerm> section. Front matter is separated from other content by a `---` notation or similar. You can edit both parts of a combination file using the Visual or Content Editor. We recommend combination files for pages where you want to attach metadata to your content.
...
* [Inputs](/documentation/user-articles/what-are-inputs/)
