...
This section covers how to manage your website files, including adding, editing, deleting, and saving. It also teaches you about Inputs (the fields for editing file data outside of your content), including what each Input type looks like and how to use them. These articles will provide you with all the tools you need for making changes to your website.
...
* Manage your files — How to manage your website files through CloudCannon
* Using Inputs — How to edit file data that isn't the main body of content
