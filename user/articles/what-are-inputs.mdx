...
<comp.DocShot docshot_key="CloudCannon-Documentation-Email-Input-With-Context" alt="A close up of an email input in the Data Editor shows a label, comment, text field, and context dropdown." type="ui-snippet" />
