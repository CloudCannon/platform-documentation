...
For more information, please read our documentation on the [configuration cascade](/documentation/developer-articles/using-the-configuration-cascade/) and [configuring your inputs](/documentation/developer-articles/configure-your-inputs/).
...
We recommend [configuring your inputs](/documentation/developer-articles/configure-your-inputs/) to overcome these limitations and for greater control over their functionality and appearance.