...
author_notes:
  ...
  ui: needs_check
  notes: |
    Compliance / account-recovery topic for domain-ownership disputes;
    routes to support. UI prose around the *Custom Domain* settings hasn't
    been verified in 5 years — button and modal labels need re-checking
    before any rewrite.
---
