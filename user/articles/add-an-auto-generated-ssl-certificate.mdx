...
Before you add an SSL certificate to your Site, you must [add a Custom Domain](/documentation/developer-articles/add-a-custom-domain-to-your-site/) to your [Organization](/documentation/articles/what-is-an-organization/).
