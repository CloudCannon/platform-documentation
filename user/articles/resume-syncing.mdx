...
<comp.DocShot docshot_key="CloudCannon-Documentation-Save-Changes-Model-Syncing-Paused-Error" alt="A screenshot of the Save Changes modal shows a Syncing is paused warning and affected files highlighted in orange." title="The Review Changes modal" type="ui-snippet"/>
