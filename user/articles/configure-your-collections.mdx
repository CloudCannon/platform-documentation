...
<comp.Annotation number="3">
  The `collections.[*].path` key tells CloudCannon where to find the files for your Collection. The value for this key is relative to your Site [source folder](/documentation/developer-articles/what-is-the-cloudcannon-configuration-file/#the-source-folder).
</comp.Annotation>
</comp.MultiCodeBlock>
