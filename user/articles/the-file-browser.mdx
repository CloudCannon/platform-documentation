...
The *File browser* shows you all the folders and files in your Site, with each file represented by a [Card](/documentation/developer-articles/what-are-cards/). These file Cards will show:
...
<comp.Notice info_type="info">
  Unlike the *Collection browser*, you cannot configure the appearance of file [Cards](/documentation/developer-articles/what-are-cards/) in the *File browser*.
</comp.Notice>
