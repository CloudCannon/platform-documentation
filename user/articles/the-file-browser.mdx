...
author_notes:
  ...
  ui: needs_check
  notes: |
    The File Browser was Lit-converted in late 2024 (page itself was created
    2024-11-04). UI structure and view-mode descriptions should be
    re-verified against the current Lit implementation at
    `app/assets/javascripts/views/site/files/file-browser.view.ts`.
---
