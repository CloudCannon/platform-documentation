...
author_notes:
  ...
  ui: ok
  notes: |
    Billing-critical page that's very thin (~29 lines). Payment methods
    section asserts Visa and Mastercard only — no Apple Pay, Google Pay,
    PayPal, ACH, or other modern options. Page hasn't been refreshed since
    2021. Worth promoting to P0/P1 alongside the other billing pages and
    rewriting against the current Subscription settings UI.
---
