...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Branding-Settings" alt="Screenshot of organization branding interface" type="screenshot" />

## Organization Badge
This asset is used in the organization list. For best results, the image should be square with a minimum width of 256px.

<comp.DocShot docshot_key="CloudCannon-Documentation-Account-Organizations-Click-Through-List" alt="Screenshot of Organizations list" type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Branded-Sites-List" alt="Screenshot of Sites list with custom branding" type="screenshot" />
