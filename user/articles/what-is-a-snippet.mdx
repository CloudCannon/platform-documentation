...
By default, CloudCannon will show the *Insert snippet* button in the *WYSIWYG toolbar* if you have at least one Snippet. The *WYSIWYG toolbar* appears in the [Content Editor](/documentation/articles/the-content-editor/) and in [rich text inputs](/documentation/articles/what-is-a-rich-text-input/).
