...
Snippets are most useful in the [Content Editor](/documentation/articles/what-is-the-content-editor/) and in [rich text inputs](/documentation/articles/configure-your-rich-text-editors/), although they can appear in the [Visual](/documentation/articles/what-is-the-visual-editor/) and [Data Editors](/documentation/articles/what-is-the-data-editor/).
...
By default, CloudCannon will show the *Insert snippet* button in the *WYSIWYG toolbar* if you have at least one Snippet. The *WYSIWYG toolbar* appears in the [Content Editor](/documentation/articles/what-is-the-content-editor/) and in [rich text inputs](/documentation/articles/what-is-a-rich-text-input/).

If you have already [customized which options are available](/documentation/articles/configure-your-rich-text-editors/) in your *WYSIWYG toolbar* using the `_editables` key in your [CloudCannon configuration file](/documentation/articles/create-your-cloudcannon-configuration-file/), please ensure that `snippet: true` is included.
