...
* Login Sessions — Learn how to review and manage your active login sessions across all devices
...
The *Sessions* page under *Account Settings* shows all active and previous login sessions for your CloudCannon account. You can use this page to review where your account is currently signed in and to sign out of all devices at once.

For instructions on managing your login sessions, please read our documentation:

* [Manage your login sessions](/documentation/user-articles/manage-your-login-sessions/)