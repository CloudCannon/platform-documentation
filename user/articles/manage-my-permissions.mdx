...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Settings-My-Permissions-Leave-Group" alt="A screenshot of the My Permissions page shows the Context Menu of a Permission Group with the option to Leave Group." title="The My Permissions page" type="screenshot"/>