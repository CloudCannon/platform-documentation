...
A Custom Domain is a unique address used to identify a website (e.g., [cloudcannon.com](https://cloudcannon.com)). If you have <a href="/documentation/articles/connect-a-custom-domain-to-your-organization/" target="_blank" rel="noopener">connected a Custom Domain to your Organization</a>, you can host your Site on a subdomain by [adding a Custom Domain to your Site](/documentation/developer-articles/add-a-custom-domain-to-your-site/). CloudCannon will use the fallback redirect domain for any subdomains you do not add to a CloudCannon Site.
