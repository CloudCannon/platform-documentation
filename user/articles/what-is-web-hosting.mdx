...
---
Web hosting is where, after a successful [build](/documentation/user-articles/what-is-a-site-build/), all your files are stored on a web server and made available to the public on the Internet. You can host your Site through CloudCannon or an external service.
