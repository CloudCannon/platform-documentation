...
* Add an [SSL certificate](/documentation/developer-articles/what-is-an-ssl-certificate/) (either an auto-generated SSL certificate or a [custom SSL certificate](/documentation/developer-articles/add-a-custom-ssl-certificate/)).
