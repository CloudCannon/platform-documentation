...
author_notes:
  ...
  ui: ok
  notes: |
    The cache-busting claim about Cloudflare CDN behaviour should be
    verified against the current Cloudflare integration. The four hosting
    combinations described otherwise match the offering.
---
