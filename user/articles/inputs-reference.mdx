...
All Inputs options are configured within the `_inputs` key in your [CloudCannon configuration file](/documentation/developer-articles/what-is-the-cloudcannon-configuration-file/).
...
<comp.DataReference>
  <comp.DataReferenceRow label="_inputs" type_markdown="Object">
    ...
    * `options`
    ...
    This key has no default. If undefined at higher levels of the [configuration cascade](/documentation/articles/using-the-configuration-cascade/), `_inputs` will default to any values configured in the [CloudCannon configuration file](/documentation/developer-articles/what-is-the-cloudcannon-configuration-file/).
...
<comp.DataReference>
  ...
  <comp.DataReferenceRow label="_inputs.*.options.max_file_size" type_markdown="String">
  ...
  <comp.DataReferenceRow label="_inputs.*.options.max_file_size_message" type_markdown="String">
