...
You need the following details to add your custom SSL certificate to a [Custom Domain](/documentation/developer-articles/what-is-a-custom-domain/) on CloudCannon.
