...
For a description of every resource available in CloudCannon, please read our reference documentation on [permissions](/documentation/developer-articles/permissions-reference/). To see which resources are enabled for a particular Permission Group in CloudCannon, click on the permission card under the *Settings* tab on any *Group* page.
