...
* One *Permission Group* with Global *Scope* in each *Client Organization*, for the *Partner Organization* that manages it (*Partner*).
...
* **Independent of your Subscription Plan** — *Default Permission Groups* are available whichever *Subscription Plan* you are on, whereas creating *Custom Permission Groups* requires our <a href="https://cloudcannon.com/pricing/">Team or Enterprise Plan</a>.
