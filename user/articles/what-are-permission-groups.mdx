...
For <a href="https://cloudcannon.com/pricing/" rel="noreferrer">Team and Enterprise plan customers</a>, CloudCannon allows you to create [Custom Permission Groups](/documentation/developer-articles/what-are-custom-permission-groups/). Custom Permission Groups give you fine-grained control over the permissions in your Organization.
...
The <a href="https://cloudcannon.com/partner-program/" rel="noreferrer">CloudCannon Partner Program</a> allows agencies or freelancers specializing in web design/development to set up their clients in CloudCannon.
...
Partner Organization members in a Client Organization do not contribute to the <a href="https://cloudcannon.com/pricing/" rel="noreferrer">maximum number of team members allowed per Organization</a> and, therefore, do not affect billing for the Client Organization.