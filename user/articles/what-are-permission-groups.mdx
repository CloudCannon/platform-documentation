...
For a complete list of resources and their associated actions, please read our reference documentation on [permissions](/documentation/developer-articles/permissions-reference/).
...
You cannot edit the resources or scope of Default Permission Groups. Members of the Owners or Developers Permission Group can [invite team members to your Organization](/documentation/user-articles/add-a-team-member-to-your-organization/) and [update which Permission Group team members belong to](/documentation/developer-articles/add-a-team-member-to-a-permission-group/).
