...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Settings-Team-Groups-Tab" alt="A screenshot of the Groups tab on the Team page shows Default, Custom, and Site Share Permission Groups." type="screenshot" />

<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Settings-Team-Default-Group-Settings-Tab" alt="A screenshot of the Developers Permission Group page shows one permission under the Settings tab." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Settings-Team-View-Permission-Modal" alt="A screenshot of the View permission modal shows the scope, target, and resource options for a permission in a Default Permission Group." type="screenshot" />
