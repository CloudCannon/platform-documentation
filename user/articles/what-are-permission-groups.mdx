...
<comp.DocShot docshot_key="CloudCannon-Documentation-Default-Permission-Group-Settings" alt="A screenshot of the Developers Permission Group page shows one permission under the Settings tab." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Default-Permission-Group-Settings" alt="A screenshot of the Developers Permission Group page shows the permissions and scope settings." type="screenshot" />
