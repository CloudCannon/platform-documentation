...
<comp.DocShot docshot_key="CloudCannon-Documentation-Organization-Browser-Pending-Invite" alt="A screenshot of the Organization Browser shows one pending invitation and one Organization card." title="The Organizations Browser" type="screenshot"/>
