...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Settings-Team-Page" alt="A screenshot of the Team page shows team members and the Add members button." type="screenshot" />

<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Settings-Team-Invite-Modal" alt="A screenshot of the Team page shows the Invite Team members modal with two fields for names and Permission Groups." type="screenshot" />
