...
<comp.DocShot docshot_key="CloudCannon-Documentation-Invite-Team-Members-Modal" alt="A screenshot of the Team page shows the Invite Team members modal with two fields for names and Permission Groups." type="screenshot" />
