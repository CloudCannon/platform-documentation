...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Settings-Team-Invite-Modal" title="The Team page" alt="A screenshot of the Team page shows the Invite Team members modal with two fields for names and Permission Groups." type="screenshot" />
