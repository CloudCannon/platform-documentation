...
Testing Domains are useful for seeing your content live after a successful [Site build](/documentation/developer-articles/what-is-a-site-build/). If you use a [publishing workflow](/documentation/guides/staging-workflow-guide/), your Testing Domain will allow you to see the content for each branch on its own domain.
