...
3. Click the *\+ Add to Group* button on the right to open the *Add [Team Member Name] to Groups* modal.
4. Enter the *Permission Group(s)* to which you want to add this *Team Member*.
5. Click the *Add to Group* button.

CloudCannon will add the *Team Member* to the selected *Permission Groups*.
