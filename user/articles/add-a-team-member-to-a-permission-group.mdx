...
author_notes:
  ...
  ui: needs_check
  notes: |
    Step 4 references the "+ Add group member" button; spot-check against
    `members-per-group-view.ts` showed button text as "Add members". Step 2
    of the same page already uses "+ Add members". Verify which label the
    current UI renders and align both steps.
---
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Settings-Team-Invite-Members-Modal" alt="A screenshot of the Team page shows the Invite Team members modal with two fields for names and Permission Groups." title="The Invite Team Members modal" type="screenshot"/>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Settings-Team-Add-Member-To-Groups-Modal" alt="A screenshot of the Team Member page shows the Add to Team Member to Groups modal with a field for Permission Groups." title="The Add Team Member to Groups modal" type="screenshot"/>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Settings-Team-Add-Members-To-Group-Modal" alt="A screenshot of the Developers Permission Group page shows the Add Team Members to Group modal with a field for names." title="The Add Team Members to Group modal" type="screenshot"/>