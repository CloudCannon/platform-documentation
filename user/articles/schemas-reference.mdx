...
author_notes:
  docshots:
---
A [schema](/documentation/developer-articles/what-is-a-schema/) is a predefined template that determines what should populate a [collection](/documentation/articles/what-is-a-collection/) file. You can configure several schemas for each collection, creating a list of file templates for you and your team.

This article covers all the keys available for schema configuration. To learn more about schemas, read our documentation on [creating a schema](/documentation/developer-articles/create-a-schema/).
...
<comp.DataReference>
 <comp.DataReferenceRow label="create" type_markdown="Object or string">
    ...
    Read more details for `create` when [choosing where to create new files](/documentation/developer-articles/set-the-path-for-new-files/).
  ...
  <comp.DataReferenceRow label="preview" type_markdown="Object">
    ...
    All preview options are available for schemas, and are the same as the ones listed in the [collections configuration options](/documentation/articles/configure-your-collections/#options)\:
