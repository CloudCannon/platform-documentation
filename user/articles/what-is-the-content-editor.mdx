...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Insert-Snippet-Modal" alt="The Content Editor shows the Insert Snippet modal for adding snippets to your rich text content." type="screenshot" />
