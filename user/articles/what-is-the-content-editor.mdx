...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor" alt="A screenshot of the Content Editor, an editing interface for content-heavy markup files." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-WYSIWYG-Toolbar" alt="A closeup of the WYSIWYG toolbar, including tools for formatting rich text." type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Sidebar" alt="A closeup of the Content Editor sidebar, showing the front matter fields of a blog file." type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-YouTube-Snippet-Edit-Panel" alt="The Content Editor shows a YouTube snippet in the rich text content with its data panel open for editing." type="screenshot" />
