...
<comp.DocShot docshot_key="CloudCannon-Documentation-Editing-Interface-Header" alt="The Editing interface header, showing the return button, file details, update status, avatars, editing dropdown, interface buttons, and save button." type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Context-Menu" alt="A screenshot of the Context Menu in the top right of the editing interface." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Collection-Browser-File-Context-Menu" alt="The collection browser shows a series of files, one with the Context Menu open from the top right of the file card." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Viewing-Mode" alt="A screenshot of the Content Editor in read-only mode, with a banner at the bottom to switch to editing." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Split-Screen-Toggle" alt="The toggle split-screen button in the bottom left of the editing interface." type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Collection-Browser-File-Card-Badges" alt="A closeup of the collection browser showing the New, Edited, and Deleted badges on files with unsaved changes." type="screenshot" />
