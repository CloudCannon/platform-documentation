...
* *Preview live site* — Open this file’s webpage in another tab, using your [Testing Domain](/documentation/user-articles/what-is-a-testing-domain/) or [Custom Domain](/documentation/developer-articles/what-is-a-custom-domain/). This will only show your [saved changes](/documentation/user-articles/save-your-changes/).
