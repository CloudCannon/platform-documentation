...
<comp.DocShot docshot_key="CloudCannon-Documentation-Editing-Interface-Header-Controls" alt="A closeup of the Editing interface navigation, including save button, avatars, editing dropdown, and update status." type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Collection-Browser-File-Context-Menu" alt="The collection browser shows a series of files, one with the Context Menu open from the top right of the file card." type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Collection-Browser-File-Card-Badges" alt="A closeup of the collection browser showing the New, Edited, and Deleted badges on files with unsaved changes." type="ui-snippet" />
