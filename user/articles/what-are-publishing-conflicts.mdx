...
<comp.Notice info_type="info">
  A [Publish Branch](/documentation/articles/what-is-a-publish-branch/) the branch immediately "upstream" of the branch you are working on, and is the copy of your website to which you want to publish your changes. Publishing Conflicts can occur if you <a href="/documentation/developer-articles/connect-a-publish-branch/" target="_blank" rel="noopener">connect a Publish Branch</a> to your Site.
</comp.Notice>
