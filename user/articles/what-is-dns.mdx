...
On CloudCannon, any [Custom Domain](/documentation/developer-articles/what-is-a-custom-domain/)  added to your [Organization](/documentation/articles/what-is-an-organization/) can use [CloudCannon DNS](/documentation/articles/configure-cloudcannon-dns/) or an [external DNS](/documentation/articles/configure-external-dns/).
