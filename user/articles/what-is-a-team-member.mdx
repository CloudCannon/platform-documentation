...
The maximum number of team members allowed per Organization will depend on your <a href="https://cloudcannon.com/pricing/" rel="noreferrer">pricing plan</a>. If you need to exceed this number, you can pay to add extra users to your Organization.

The *Team* page under *Org Settings* shows a *Last active* indicator on each team member's card. This indicator shows when the team member was last active in your *Organization*.
