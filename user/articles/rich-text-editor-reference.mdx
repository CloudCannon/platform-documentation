...
_created_at: 2024-06-14T14:02:01+00:00
details:
...
<comp.DataReference>
  ...
  <comp.DataReferenceRow label="join_above" type_markdown="Boolean">
    This key enables a tool to merge a list item with the item above it in an ordered or unordered list.

    Available for the Content Editor (`_editables.content`), the Block editable region (`_editables.block`), and Rich Text inputs (`_inputs.key_name.options`).
  </comp.DataReferenceRow>
  <comp.DataReferenceRow label="join_below" type_markdown="Boolean">
    This key enables a tool to merge a list item with the item below it in an ordered or unordered list.
...
<comp.DataReference>
  <comp.DataReferenceRow label="image_size_attributes" type_markdown="Boolean">
    ...
    <comp.Notice info_type="important">
          This defaults to `true` for sites created before June 23 2023, in order to keep those sites working. Use the [Image Size Attributes Default](/documentation/developer-articles/legacy-option-flags/#image-size-attributes-default-behaviour) flag to update this for your site, if needed.
        </comp.Notice>
...
<comp.DataReference>
  <comp.DataReferenceRow label="paths" type_markdown="Object">
    ...
    * `uploads_use_relative_paths`
    ...
    This key has no default. If undefined at higher levels of the [configuration cascade](/documentation/articles/using-the-configuration-cascade/), `paths` will default to any values configured in the [CloudCannon configuration file](/documentation/developer-articles/what-is-the-cloudcannon-configuration-file/).
    
    For more information, please read our documentation on [Rich Text editors](/documentation/developer-articles/what-are-rich-text-editors/) or [File inputs](/documentation/articles/what-is-a-file-input/).
  ...
  <comp.DataReferenceRow label="paths.dam_uploads" type_markdown="String">
    ...
    You can use [dynamic placeholders](/documentation/articles/configure-your-template-strings/) for `uploads` and `dam_uploads`. For more information, please read our documentation on [adjusting file upload paths](/documentation/developer-articles/adjusting-the-uploads-path/).

    Available for the Content Editor (`_editables.content`), the Block editable region (`_editables.block`), the Image editable region (`_editables.image`), the Text editable region (`_editables.text`), and Rich Text inputs (`_inputs.key_name.options`).
  </comp.DataReferenceRow>
  <comp.DataReferenceRow label="paths.dam_uploads_filename" type_markdown="String">
    This key enables you to define the path for the name of the uploaded file, when uploading [DAM](/documentation/developer-articles/introduction-to-assets-and-dams/) files.
...
<comp.DataReference>
  <comp.DataReferenceRow label="allow_custom_markup" type_markdown="Boolean">
    ...
    For more information, please read our documentation on best practices for HTML in [rich text](/documentation/developer-articles/best-practices-for-rich-text/) and [editable regions](/documentation/articles/define-editable-regions-in-your-html/).
  </comp.DataReferenceRow>
