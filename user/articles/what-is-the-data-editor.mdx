...
<comp.DocShot docshot_key="CloudCannon-Documentation-Visual-Editor-Data-Panel" alt="A screenshot of the Visual Editor,  with the open data panel showing the inputs of a page component." title="The Visual Editor with data panel" type="screenshot"/>
