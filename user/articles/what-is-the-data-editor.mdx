...
<comp.DocShot docshot_key="CloudCannon-Documentation-Data-Editor" alt="A screenshot of the Data Editor, an editing interface for structured data files and markup file front matter." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor" alt="A screenshot of the Content Editor, with the sidebar showing the front matter fields of a blog file." type="screenshot" />
