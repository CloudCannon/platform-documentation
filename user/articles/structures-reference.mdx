...
This article covers all keys available in CloudCannon for configuring your Structures. For more information, please read our documentation on [Structures](/documentation/developer-articles/what-is-a-structure/) in general and [creating a Structure](/documentation/developer-articles/create-a-structure/).
...
<comp.DataReference>
  ...
  <comp.DataReferenceRow label="picker_preview" type_markdown="Object">
    This key defines the appearance of a Card. You can configure Card preview for [Structures](/documentation/developer-articles/what-is-a-structure/) and [Snippets](/documentation/articles/what-is-a-snippet/). This key is separate from the `preview` key and only affects the select and modal lists.
