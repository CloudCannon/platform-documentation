...
<comp.Notice info_type="info">
  CloudCannon also supports SAML authentication for CloudCannon app access. This feature is available on our [Enterprise plan](https://cloudcannon.com/pricing/). If this is what you're looking for, please read our documentation on [SSO/SAML](/documentation/developer-articles/what-is-sso-saml/) or reach out to our friendly [support team](https://cloudcannon.com/support/).
</comp.Notice>
