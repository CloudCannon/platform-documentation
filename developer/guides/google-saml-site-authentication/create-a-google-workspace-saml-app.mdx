---
_schema: default
_uuid: f575d74b-47e8-4c4a-8a5b-a8800e67351a
_created_at: 2025-02-18T23:34:09Z
details:
...
---
Google Workspace allows you to create a dedicated SAML App to handle authentication. If you want to, you can follow <a href="https://support.google.com/a/answer/6087519?hl=en" target="_blank" rel="noopener noreferrer">Google’s instructions</a> directly.
...
1. Log in to the <a href="https://admin.google.com/" target="_blank" rel="noopener noreferrer">Google Admin Portal</a> using your super administrator account.
...
<comp.DocsImage path="/assets/external_screenshots/CloudCannon-Documentation-Google-Custom-SAML-App.png" alt="A screenshot of the Google Workspace Add Custom SAML App page shows the service provider details." title="The Add Custom SAML App page" type="screenshot"/>
