...
Bringing your own UI like this gives you complete control over the experience. If instead you want to reuse CloudCannon's native editing surfaces, the *Visual Editor API* can also open its own <comp.GlossaryTerm term="/user/glossary/d/data-panel.yml">Data Panels</comp.GlossaryTerm> and make page elements directly editable.
