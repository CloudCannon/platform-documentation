...
If you’re starting from scratch, have a look at the <a href="https://rosey.app" target="_blank" rel="noopener noreferrer">Rosey documentation</a> to get set up, then move on to the next step.
