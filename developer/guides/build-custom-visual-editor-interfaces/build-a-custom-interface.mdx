...
<comp.DocShot docshot_key="CloudCannon-Documentation-Visual-Editor-Doodle-Controls" alt="A screenshot of the drawing tool's controls: Undo stroke and Start over buttons, a caption text field, and an Add to the gallery button." title="The drawing tool's caption field and submit button" type="ui-snippet"/>
