...
<comp.DocShot docshot_key="CloudCannon-Documentation-Visual-Editor-Doodle-Interface" alt="A screenshot of the custom drawing interface inside the Visual Editor, with a blank canvas on the left and caption and submit controls on the right." title="The custom interface rendered inside the Visual Editor" type="ui-snippet"/>
