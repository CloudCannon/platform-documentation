...
<comp.Notice info_type="info">
  **What happens when you select one** ***Collection*** **nested inside of another?**
  ...
  <comp.DocsImage path="assets/diagrams/CloudCannon-Documentation-Collection-File-Structure.png" alt="An illustration of a file structure shows a blog folder with two nested files and a nested authors folder, which also has two nested files." title="An example file structure" type="ui-snippet"/>
