...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Navigation" alt="A screenshot of the Site Navigation shows links to important Site pages, including Dashboard, Collections, and Site Settings. " title="The Site Navigation" type="ui-snippet"/>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Navigation-Dashboard" alt="A screenshot of the Dashboard link in the Site Navigation, with the Status indicator and Guide progress indicator." title="The Dashboard link" type="ui-snippet"/>
