...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Header-No-Build" alt="A screenshot of the Site Header shows the " title="The Site Header" type="ui-snippet"/>
