...
<comp.DocShot docshot_key="CloudCannon-Documentation-Add-Your-Files-Task" alt="A screenshot of the Add your Files task from the Getting Started with Editing in-app guide shows the Mark as complete button." title="The Add your Files task" type="ui-snippet"/>
