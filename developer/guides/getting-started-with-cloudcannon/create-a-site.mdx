...
<comp.DocShot docshot_key="CloudCannon-Documentation-Organization-Home-Add-Your-Files-Card" alt="A screenshot of the Add your own files to CloudCannon card from the Organization Home page." title="The Add your own files card" type="ui-snippet"/>

CloudCannon will open the *Create a Site* page.

Here, you can use the *File source* dropdown to select your Git provider.

<comp.DocShot docshot_key="CloudCannon-Documentation-Create-a-Site-Source-Dropdown" alt="A screenshot of the Create a Site page shows a dropdown to select your File Source from a Git repository, local storage, or a template." title="The Create a Site page with a new branch" type="screenshot"/>

<comp.Notice info_type="info">
  <p>If you already have one or more <em>Sites</em> associated with your <em>Organization</em>, the *Try our demo Site* or *Add your own files to CloudCannon* options will not appear on your <em>Organization Home</em> page. Instead, click the <em>Sites</em> button in the <em>App Sidebar</em> to open the <em>Sites Browser</em>. You can add a new Site to CloudCannon using the <em>+ Create a Site</em> button at the top right of the <em>Sites Browser</em>.</p>
  
  <comp.DocShot docshot_key="CloudCannon-Documentation-Sites-Browser-One-Site" alt="A screenshot of the Sites Browsers shows one Site and the + Create a Site button in the top right." title="The Sites Browser" type="screenshot"/>
</comp.Notice>
