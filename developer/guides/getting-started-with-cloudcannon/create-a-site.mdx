...
When you create a *Site*, CloudCannon first needs to sync your website files from their current location. This could be your local computer storage, or a Git repository maintained using one of CloudCannon's supported Git providers: <a href="https://cloudcannon.com/documentation/developer-articles/connecting-a-github-repository-as-your-source/" target="_blank" rel="noopener">GitHub</a>, <a href="https://cloudcannon.com/documentation/developer-articles/connecting-a-gitlab-respository-as-your-source/" target="_blank" rel="noopener">GitLab</a>, or <a href="https://cloudcannon.com/documentation/developer-articles/connecting-a-bitbucket-respository-as-your-source/" target="_blank" rel="noopener">Bitbucket</a>.
...
<comp.Notice info_type="info">
  For GitHub, you also need a GitHub App installation connected to your *Organization* before you can select repositories. If you have not installed the CloudCannon GitHub App yet, CloudCannon will prompt you to do so. For more details, see <a href="/documentation/developer-articles/manage-your-github-app-installations/">Manage your GitHub App installations</a>.
</comp.Notice>

### Select your repository and branch

Once you have selected an authenticated Git provider using the *File source* dropdown, the *Create a Site* page will show additional fields for selecting a repository and branch.

For GitHub with scoped installations enabled, you will first see an *Installation* dropdown. Select the GitHub account or organization whose repositories you want to browse. The *Repository* dropdown will then show only the repositories accessible through that installation.

<comp.Notice info_type="info">
  If your *Organization* does not have scoped installations enabled, or if you are using GitLab or Bitbucket, you will see the *Repository* dropdown directly without an *Installation* dropdown.
</comp.Notice>
