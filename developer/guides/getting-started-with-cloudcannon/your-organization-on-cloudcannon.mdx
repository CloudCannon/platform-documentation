...
You can also join other people's <em>Organizations</em> by invitation, which will allow you to manage their content.
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Dashboard-Summary-Tab" alt="A screenshot of the Site Dashboard Summary tab shows custom README content and Site information." title="The Site Dashboard" type="screenshot"/>
