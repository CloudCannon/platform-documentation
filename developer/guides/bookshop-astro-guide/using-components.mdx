...
You can find more information on template directives and how to use them at Astro's <a href="https://docs.astro.build/en/reference/directives-reference" target="_blank" rel="noopener noreferrer">template directives reference documentation</a>.
