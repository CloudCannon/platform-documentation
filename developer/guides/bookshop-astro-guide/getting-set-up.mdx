...
<comp.Notice info_type="info">
   As a useful reference, the <a href="https://github.com/CloudCannon/sendit-astro-template" target="_blank" rel="noopener noreferrer">Astro Sendit Template</a> repository
