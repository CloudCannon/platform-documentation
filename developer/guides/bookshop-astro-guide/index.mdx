...
<comp.Notice info_type="important">
  ...
  Please open an issue on the <a href="https://github.com/CloudCannon/bookshop/issues" target="_blank" rel="noopener noreferrer">Bookshop GitHub repository</a> if you encounter any trouble when integrating your site.
</comp.Notice>
...
Bookshop is fully open-source and is available on GitHub at <a href="https://github.com/CloudCannon/bookshop/" target="_blank" rel="noopener noreferrer">CloudCannon/bookshop</a>. As a tool that integrates into your codebase, we want to ensure you aren't vendor-locked to our platform. Sites built using Bookshop remain fully portable and can be built or hosted anywhere on the web.
