...
Input configuration is passed directly to CloudCannon; see the [CloudCannon Inputs Documentation](https://cloudcannon.com/documentation/developer-articles/configure-your-inputs/) to read more.