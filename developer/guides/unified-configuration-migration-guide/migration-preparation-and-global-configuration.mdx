...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Flags-Page" alt="A screenshot of the Flags page shows configuration options including the Unified Configuration checkbox." type="screenshot" />
