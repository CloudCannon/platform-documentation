---
_schema: default
_uuid: ecfcbe4f-f0d2-4341-a608-308a95caca11
...
## 1\. Update the format of your *Dataset*s

<comp.Notice info_type="info">
  This step of the migration guide is only relevant to Sites using Eleventy, Hugo, or Jekyll as their SSG.
</comp.Notice>

CloudCannon no longer exclusively reads *Dataset*s at build time. You must update your data configuration to allow CloudCannon to read your *Dataset*s at any time.
