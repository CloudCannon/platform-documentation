...
Hugo calls this <a href="https://gohugo.io/content-management/multilingual/#translation-by-content-directory" target="_blank" rel="noopener noreferrer">Translation by content directory</a>. Your files will be placed inside a top-level content folder for each language (e.g. `content/es/posts/my-post.md`).
