...
Hugo calls this <a href="https://gohugo.io/content-management/multilingual/#translation-by-filename" target="_blank" rel="noopener noreferrer">Translation by filename</a>. You will need to specify a language per file, as an extension prefix (e.g. `content/blog/my-post.es.md`).
...
<comp.Annotation number="2">
  The [create option](/documentation/developer-articles/set-the-path-for-new-files/) controls the filename and path when creating new content files.
