...
For more information about connecting a source to imgix, please see their <a href="https://docs.imgix.com/getting-started/setup/creating-sources/amazon-s3" target="_blank" rel="noopener noreferrer">documentation</a>.

In this step, you will connect imgix to your S3 bucket.

1. Navigate to the <a href="https://dashboard.imgix.com/sources" target="_blank" rel="noopener noreferrer">Sources page</a> in the imgix dashboard.
