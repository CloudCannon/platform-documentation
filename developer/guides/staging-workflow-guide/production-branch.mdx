...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Details" alt="The Site Settings Details page showing the Editing Locked option." type="screenshot" />
