...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Details-Editing-Locked" alt="A screenshot of the Details page under Site Settings shows the Editing Locked toggle switched on." type="screenshot" />
