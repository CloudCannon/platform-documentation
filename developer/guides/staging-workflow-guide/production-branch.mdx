...
The `production` branch is what you show to your end-users. You might do this by [adding a Custom Domain in CloudCannon](/documentation/developer-articles/what-is-a-custom-domain/) or [deploying your built files](/documentation/developer-articles/configure-build-deploys) for external hosting.
