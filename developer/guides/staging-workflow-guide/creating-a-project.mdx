...
<comp.DocShot docshot_key="CloudCannon-Documentation-Project-Settings-Page" alt="A screenshot of the Create Project form in CloudCannon." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Project-Sites-Page" alt="A screenshot of the Project page showing the Sites list with an Add new site button." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Publishing-Settings" alt="The Publishing settings page showing the post-publishing behavior options." type="screenshot" />