...
<comp.DocShot docshot_key="CloudCannon-Documentation-Create-a-Project-Page" alt="A screenshot of the Create a Project page shows fields for Git Provider, Repository, Main Branch, and other settings." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Project-Sites-Browser" alt="A screenshot of the Project page shows the Sites list with a Create a Site button and one connected Site." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Publishing-Settings" alt="A screenshot of the Publishing page under Site Settings shows the Publish Branch, Publishing Method, and post-publishing behavior options." type="screenshot" />