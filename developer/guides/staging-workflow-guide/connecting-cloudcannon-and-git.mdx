...
<comp.DocShot docshot_key="CloudCannon-Documentation-Create-a-Site-Page-Complete" alt="A screenshot of the Create a Site page shows the File source, Repository, Branch, and Site name fields completed." type="screenshot" />
