...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Create-File-Source" alt="When adding a new site, you can edit with a template or build with your own files." type="screenshot" />
