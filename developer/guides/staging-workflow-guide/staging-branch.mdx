...
<comp.DocShot docshot_key="CloudCannon-Documentation-Create-a-Site-New-Branch" alt="The Create a Site page with the Create a new branch option selected, branching from main." type="screenshot" />
