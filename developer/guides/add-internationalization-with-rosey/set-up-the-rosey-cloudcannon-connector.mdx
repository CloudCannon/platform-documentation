...
In this part of the guide, you will install the *Rosey CloudCannon Connector*, modify your *CloudCannon Configuration File* to define a *Dataset* for each locale, and update your postbuild script. For more information, see the <a href="https://github.com/CloudCannon/rosey-cloudcannon-connector" target="_blank" rel="noopener noreferrer">full documentation on GitHub</a> or contact our friendly <a href="https://cloudcannon.com/support/">support team</a>.
...
<comp.OptionsTable>
  <comp.OptionsRow label="data-rcc" type_markdown="Boolean">
...
Marks this wrapper as the snapshot boundary, so the Connector clones the entire region — including navigation and footer — when switching locales. Without this attribute, only `<main>` would be swapped.
  ...
  <comp.OptionsRow label="data-rcc-ignore" type_markdown="Boolean">
  ...
  <comp.OptionsRow label="data-rcc-exclude" type_markdown="String">
  ...
  <comp.OptionsRow label="data-rcc-verbose" type_markdown="Boolean">
