...
details:
  ...
  description: >-
    The Rosey CloudCannon Connector enables inline translation editing in the
    Visual Editor for multilingual Rosey sites.
...
<comp.DocsImage path="https://cc-dam.imgix.net/documentation/images/guides/add-rosey/08-2026/CloudCannon-Documentation-Visual-Editor-Rosey-Connector-Integration.png" alt="A screenshot of the Visual Editor show the Locale Switcher toll in the bottom right from the Rosey CloudCannon Connector integration." title="The Visual Editor with the Rosey CloudCannon Connector integration" type="screenshot"/>
