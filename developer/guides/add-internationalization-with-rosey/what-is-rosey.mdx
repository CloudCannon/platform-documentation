...
If you want to see your changes in context without saving and building your *Site*, you can edit each localized version of a page inline in the *Visual Editor* with the optional <comp.GlossaryTerm term="/user/glossary/r/rosey-cloudcannon-connector.yml">Rosey CloudCannon Connector</comp.GlossaryTerm>, covered in the second section of this guide.
