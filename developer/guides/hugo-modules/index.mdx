...
---
Welcome to the <a href="https://gohugo.io/hugo-modules/" target="_blank" rel="noopener noreferrer">Hugo Modules</a> guide. If you want to use themes and components from other repositories on your site, you are in the right place! To configure CloudCannon so that your Hugo modules install correctly, you must customize how CloudCannon loads your modules into your build.
