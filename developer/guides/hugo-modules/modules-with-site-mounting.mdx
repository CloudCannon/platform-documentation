...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Site-Mounting" alt="A screenshot of the CloudCannon app shows the Site Mountings page, with a section to add a mounted site to the local site." title="Add a mounted site" type="screenshot"/>
