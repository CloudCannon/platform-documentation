...
_created_at: 2025-11-03T23:53:18.000Z
details:
...
<comp.Notice info_type="important">
  <p>Currently, Component <em>Editable Regions</em> are only available for Astro and React. We are working to support more types. Please get in touch with our friendly <a href="https://cloudcannon.com/support/">support team</a> to make a request.</p>
</comp.Notice>
...
<comp.Notice info_type="info">
  <p>React is a dependency of this package. You may need to use <code>npm i</code> to install React if your local development environment is out of date.</p>
</comp.Notice>

For more information, you can visit CloudCannon's GitHub repository for the <a href="https://github.com/CloudCannon/editable-regions" target="_blank" rel="noopener noreferrer">Editable Regions NPM package</a>.
...
cta:
  ...
  link: "https://cloudcannon.com/support/"
...
<comp.DocsImage path="/assets/external_screenshots/CloudCannon-Documentation-Visual-Editing-Guide-CTA-Component.png" alt="A screenshot of a blog page on our Astro website shows a call to action component under the blog content." title="A blog page" type="screenshot"/>
