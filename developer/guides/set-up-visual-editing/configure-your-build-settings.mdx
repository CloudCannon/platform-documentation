...
<comp.DocShot docshot_key="CloudCannon-Documentation-Building-Toast-Notification" alt="A screenshot of the Content Editor with the Building notification in the bottom right shows a button labeled View Output." title="The Building notification" type="ui-snippet"/>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Build-Terminal-Modal" alt="A screenshot of the Content Editor with the Build Terminal modal open shows the progress of the current Site build." title="The Build Terminal modal" type="screenshot"/>
...
If your build fails, please reach out to our friendly <a href="https://cloudcannon.com/support/" rel="noreferrer">support team</a>.
