...
In this guide, we'll show you how to define each type of *Editable Region* using HTML attributes or web components. For a complete list of HTML attributes, please read our [Editable Regions reference](/documentation/developer-articles/editable-regions-reference/) documentation.
