...
_created_at: 2025-11-07T03:35:32Z
details:
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Editing-Interface-Header-Controls" alt="A screenshot of the Editing Interface Header Controls shows the Switch Editing Interface buttons." title="The Editing Interface Header Controls" type="ui-snippet"/>
...
The `url` template string `/[relative_base_path]/[slug]/` for our "Pages" *Collection* will resolve to the following output URLs:
