...
<comp.DocShot docshot_key="CloudCannon-Documentation-Confirm-Output-Files-Task" alt="A screenshot of the Confirm your output files task shows two collections with eight output files." title="The Confirm output files task" type="ui-snippet"/>
