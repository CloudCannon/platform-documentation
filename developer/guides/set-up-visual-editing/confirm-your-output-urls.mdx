...
<comp.DocShot docshot_key="CloudCannon-Documentation-Visual-Editor-Home" alt="A screenshot of the Visual Editor shows an interactive webpage preview." title="The Visual Editor" type="screenshot"/>
