...
_created_at: 2025-03-13T21:32:45.000Z
details:
  title: Introduction
  order: 1
  image: >-
...
<a href="https://www.okta.com/" target="_blank" rel="noopener noreferrer">Okta</a> is a cloud-based identity and access management (IAM) service that allows you to manage how your team members access the software they need.

This guide assumes that:

* You want to use Okta as your SSO Identity Provider.
* You already have Okta and CloudCannon accounts.
* Your Organization is on our <a href="https://cloudcannon.com/pricing/" target="_blank" rel="noopener">Enterprise plan</a>.
* You are a member of the Owner <a href="/documentation/user-articles/what-are-permission-groups/" target="_blank" rel="noopener">Permission Group</a> for your Organization.
...
<comp.Notice info_type="info">
  If you need any assistance setting up SSO/SAML for you Organization, please reach out to our friendly <a href="https://cloudcannon.com/support/">support team</a>.
</comp.Notice>
