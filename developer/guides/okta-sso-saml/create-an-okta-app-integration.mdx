...
_created_at: 2025-03-13T21:25:52.000Z
details:
...
Open <a href="https://www.okta.com/" target="_blank" rel="noopener noreferrer">Okta</a> in another tab. Log in and navigate to the *Applications* page under *Applications* in the sidebar.

Click the *Create App Integration* button. Okta will open the *Create a new app integration* modal.

<comp.DocsImage path="/assets/external_screenshots/Okta-Applications-Page.png" alt="A screenshot of the Okta Applications page shows the Create App Integration button." title="The Okta Applications page" type="screenshot"/>
...
<comp.DocsImage path="/assets/external_screenshots/Okta-Create-SAML-Sign-In-Method.png" alt="A screenshot of the Okta Applications page shows the Create a new app integration modal." title="The Okta Applications page" type="screenshot"/>

The first tab on the *Create SAML Integration* page is *General Settings*.

Enter "CloudCannon" in the *App name* text field. You also have the option to upload the <a href="https://cc-dam.imgix.net/documentation/images/icons/CloudCannon-Logo-Blue.svg" target="_blank" rel="noopener noreferrer">CloudCannon Logo</a>. Adding a logo can help you find the CloudCannon app integration in your list of integrations.

Click the *Next* button. Okta will open the *Configure SAML* tab.

<comp.DocsImage path="/assets/external_screenshots/Okta-Create-SAML-General-Settings.png" alt="A screenshot of the General Settings tab on the Create SAML Integration page shows fields for app name and logo." title="The Create SAML Integration page" type="screenshot"/>
...
<comp.DocsImage path="/assets/external_screenshots/Okta-Create-SAML-Configure-SAML.png" alt="A screenshot of the General Settings tab on the Create SAML Integration page shows fields for the SSO URL and Entity ID." title="The Create SAML Integration page" type="screenshot"/>
