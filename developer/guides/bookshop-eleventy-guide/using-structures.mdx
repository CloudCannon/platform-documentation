...
<comp.Annotation number="1">
  ...
  This should be the attribute name of any <a href="https://fonts.google.com/icons" target="_blank" rel="noopener noreferrer">Material Icon</a>.
</comp.Annotation></comp.CodeBlock>
...
<comp.DocsImage path="assets/deprecated/new-sample-component.png" alt="A data editor panel open in CloudCannon showing the initialized state of a new Sample component when added to the page" type="ui-snippet"/>
