...
<comp.DocsImage path="/assets/deprecated/sendit-data-binding.png" alt="An example page matching the aforementioned code block, showing a data panel open in CloudCannon's visual editor after interacting directly with a component."  type="ui-snippet"/>