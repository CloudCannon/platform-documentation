...
<comp.Notice info_type="info">
  As a useful reference, the <a href="https://github.com/CloudCannon/eleventy-bookshop-starter/" target="_blank" rel="noopener noreferrer">Eleventy Bookshop Starter</a> repository
...
<comp.OptionsTable>
  <comp.OptionsRow label="bookshop/bookshop.config.cjs" type_markdown="">
  ...
  <comp.OptionsRow label="components/" type_markdown="">
    This is where you will write your component files, a sample component has been added for you.
  </comp.OptionsRow>
  <comp.OptionsRow label="shared/eleventy/" type_markdown="">
  ...
  <comp.OptionsRow label="shared/styles/" type_markdown="">
