...
- **YAML files**: Add a `# yaml-language-server` comment at the top of the file (requires the [Red Hat YAML extension](https://marketplace.visualstudio.com/items?itemName=redhat.vscode-yaml) in VS Code/Cursor)
