...
details:
  ...
  related_articles:
    - _type: developer_articles
      item: 6cfe8c59-733f-45eb-89c1-ae8d6fa951d8
author_notes:
  ...
  ui: ok
  notes: |
    Integromat has been renamed to Make; the in-page Notice links to the
    `integrating-your-forms-with-make-formerly-integromat` doc. Rewrite
    this page as a redirect or sunset.
---
...
<comp.DocsImage path="assets/external_screenshots/www-integromat-com-scenario-add.png" alt="The scenario creation screen in Integromat" type="screenshot" />
