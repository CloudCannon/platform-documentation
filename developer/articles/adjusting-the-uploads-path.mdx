...
details:
  ...
  related_articles:
    ...
    - _type: developer_articles
      item: 7630a593-3a92-49c0-8557-627ddd5112fe
    - _type: developer_articles
...
<comp.ReferenceDataTable>
  <comp.ReferenceDataRow section="type.Configuration" ref_key="type.paths.dam_uploads" display_label="collections_config.*.paths.dam_uploads" />
  <comp.ReferenceDataRow section="type.Configuration" ref_key="type.paths.dam_uploads_filename" display_label="collections_config.*.paths.dam_uploads_filename" />
  <comp.ReferenceDataRow section="type.Configuration" ref_key="type.paths.static" display_label="collections_config.*.paths.static" />
  <comp.ReferenceDataRow section="type.Configuration" ref_key="type.paths.uploads" display_label="collections_config.*.paths.uploads" />
  <comp.ReferenceDataRow section="type.Configuration" ref_key="type.paths.uploads_filename" display_label="collections_config.*.paths.uploads_filename" />
  <comp.ReferenceDataRow section="type.Configuration" ref_key="type.paths.uploads_use_relative_path" display_label="collections_config.*.paths.uploads_use_relative_path" />
</comp.ReferenceDataTable>
