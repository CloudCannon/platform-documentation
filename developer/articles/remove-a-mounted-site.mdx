...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Site-Mountings-Context-Menu" alt="A screenshot of the Site Mountings page showing a mounted site with the context menu open, displaying the Unmount option." type="screenshot" />