...
```
const file = api.currentFile(); /*1*/
const element = document.querySelector('#hero-image'); /*2*/

element.addEventListener('click', (event) => { /*3*/
  const rect = element.getBoundingClientRect(); /*4*/
  file.data.edit({ /*5*/
    slug: 'hero_image', /*6*/
    position: { /*7*/
      x: event.clientX,
