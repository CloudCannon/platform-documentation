...
You can use the *Visual Editor API* to add, remove, and reorder items in an [Array Input](/documentation/user-articles/what-is-an-array-input/), either in the *Front Matter* of a content file or in a data file.
