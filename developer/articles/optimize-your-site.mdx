...
author_notes:
  docshots: Added!
---
CloudCannon optimizes sites to load as fast as possible. CloudCannon minifies CSS with <a href="https://github.com/GoalSmashers/clean-css" target="_blank" rel="noopener noreferrer">clean-css</a> and JavaScript with <a href="https://esbuild.github.io/" target="_blank" rel="noopener noreferrer">esbuild</a>. Externally hosted assets are not optimized.
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Build-Settings-Compressor" title="Compressor settings screen" alt="Screenshot of compressor settings screen" type="screenshot" />
