...
<comp.Notice info_type="info">
  Invalid JSON data in the `routing.json` file will cause your Site [builds](/documentation/user-articles/what-is-a-site-build/) to fail, protecting the live version of your Site. You can troubleshoot your JSON using the [build output logs](/documentation/user-articles/what-is-a-site-build/#reading-your-build-output-logs).
</comp.Notice>
