...
For a complete list of options available in the `routing.json` file, please read our [routing reference](/documentation/developer-articles/routing-reference/) documentation.
...
For more a complete list of configuration keys available for custom routing, please read our [routing reference documentation](/documentation/developer-articles/routing-reference/).
...
<comp.Notice info_type="info">
  CloudCannon supports a specific set of headers. For a complete list, please read our [routing](/documentation/developer-articles/routing-reference/) reference documentation.
</comp.Notice>
