...
details:
  ...
  related_articles:
    ...
    - _type: developer_articles
      item: 5a6b7c8d-9e0f-1a2b-3c4d-5e6f7a8b9c0d
author_notes:
...
* **Status** — Tells the visitor's browser the reason for the route using an <a href="https://en.wikipedia.org/wiki/List_of_HTTP_status_codes" target="_blank" rel="noopener noreferrer">HTTP status code</a>.
...
For more information, please contact our friendly <a href="https://cloudcannon.com/support/">support team</a>.
