...
details:
  ...
  related_articles:
    - /articles/defining-your-collections
    - /articles/creating-collection-schemas
    - /articles/structures-reference
    - /articles/editing-objects-in-your-data
    - /articles/using-arrays-to-edit-your-data
tags:
  - migration
related_links: null
---
...
2. Snippet Picker
3. [Structures](/documentation/articles/what-is-a-structure/) inside [Array inputs](/documentation/articles/what-is-an-array-input/)
...
7. Non-structure items inside [Array inputs](/documentation/articles/what-is-an-array-input/)
