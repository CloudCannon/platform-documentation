...
author_notes:
  ...
  ui: ok
  notes: |
    Migration content for legacy preview-options configuration
    consolidation. Audience has mostly migrated; keep accessible for
    inbound search but no proactive audit needed.
---
