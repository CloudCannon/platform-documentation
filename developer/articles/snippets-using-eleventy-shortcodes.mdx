...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Unknown-Shortcode" title="The Content Editor with an unconfigured shortcode" alt="The Content Editor showing an Unknown Shortcode block for an unconfigured custom shortcode." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Snippet-Edit-Panel" title="The Content Editor with a Snippet edit panel" alt="The Content Editor showing a Tint Snippet block selected with the data editor panel open, displaying Color and Inner Text inputs." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Callout-Snippet-Edit-Panel" title="The Content Editor with a Callout Snippet edit panel" alt="The Content Editor showing a Callout Snippet block selected with the data editor panel open, displaying Type and Inner Text inputs." type="screenshot" />
...
<comp.OptionsTable>
  <comp.OptionsRow label="shortcode_name" type_markdown="String">
    The name of your shortcode, as used in your Eleventy content files.
  </comp.OptionsRow>
  <comp.OptionsRow label="positional_args" type_markdown="Array of [argument options](#argument-options)">
...
<comp.OptionsTable>
  ...
  <comp.OptionsRow label="named_args" type_markdown="Array of [argument options](#argument-options)">
...
<comp.OptionsTable>
  <comp.OptionsRow label="include_name" type_markdown="String">
...
<comp.OptionsTable>
  <comp.OptionsRow label="render_name" type_markdown="String">
...
<comp.OptionsTable>
  <comp.OptionsRow label="component_name" type_markdown="String">
...
<comp.OptionsTable>
  ...
  <comp.OptionsRow label="implied_boolean" type_markdown="Boolean">
