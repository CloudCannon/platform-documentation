...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Callout-Snippet-Edit-Panel" alt="The Content Editor showing a Callout Snippet block selected with the data editor panel open, displaying Type and Inner Text inputs." type="screenshot" />
