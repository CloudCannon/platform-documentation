...
CloudCannon can create archives of your <comp.GlossaryTerm term="/user/glossary/s/site.yml">Site</comp.GlossaryTerm> source files at any point in time. Backups protect against unintentional deletions and give you a snapshot of your files as they were at a specific date and time. You can create backups from *Site Settings* / *Backups* and download them when needed.
