...
<comp.DocShot docshot_key="CloudCannon-Documentation-Collection-Add-Options" alt="A closeup of the Collection Browser Add menu shows a schema for creating new articles." type="screenshot" />

Here is how the new article looks in the Content Editor.

<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor" alt="The Content Editor in CloudCannon shows a file with content populated by a schema." type="screenshot" />

When you create a file using a schema, a hidden `_schema` input is added to the front matter of that file. This input is visible in the [Source Editor](/documentation/user-articles/what-is-the-source-editor/) but hidden in the sidebar of the Visual or Content Editor, and contains the name of the schema a file uses.
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Collection-Add-Options" alt="A closeup of the Collection Browser shows multiple options in the Add dropdown." type="screenshot" />
