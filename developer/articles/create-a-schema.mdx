...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Schema-File" alt="The Content Editor shows a Customer Story file with front matter inputs and Markdown content populated by a schema." type="screenshot" />
