...
<comp.CodeBlock language="Markdown" source=".cloudcannon/schemas/customer-story.md">
```
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Collection-Add-Options" alt="A closeup of the Collection Browser Add menu shows a schema for creating new articles." title="A schema in the collection Add menu" type="screenshot" />

Here is how the new article looks in the Content Editor.

<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Schema-File" title="The Content Editor" alt="The Content Editor shows a Customer Story file with front matter inputs and Markdown content populated by a schema." type="screenshot" />
...
<comp.CodeBlock language="Markdown" source="acme-corp-grows-email-list.md">
```
