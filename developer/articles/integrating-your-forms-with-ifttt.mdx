...
1. If you haven't already, create an IFTTT account <a href="https://ifttt.com/join" target="_blank" rel="noopener noreferrer">here</a>.
...
<comp.DocsImage path="assets/external_screenshots/ifttt-com-create.png" alt="The IFTTT applet create screen" type="screenshot" />
