...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Settings-GitHub-Enterprise-Configured" alt="A screenshot of the Organization Settings page for GitHub Enterprise Server shows the configured and authenticated state with Authentication, Server, and Danger Zone tabs." title="The GitHub Enterprise Server Organization Settings page after configuration" type="screenshot"/>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Syncing-Select-GitHub-Enterprise" alt="The Site Settings Syncing page with GitHub Enterprise Server repository selected from the provider dropdown and an Authenticate button." type="screenshot" />
