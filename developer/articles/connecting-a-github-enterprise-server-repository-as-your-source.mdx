...
Before configuring your GitHub Enterprise Server, you need to <a href="https://docs.github.com/en/enterprise-server@3.7/developers/apps/building-github-apps/creating-a-github-app" target="_blank" rel="noopener noreferrer">Create a new GitHub App</a>. You only need to do this once per server. We recommend creating the App under a GitHub Organisation.
...
2. Fill the **Register new GitHub App** with the following:
   ...
   * **Webhook secret**: A random <a href="https://docs.github.com/en/developers/webhooks-and-events/webhooks/securing-your-webhooks#setting-your-secret-token" target="_blank" rel="noopener noreferrer">string with high entropy</a>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-GitHub-Enterprise-Config-Form" title="The Organization Settings page for GitHub Enterprise Server" alt="The Organization Settings page for GitHub Enterprise Server showing the initial configuration form with fields for Endpoint, Authorize URL, Token URL, GitHub App details, and keys." type="screenshot" />

<comp.DocShot docshot_key="CloudCannon-Documentation-Org-GitHub-Enterprise-Authenticated" alt="A screenshot of the Organization Settings page for GitHub Enterprise Server shows the configured and authenticated state with Authentication, Server, and Danger Zone tabs." title="The GitHub Enterprise Server settings" type="screenshot"/>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Syncing-Select-GitHub-Enterprise-Complete" title="The Syncing page with GitHub Enterprise connected" alt="The Site Settings Syncing page with GitHub Enterprise Server repository selected, showing a connected repository and branch." type="screenshot" />
