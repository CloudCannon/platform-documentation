...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-GitHub-Enterprise-Config-Form" alt="The Organization Settings page for GitHub Enterprise Server showing the initial configuration form with fields for Endpoint, Authorize URL, Token URL, GitHub App details, and keys." type="screenshot" />

<comp.DocShot docshot_key="CloudCannon-Documentation-Org-GitHub-Enterprise-Authenticated" alt="A screenshot of the Organization Settings page for GitHub Enterprise Server shows the configured and authenticated state with Authentication, Server, and Danger Zone tabs." title="The GitHub Enterprise Server Organization Settings page after configuration" type="screenshot"/>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Syncing-Select-GitHub-Enterprise-No-Authorization" alt="The Site Settings Syncing page with GitHub Enterprise Server repository selected from the provider dropdown and an Authenticate button." type="screenshot" />
