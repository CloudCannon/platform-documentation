...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Syncing-Select-GitHub-Enterprise-Complete" alt="The Site Settings Syncing page with GitHub Enterprise Server repository selected, showing a connected repository and branch." type="screenshot" />
