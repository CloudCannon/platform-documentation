...
<comp.DocShot docshot_key="CloudCannon-Documentation-Client-Sharing-Settings-Tab" title="The Settings tab on the Client Sharing page" alt="A screenshot of the Settings tab on the Client Sharing page shows the three fields for Preview URL, Documentation URL, and Support URL." type="screenshot" />
