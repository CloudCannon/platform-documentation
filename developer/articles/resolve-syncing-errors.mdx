...
_created_at: 2024-03-13T21:32:56.000Z
details:
  ...
  related_articles:
    - _type: user_articles
      item: cb6c5e62-9546-4f66-839a-6a170297fe8d
    - _type: user_articles
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Syncing-Sync-Conflict" alt="A screenshot of the Syncing page shows resolution options for a sync conflict, including creating a new branch, resetting from the Git repository, and switching to a different branch." title="The Syncing page with resolution options" type="screenshot"/>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Syncing-Sync-Conflict" alt="A screenshot of the Syncing page shows an error banner with options to reconnect with local changes or discard local changes and reconnect." title="The Syncing page with a Syncing error" type="screenshot"/>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Syncing-Change-Branch-Modal-Element" alt="A screenshot of the Switch branch modal shows options to use an existing branch or create a new branch, with a branch dropdown and action buttons." title="The Switch branch modal" type="ui-snippet"/>
