...
<comp.DocShot docshot_key="CloudCannon-Documentation-Syncing-Sync-Error" alt="A screenshot of the Syncing page shows an error banner with options to reconnect with local changes or discard local changes and reconnect." title="The Syncing page with a Syncing error" type="screenshot"/>
