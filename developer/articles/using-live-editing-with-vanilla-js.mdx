...
## CloudCannon Events
When your website is loaded in the Visual Editor, CloudCannon will trigger <a href="https://developer.mozilla.org/en-US/docs/Web/Events/Creating_and_triggering_events" target="_blank" rel="noopener noreferrer">CustomEvents on the global document object</a>. This is a feature available in all major browsers.
