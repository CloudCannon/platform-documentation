...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Unknown-Shortcode" alt="The Content Editor showing an Unknown Shortcode block for an unconfigured custom shortcode." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Snippet-Edit-Panel" alt="The Content Editor showing a Tint Snippet block selected with the data editor panel open, displaying Color and Inner Text inputs." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Callout-Snippet-Edit-Panel" alt="The Content Editor showing a Callout Snippet block selected with the data editor panel open, displaying Label and Inner Text inputs." type="screenshot" />
