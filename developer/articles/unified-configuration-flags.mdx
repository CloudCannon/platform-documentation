...
details:
  ...
  related_articles:
    ...
    - _type: developer_articles
      item: 8d1f22d6-4957-4714-8f85-77beb3427a18
author_notes:
  docshots: Needs docshots
---
<comp.Notice info_type="important">
  <p>As of October 2024, CloudCannon uses the Unified Configuration format for your CloudCannon configuration file by default for all new Sites. Site created before this data can also upgrade to the Unified Configuration format.</p><p>For more information, please read our guide on <a href="/documentation/developer-guides/unified-configuration-migration-guide/">migrating to Unified Configuration</a> or contact our friendly <a href="https://cloudcannon.com/support/">support team</a>.</p>
</comp.Notice>
...
All Sites can enable this behavior independently from migrating to the Unified Configuration file format. You can enable this behavior by checking the *Enable live configuration and data reloading* flag on the *Flags* page of your Site, under *Site Settings*.
