...
<comp.DocShot docshot_key="CloudCannon-Documentation-Array-Input" alt="A screenshot of the Array input in the Data Editor, showing a preview of the content within multiple entries." type="ui-snippet" />
