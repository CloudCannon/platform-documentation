...
details:
  ...
  description: Learn how to configure the previews for a structure. Structures with custom styling are a good way to create an intuitive experience for your team members
...
At the top of this configuration file, we have also defined a few inputs (i.e., `staff`, `profile_picture`, and `job_description`). For more information on this, read our documentation on [configuring your inputs](/documentation/developer-articles/configure-your-inputs).
