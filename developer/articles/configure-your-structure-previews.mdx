...
<comp.DocShot docshot_key="CloudCannon-Documentation-Array-Input-Structure-Preview" alt="The sidebar of the Content Editor shows an array with structure options configured." type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Array-Input-Structure-Modal" alt="The dropdown shows options for an array with structure options configured." type="ui-snippet" />
