...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Structure-Array" alt="The sidebar of the Content Editor shows an array with structure options configured." type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Structure-Array-Dropdown" alt="The dropdown shows options for an array with structure options configured." type="ui-snippet" />
