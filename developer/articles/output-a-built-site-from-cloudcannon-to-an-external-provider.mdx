...
<comp.DocShot docshot_key="CloudCannon-Documentation-Build-Deploys-Connected" alt="A screenshot of the Build Deploys page shows a connected output provider with branch, deploy step, and excluded paths settings." title="The Build Deploys page with a connected provider" type="screenshot"/>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Build-Deploys-Change-Branch-Modal-Element" alt="A screenshot of the Change branch modal on the Build Deploys page shows a branch dropdown for selecting the output branch." title="The Change branch modal on the Build Deploys page" type="ui-snippet"/>
