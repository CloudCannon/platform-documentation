...
<comp.DocShot docshot_key="CloudCannon-Documentation-Build-Deploys-Change-Branch-Modal" alt="A screenshot of the Change branch modal on the Build Deploys page shows a branch dropdown for selecting the output branch." title="The Change branch modal on the Build Deploys page" type="ui-snippet"/>
