...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Site-Sharing-Edit-Permission-Group-Modal" alt="A screenshot of the Edit Permission Group modal shows one field to select which Site Sharing Permission Group a team member belongs to." title="The Edit Permission Group modal" type="screenshot"/>