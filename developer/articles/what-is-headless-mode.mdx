...
details:
  ...
  related_articles:
    - _type: developer_articles
      item: cccfaa53-f9f0-4692-81e9-dec08505cf9d
    - _type: developer_articles
...
Headless Mode is useful if you want to host a website with server-side rendering (SSR), or a fully hosted API, using a third-party service while still using CloudCannon as your primary <comp.GlossaryTerm term="/user/glossary/c/cms.yml">CMS</comp.GlossaryTerm>.
