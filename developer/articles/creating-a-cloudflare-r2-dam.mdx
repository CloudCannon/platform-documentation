...
<comp.DocShot docshot_key="CloudCannon-Documentation-DAM-CloudflareR2-Settings" alt="Screenshot of the CloudCannon form for authenticating an R2 DAM" type="screenshot" />
