...
<comp.DocsImage path="external_screenshots/create-r2-bucket.png" alt="Screenshot of R2 section of the Cloudflare dashboard" type="screenshot" />
...
<comp.DocsImage path="external_screenshots/r2-initial-bucket-settings.png" alt="Screenshot of the bucket creation menu in Cloudflare" type="screenshot" />
...
<comp.DocsImage path="external_screenshots/r2-bucket-public-access.png" alt="Screenshot of the Public Access menu in Cloudflare" type="screenshot" />
...
<comp.DocsImage path="external_screenshots/r2-bucket-cors-policy.png" alt="Screenshot of the CORS policy editor in Cloudflare" type="screenshot" />
...
<comp.DocsImage path="external_screenshots/r2-manage-api-token.png" alt="Screenshot of the Cloudflare R2 dashboard overview" type="screenshot" />
