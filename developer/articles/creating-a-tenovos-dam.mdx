...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Assets-New-DAM-Modal-Tenovos" alt="The New DAM modal with Tenovos selected as the DAM provider, showing fields for Name, Base URL, API Endpoint, Content Endpoint, API Key, Client ID, Username, and Password." type="screenshot" />
