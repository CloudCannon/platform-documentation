...
<comp.DocShot docshot_key="CloudCannon-Documentation-Publishing-Page-Merge-Immediately" title="The app" alt="A screenshot of the CloudCannon app shows the Publishing page with a button to Publish pending changes." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Publishing-Page-Create-Pull-Request" title="The app" alt="A screenshot of the CloudCannon app shows the Publishing page with fields to describe changes and a Create Pull Request button." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Publishing-Page-Open-Pull-Request" title="The app" alt="A screenshot of the CloudCannon app shows the Publishing page with a button to Merge or Close a Pull Request and a list of changes." type="screenshot" />
