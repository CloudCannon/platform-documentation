...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Details" title="The Details page" alt="A screenshot of the Details page shows the Mode field with radio buttons for Hosted and Headless." type="screenshot" />
