...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Create-Upload-Folder" alt="Sync step of creating a site to add your files" type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-File-Browser-Controls-Add-Menu-Dropdown" alt="Adding files to your site using the File Browser" type="screenshot" />
