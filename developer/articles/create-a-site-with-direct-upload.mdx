...
<comp.DocShot docshot_key="CloudCannon-Documentation-File-Browser-Controls-Add-Menu-Dropdown" alt="Adding files to your site using the File Browser" type="ui-snippet" />
