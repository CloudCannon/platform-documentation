...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Insert-Snippet-Modal" alt="The Insert Snippet modal in the Content Editor, showing available snippets." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Insert-Snippet-Modal" alt="The Insert Snippet modal showing available snippet components." type="screenshot" />
