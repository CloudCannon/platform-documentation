...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Unknown-Shortcode" title="The Content Editor with an unconfigured shortcode" alt="The Content Editor showing an Unknown Shortcode block for an unconfigured custom component." type="screenshot" />
