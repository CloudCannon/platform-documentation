...
For advanced use cases, you can interact with the Visual Editor programmatically using the *Visual Editor API*. This JavaScript API lets you read and write content, listen for changes, and build custom editing interfaces from your site's code.

For more information, see [What is the Visual Editor API?](/documentation/developer-articles/what-is-the-visual-editor-api/).
