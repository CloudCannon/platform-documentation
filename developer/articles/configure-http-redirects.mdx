...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Routing-HTTPS-Redirect" alt="A screenshot of the Routing page shows the Redirect all HTTP traffic to HTTPS checkbox is ticked" type="screenshot" />