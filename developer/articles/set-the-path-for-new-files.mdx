...
Defining a `filename` data placeholder based on `date` and `title`, then slugifies that to remove the potential leading hyphens when `date` is unset (`slugify` removes leading and trailing hyphens):
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Save-Confirmation" title="The save confirmation modal" alt="The save confirmation modal shows Date and Title inputs from the create path data placeholders." type="screenshot" />
...
<comp.ReferenceDataTable>
  <comp.ReferenceDataRow section="type.Configuration" ref_key="type.create.extra_data" display_label="collections_config.*.create.extra_data" />
  <comp.ReferenceDataRow section="type.Configuration" ref_key="type.create.extra_data.*" display_label="collections_config.*.create.extra_data.*" />
  <comp.ReferenceDataRow section="type.Configuration" ref_key="type.create.path" display_label="collections_config.*.create.path" />
  <comp.ReferenceDataRow section="type.Configuration" ref_key="type.create.publish_to" display_label="collections_config.*.create.publish_to" />
</comp.ReferenceDataTable>
