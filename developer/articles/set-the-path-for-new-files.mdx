...
<comp.DocShot docshot_key="CloudCannon-Documentation-Save-Confirmation" alt="The save confirmation modal shows Date and Title inputs from the create path data placeholders." type="screenshot" />
