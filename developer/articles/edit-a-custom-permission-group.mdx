...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Settings-Team-Custom-Group-Settings-Tab" alt="A screenshot of the Marketing Team Permission Group page shows the permissions and options to manage them." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Settings-Team-Custom-Group-Settings-Tab" alt="A screenshot of the Custom Permission Group page shows permission settings that can be edited." type="screenshot" />
