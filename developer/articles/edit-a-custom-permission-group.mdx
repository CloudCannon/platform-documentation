...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Settings-Team-Custom-Group-Settings-Tab" title="The Marketing Team Permission Group page" alt="A screenshot of the Marketing Team Permission Group page shows permissions and the Add Permission button." type="screenshot" />
...
<comp.Notice info_type="info">
  You can only grant permissions that you already hold. CloudCannon will prevent you from adding a resource to a Permission Group if you do not hold that resource at the selected scope. For more information, please read our documentation on [selecting resources](/documentation/developer-articles/what-are-custom-permission-groups/#selecting-resources).
</comp.Notice>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Settings-Team-Custom-Group-Permission-Context-Menu" title="The Marketing Team Permission Group page" alt="A screenshot of the Marketing Team Permission Group page shows the context menu open on a permission card with Delete and Clone options." type="screenshot" />
...
<comp.Notice info_type="info">
  You can only remove a permission or exception when doing so does not widen access beyond what you hold. Deleting an exception restores the access it was removing, and deleting a file glob on a permission can expose a broader unrestricted permission, so CloudCannon will prevent the change unless you hold the underlying resource at that scope. Deleting a plain permission only narrows access and is always allowed. For more information, please read our documentation on [selecting resources](/documentation/developer-articles/what-are-custom-permission-groups/#selecting-resources).
</comp.Notice>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Settings-Team-Edit-Permission-Modal" title="The Edit permission modal" alt="A screenshot of the Edit permission modal shows the scope and resource tree for a Global permission with site:write." type="screenshot" />
