...
author_notes:
  ...
  ui: ok
  notes: |
    Copy-paste artifact in two procedure steps: lines 37 ("Delete a permission")
    and 77 ("Edit a permission") both read "Permission Group you want to delete"
    when the surrounding context is editing or deleting a permission inside the
    group. Should say "you want to edit" or "you want to update" to match the
    section heading.
---
