...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Settings-Team-Custom-Group-Settings-Tab" alt="A screenshot of the Marketing Team Permission Group page shows permissions and the Add Permission button." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Settings-Team-Custom-Group-Permission-Context-Menu" alt="A screenshot of the Marketing Team Permission Group page shows the context menu open on a permission card with Delete and Clone options." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Settings-Team-Edit-Permission-Modal" alt="A screenshot of the Edit permission modal shows the scope and resource tree for a Global permission with site:write." type="screenshot" />
