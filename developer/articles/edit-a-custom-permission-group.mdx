...
6. Select the scope using the *Scope* dropdown. If you select *Base Domain*, *Group*, *Project*, or *Site*, you must also choose the *Target* for that scope with the *Target* dropdown. Selecting a scope will automatically filter the resource tree.
...
<comp.Notice info_type="info">
  When you create a *Custom Permission Group*, CloudCannon will prevent you from granting a *Permission* to that *Group* that you do not have at the selected *Scope*. This behavior prevents *Permission* escalation. For more information, please read our documentation on [selecting resources](/documentation/developer-articles/what-are-custom-permission-groups/#selecting-resources).
</comp.Notice>
