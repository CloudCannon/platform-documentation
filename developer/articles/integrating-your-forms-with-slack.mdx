...
<comp.DocsImage path="assets/external_screenshots/api-slack-com-apps-webhooks.png" alt="The Slack Incoming Webhooks console" type="screenshot" />
...
Now if you submit to that Inbox, the submission data will be forwarded to Slack. See <a href="https://api.slack.com/reference/messaging/payload" target="_blank" rel="noopener noreferrer">here</a> for a reference on the kinds of data that Slack accepts.
