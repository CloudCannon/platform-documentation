...
<comp.Notice info_type="pricing">
  **Some advanced publishing workflow features are available only to customers on our Team and Enterprise plans.**

  Some features of this advanced publishing workflow are limited to customers on our [Team and Enterprise plans](/pricing/). Want to chat about whether this feature is right for you? Our support team is always <a href="mailto:success@cloudcannon.com?subject=A%20question%20about%20Projects" rel="noreferrer">happy to hear from you</a>.
</comp.Notice>
...
<comp.DocsImage path="https://cc-dam.imgix.net/documentation/images/projects/2023-Q4/CloudCannon-Documentation-Create-First-Project.png" alt="A screenshot of the CloudCannon app shows the Projects page with a 'create your first project' button." title="" type="screenshot"/>

<comp.DocsImage path="https://cc-dam.imgix.net/documentation/images/projects/2023-Q4/CloudCannon-Documentation-Create-Project.png" alt="A screenshot of the CloudCannon app shows a field for your git provider, repository, and main branch name." title="" type="screenshot"/>
...
<comp.DocsImage path="https://cc-dam.imgix.net/documentation/images/projects/2023-Q4/CloudCannon-Documentation-Project-First-Site.png" alt="A screenshot of the CloudCannon app shows fields for your new site name, repository, and branch setup." title="" type="screenshot"/>
...
* **Related Links** — Add quick links for your project team members. Read our documentation on [Add Related Links to your Project](/documentation/developer-articles/add-related-links-to-your-project/).
...
<comp.DocsImage path="https://cc-dam.imgix.net/documentation/images/projects/2023-Q4/CloudCannon-Documentation-Project-Sites-Page.png" alt="A screenshot of the CloudCannon app shows the Project page with a list of all the Project sites and a Project Settings tab." title="" type="screenshot"/>

<comp.DocsImage path="https://cc-dam.imgix.net/documentation/images/projects/2023-Q4/CloudCannon-Documentation-Create-Branch-Site.png" alt="A screenshot of the CloudCannon app shows the Create Site page with fields for the main site, new site name, and branch setup." title="" type="screenshot"/>
