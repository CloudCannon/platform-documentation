...
<comp.DocShot docshot_key="CloudCannon-Documentation-Create-a-Site-Repository-Dropdown" alt="The Create a Site page with GitHub authorized and the Repository dropdown open, listing available repositories." title="The Create a Site page" type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Details-Headless" alt="The Site Settings Details page with Headless Mode selected under Site Building Mode." title="The Details page with Headless Mode selected" type="screenshot" />
...
<comp.DocsImage path="assets/external_screenshots/import-selected.png" alt={null} type="screenshot" />

The next step is to select your SSG of choice. This is very similar to the build step in CloudCannon.

<comp.DocsImage path="assets/external_screenshots/netlify-build-commands.webp" alt={null} type="screenshot" />
