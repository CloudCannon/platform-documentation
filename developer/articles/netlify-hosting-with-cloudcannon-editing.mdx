...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Create-From-Git" alt="A screenshot of the Create a Site page showing Git repository selection." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Details-Page" alt="A screenshot of the Site Details page showing the Static Site Generator dropdown." type="screenshot" />
