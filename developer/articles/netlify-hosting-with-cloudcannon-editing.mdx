...
<comp.DocsImage path="external_screenshots/import-selected.png" alt={null} type="screenshot" />

The next step is to select your SSG of choice. This is very similar to the build step in CloudCannon.

<comp.DocsImage path="external_screenshots/netlify-build-commands.webp" alt={null} type="screenshot" />
