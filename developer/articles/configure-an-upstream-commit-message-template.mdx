...
Upstream commit messages use [template strings](/documentation/developer-articles/configure-your-template-strings/). To add an upstream commit template, add the key `upstream_commit_template` to the root level of your *CloudCannon Configuration File*.
