...
* **Remote artifact** — This determines which files are mounted and which events trigger new builds. You can set this to either *Source files* or *Build output* (available on <a href="https://cloudcannon.com/pricing/" rel="noreferrer">Team and Enterprise plans</a>).
...
If you are on our <a href="https://cloudcannon.com/pricing/" rel="noreferrer">Team or Enterprise plan</a>, Site Mounting also unlocks the ability to mount the build output of a site in addition to its source files.