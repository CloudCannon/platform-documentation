...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Settings-Site-Mountings-Page" title="The Site Mountings page" alt="A screenshot of the Site Mountings page in Org Settings, where the Sites mounted across your Organization are listed." type="screenshot" />

* **Local Site** — The recipient of files from another site.
* **Remote Site(s)** — The donor site.
* **Remote artifact** — This determines which files are mounted and which events trigger new builds. You can set this to either *Source files* or *Build output* (available on [Team and Enterprise Plans](https://cloudcannon.com/pricing/)).
...
If you are on our [Team or Enterprise Plan](https://cloudcannon.com/pricing/), Site Mounting also unlocks the ability to mount the build output of a site in addition to its source files.