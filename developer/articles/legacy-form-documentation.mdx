...
author_notes:
  ...
  ui: stale
  notes: |
    Replacement Forms docs exist (*What is a Form*, *Creating a Form*) but
    this page doesn't route readers to them — only the top-of-page notice
    mentions "the new forms feature" without links. Legacy code blocks
    (AJAX submission patterns, deprecated field names) may confuse readers
    about what still works. Plan a migration-guide-style rewrite or sunset.
---
