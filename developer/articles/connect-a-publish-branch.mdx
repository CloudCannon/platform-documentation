...
author_notes:
  ...
  ui: ok
---
The CloudCannon publishing workflow lets your team edit your content on a branch site. Team members can merge their changes into the <comp.GlossaryTerm term="/user/glossary/p/publish-branch.yml">Publish Branch</comp.GlossaryTerm> directly or with a pull request.
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Publishing-Connected" alt="A screenshot of the Publishing page shows a connected Publish Branch with options for merge mode, pull requests, and delete after publishing." title="The Publishing page with a connected Publish Branch" type="screenshot"/>
