...
<comp.Notice info_type="info">
  CloudCannon enables publishing workflows for branched sites inside a [Project](/documentation/developer-articles/what-is-a-project/) by default.
</comp.Notice>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Publishing-No-Branch" alt="A screenshot of the Publishing page shows the empty state with a search field and button to add a Publish Branch." title="The Publishing page before connecting a Publish Branch" type="screenshot"/>
