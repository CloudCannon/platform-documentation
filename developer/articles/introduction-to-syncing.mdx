...
<comp.DocShot docshot_key="CloudCannon-Documentation-Syncing-Connected" alt="A screenshot of the Syncing settings page shows a connected GitHub repository, the current branch, sync status, and additional settings for Git LFS and branched Site rebuilds." title="The Syncing settings page with a connected provider" type="screenshot"/>
...
1. [Merging](/documentation/developer-articles/merging-and-pull-requests/): A direct merge with no review process.
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Syncing-No-Provider" alt="A screenshot of the Syncing settings page shows the initial setup state with options to connect a Git provider to your site." title="The Syncing settings page before connecting a provider" type="screenshot"/>
