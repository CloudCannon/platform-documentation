...
<comp.Notice info_type="important">
  An *Access Key* is tied to your personal CloudCannon account and inherits your account's access and *Permissions*. Any program that holds it can take any action you can take across every <comp.GlossaryTerm term="/user/glossary/o/organization.yml">Organization</comp.GlossaryTerm> and <comp.GlossaryTerm term="/user/glossary/s/site.yml">Site</comp.GlossaryTerm> you belong to.
</comp.Notice>
