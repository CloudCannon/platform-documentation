...
<comp.Notice info_type="important">
  An *Access Key* belongs to your CloudCannon account, not to a single <comp.GlossaryTerm term="/user/glossary/s/site.yml">Site</comp.GlossaryTerm>. This differs from a [Bearer Token](/documentation/developer-articles/generate-a-bearer-token/), which grants a trusted application access to a single *Site*. Any program that holds your *Access Key* can take any action your account is authorized to take across every Organization and *Site* you belong to.
</comp.Notice>

<comp.DocShot docshot_key="CloudCannon-Documentation-Access-Keys-Page" alt="A screenshot of the Access Keys page in Account Settings shows the Create Access Key button above the Active Access Keys and Revoked Access Keys lists." title="The Access Keys page" type="screenshot" />
