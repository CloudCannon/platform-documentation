...
<comp.DocShot docshot_key="CloudCannon-Documentation-Save-Changes-Modal-Extra-Data-Element" alt="The Save Changes modal shows two fields for Message and Breaking Changes Message." type="ui-snippet" />
