...
details:
  ...
  related_articles:
    ...
    - _type: developer_articles
      item: 281bd649-3d81-48c1-bce4-b09b44f6842a
    - _type: developer_articles
      item: b81a259b-3cc9-406d-98df-d1e4ae58343c
author_notes:
  docshots: Added!
  priority: P2
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Save-Changes-Modal-Multiple-Commit-Templates-Element" alt="The Save Changes modal shows a commit message with a select and a text input." title="The Review changes modal" type="ui-snippet"/>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Save-Changes-Modal-Extra-Data-Element" title="The Save Changes modal" alt="The Save Changes modal shows two fields for Message and Breaking Changes Message." type="ui-snippet" />
...
<comp.ReferenceDataTable>
  <comp.ReferenceDataRow section="type.Configuration" ref_key="type._inputs" display_label="commit_templates[*]._inputs" />
  <comp.ReferenceDataRow section="type.Configuration" ref_key="commit_templates.[*].extra_data" display_label="commit_templates[*].extra_data" />
  <comp.ReferenceDataRow section="type.Configuration" ref_key="commit_templates.[*].extra_data.*" display_label="commit_templates[*].extra_data.*" />
  <comp.ReferenceDataRow section="type.Configuration" ref_key="commit_templates.[*].label" display_label="commit_templates[*].label" />
  <comp.ReferenceDataRow section="type.Configuration" ref_key="commit_templates.[*].template_path" display_label="commit_templates[*].template_path" />
  <comp.ReferenceDataRow section="type.Configuration" ref_key="commit_templates.[*].template_string" display_label="commit_templates[*].template_string" />
</comp.ReferenceDataTable>