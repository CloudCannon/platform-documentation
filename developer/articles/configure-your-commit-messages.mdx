...
You can configure a commit message by adding the array key `commit_templates` to your [global configuration file](/documentation/developer-articles/create-a-global-configuration-file/).
...
<comp.DocsImage path="https://cc-dam.imgix.net/documentation/images/editing/commit-messages/2024-05/CloudCannon-Documentation-Save-Changes-Modal-Multiple-Commit-Templates.png" alt="The Save Changes modal shows a commit message with a select and a text input." title="The Review changes modal" type="ui-snippet"/>
...
<comp.DocsImage path="https://cc-dam.imgix.net/documentation/images/editing/commit-messages/2024-05/CloudCannon-Documentation-Commit-Messages-Extra-Data.png" alt="The Save Changes modal shows two fields for Message and Breaking Changes Message." title="The Review Changes modal" type="ui-snippet"/>
