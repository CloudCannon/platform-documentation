...
<comp.Notice info_type="important">
  Managing your SSL certificate on CloudCannon requires you to host your Site through CloudCannon. If you are hosting your Site through an [external service](/documentation/developer-articles/what-is-external-hosting/), please review their documentation on SSL certification.
</comp.Notice>
...
Before you add an SSL certificate to your Site, you must [add a Custom Domain](/documentation/developer-articles/add-a-custom-domain-to-your-site/) to your [Organization](/documentation/user-articles/what-is-an-organization/).
