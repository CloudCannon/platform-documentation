...
<comp.DocsImage path="https://cc-dam.imgix.net/documentation/images/sharing/client-sharing/2024-05/CloudCannon-Documentation-Update-Client-Sharing-Settings.png" alt="A screenshot of the Settings tab on the Client Sharing pages shows a field to update the URL subpath of your Client Login page and a checkbox to prevent browsers asking to save Client passwords." title="The Client Sharing page" type="screenshot"/>
