...
<comp.DocShot docshot_key="CloudCannon-Documentation-Client-Sharing-Settings-Tab" title="The Settings tab on the Client Sharing pages" alt="A screenshot of the Settings tab on the Client Sharing pages shows a field to update the URL subpath of your Client Login page and a checkbox to prevent browsers asking to save Client passwords." type="screenshot" />
