...
details:
  ...
  related_articles:
    ...
    - _type: user_articles
      item: dc0eabff-27d7-4c59-9c0b-4db0b4b6b9c5
    - _type: user_articles
...
<comp.ReferenceDataTable>
  ...
  <comp.ReferenceDataRow section="type.Configuration" ref_key="type._inputs.*.(text-input).options.icon" />
  <comp.ReferenceDataRow section="type.Configuration" ref_key="type._inputs.*.(text-input).options.icon_background_color" />
  <comp.ReferenceDataRow section="type.Configuration" ref_key="type._inputs.*.(text-input).options.icon_color" />
  ...
  <comp.ReferenceDataRow section="type.Configuration" ref_key="type._inputs.*.(text-input).options.placeholder" />
  <comp.ReferenceDataRow section="type.Configuration" ref_key="type._inputs.*.(textarea-input).options.placeholder" />
  ...
  <comp.ReferenceDataRow section="type.Configuration" ref_key="type._inputs.*.(textarea-input).options.show_count" />
