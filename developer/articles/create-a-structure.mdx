...
<comp.DocShot docshot_key="CloudCannon-Documentation-Array-Input-Structure-Empty" title="An empty Array input with an Add button" alt="An empty array input in the Data Editor with an Add button for adding new items using a structure." type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Array-Inputs-with-Shared-Structure" title="The Data Editor" alt="A screenshot of the Data Editor shows two Array inputs using the same Structure." type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Array-Input-Structure-Dropdown" title="A dropdown menu" alt="A dropdown menu shows two structure options, Employee and Manager, when clicking the Add button on an array input." type="ui-snippet" />
