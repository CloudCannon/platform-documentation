...
<comp.DocShot docshot_key="CloudCannon-Documentation-Array-Input-Structure-Dropdown" alt="A dropdown menu shows two structure options, First and Second, when clicking the Add button on an array input." type="ui-snippet" />
