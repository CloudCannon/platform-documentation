...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Structure-Array-Dropdown" alt="An array with dropdown options from a structure." type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Structure-Array" alt="The sidebar of the Content Editor shows arrays using a structure." type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Structure-Array-Dropdown" alt="An array with dropdown options from the structure." type="ui-snippet" />
