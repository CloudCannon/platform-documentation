...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Structure-Empty-Array" alt="An empty array input in the Data Editor with an Add button for adding new items using a structure." type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Array-Inputs-with-Shared-Structure" alt="A screenshot of the Data Editor shows two Array inputs using the same Structure." type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Structure-Select-Dropdown" alt="A dropdown menu shows two structure options, First and Second, when clicking the Add button on an array input." type="ui-snippet" />
