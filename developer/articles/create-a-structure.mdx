...
<comp.DocShot docshot_key="CloudCannon-Documentation-Array-Input-Structure-Empty" alt="An empty array input in the Data Editor with an Add button for adding new items using a structure." type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Array-Input-Structure-Dropdown" alt="A dropdown menu shows two structure options, Employee and Manager, when clicking the Add button on an array input." type="ui-snippet" />
