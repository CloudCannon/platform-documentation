...
<comp.DataReference>
  <comp.DataReferenceRow label="_inputs.*.options.max_visible_lines" type_markdown="Integer">
  ...
  <comp.DataReferenceRow label="_inputs.*.options.min_visible_lines" type_markdown="Integer">
  ...
  <comp.DataReferenceRow label="_inputs.*.options.show_gutter" type_markdown="Boolean">
    This key toggles the line numbers and code-folding controls. Defaults to `true`.
  </comp.DataReferenceRow>
  <comp.DataReferenceRow label="_inputs.*.options.syntax" type_markdown="String">
  ...
  <comp.DataReferenceRow label="_inputs.*.options.tab_size" type_markdown="Integer">
    This key defines how many spaces each line is auto indented by, and how many spaces a tab is shown as. Defaults to `2`.
  </comp.DataReferenceRow>
  <comp.DataReferenceRow label="_inputs.*.options.theme" type_markdown="String">
