...
<comp.DocsImage path="ye_olde_images/gitlab-self-hosted-connect.png" alt="Settings page from Gitlab" title="" type="screenshot"/>
...
<comp.DocsImage path="ye_olde_images/files-source-syncing-gitlab-oauth.png" alt="A menu with a button labelled 'Authenticate with GitLab'." title="" type="screenshot"/>
...
<comp.DocsImage path="ye_olde_images/files-source-syncing-gitlab-token.png" alt="A form with fields for token and expiry date, and a submit button." title="" type="screenshot"/>
...
<comp.DocsImage path="ye_olde_images/gitlab-self-hosted-select-branch.png" alt="Settings page from Gitlab" title="" type="screenshot"/>
