...
details:
  ...
  category:
    - Instructions
  related_articles: ["a01c2606-bd15-4d5e-877f-1018cb6e2f72","fad6a760-07db-4f3b-8f69-82bd66e188cb"]
author_notes:
  docshots:
---
...
<comp.Notice info_type="info">
  To connect to a *GitLab.com* repository instead, follow the instructions listed for [GitLab](/documentation/developer-articles/connecting-a-gitlab-repository-as-your-source/).
</comp.Notice>
