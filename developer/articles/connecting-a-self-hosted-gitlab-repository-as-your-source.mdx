...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Syncing-Select-Self-Hosted-GitLab-No-Authorization" alt="The Site Settings Syncing page with Self-hosted GitLab repository selected from the provider dropdown and an Authenticate button." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Syncing-Select-Self-Hosted-GitLab-Complete" alt="The Site Settings Syncing page showing a Self-hosted GitLab repository and branch selected." type="screenshot" />
