...
<comp.DocShot docshot_key="CloudCannon-Documentation-Dashboard-README-Config-Off" alt="A screenshot of the Site Dashboard shows custom Markdown content at the top of the Summary tab." title="The Site Dashboard with README" type="screenshot"/>
