...
author_notes:
  ...
  ui: ok
  notes: |
    Description in details frontmatter has a template placeholder:
    "edit x in your data files or front matter". Fill in the missing word
    (likely "nested structured data" or "object data").
---
