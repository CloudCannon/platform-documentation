...
<comp.Notice info_type="info">
  Data files/folders (i.e., `data_config`) are different to fixed *Dataset*s (i.e., `_select_data`).

  For more information about fixed *Dataset*s, please read our documentation on [Select and Multiselect inputs](/documentation/user-articles/what-is-a-select-input/).
</comp.Notice>
