...
<comp.DataReference>
  ...
  <comp.DataReferenceRow label="data_config.[*].path" type_markdown="String">
    ...
    The value for this key is relative to your [Site source](/documentation/developer-articles/configuration-file-reference/#source). Each Collection must have a unique path.
