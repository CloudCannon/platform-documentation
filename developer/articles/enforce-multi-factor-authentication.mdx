...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Settings-Multi-Factor-Authentication-Page" alt="A screenshot of the Multi-factor Authentication page shows a checkbox and date field for enforcing MFA." type="screenshot" />
