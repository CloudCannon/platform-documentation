...
<comp.DocShot docshot_key="CloudCannon-Documentation-Build-Settings-Backups" alt="Starting a new backup from your source files and downloading backups from specified date time" type="screenshot" />
