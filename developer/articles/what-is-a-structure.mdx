...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Structure-Array" alt="The sidebar of the Content Editor shows an array with the options for Manager and Employee configured in the structure." type="ui-snippet" />
