...
For more information, including a list of all keys available for structure configuration, please read our reference documentation for [structures](/documentation/developer-articles/array-structures-reference/).
