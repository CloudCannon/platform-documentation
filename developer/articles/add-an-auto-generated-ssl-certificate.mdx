...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Settings-SSL-Certificates-Page" alt="A screenshot of the Custom Domain page under Site Settings shows the SSL tab with fields for Minimum TLS Version and Validation Method." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Custom-Domain-Validate-SSL" alt="A screenshot of the Custom Domain page shows two TXT records for your external DNS provider." type="screenshot" />
