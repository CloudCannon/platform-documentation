...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Custom-Domain-SSL-Element" alt="A screenshot of the SSL settings modal shows fields for Minimum TLS Version, Validation Method, and a wildcard certificate checkbox." type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Custom-Domain-SSL-TXT-Records" alt="A screenshot of the Custom Domain page shows two TXT records for your external DNS provider." type="screenshot" />
