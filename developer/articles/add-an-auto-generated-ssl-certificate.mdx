...
<comp.Notice info_type="info">
  If you have recently added your <comp.GlossaryTerm term="/user/glossary/c/custom-domain.yml">Custom Domain</comp.GlossaryTerm> to your *Site*, CloudCannon may need a few minutes to fetch your domain details before you can add an SSL certificate. If this process takes more than a few minutes, please contact our friendly [support team](https://cloudcannon.com/support/).
</comp.Notice>
