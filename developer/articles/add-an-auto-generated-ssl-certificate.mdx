...
<comp.Notice info_type="info">
  If you have recently added your <comp.GlossaryTerm term="/user/glossary/c/custom-domain.yml">Custom Domain</comp.GlossaryTerm> to your *Site*, CloudCannon may need a few minutes to fetch your domain details before you can add an SSL certificate. If this process takes more than a few minutes, please contact our friendly <a href="https://cloudcannon.com/support/" rel="noreferrer">support team</a>.
</comp.Notice>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Configure-SSL-Auto-Generated-Modal-Element" alt="A screenshot of the SSL settings modal shows fields for Minimum TLS Version, Validation Method, and a wildcard certificate checkbox." title="The Configure SSL modal" type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Custom-Domain-Subdomain-SSL-Pending" alt="A screenshot of the Custom Domain subdomain page shows the SSL status is pending." title="The subdomain page with pending SSL" type="screenshot" />
