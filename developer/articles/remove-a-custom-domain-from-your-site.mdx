...
A Custom Domain is a unique address used to identify a website (e.g., <a href="https://cloudcannon.com/">cloudcannon.com</a>). You can connect a Custom Domain to your CloudCannon Organiation and add it to a Site to host your website content on that domain.
