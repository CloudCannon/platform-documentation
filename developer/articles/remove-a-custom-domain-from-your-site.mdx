...
details:
  ...
  related_articles:
    ...
    - _type: developer_articles
      item: 26e8a313-a992-4d96-99f1-02eeb9e9f00d
author_notes:
  docshots: Added!
---
...
A Custom Domain is a unique address used to identify a website (e.g., <a href="https://cloudcannon.com/" rel="noreferrer">cloudcannon.com</a>). You can connect a Custom Domain to your CloudCannon Organiation and add it to a Site to host your website content on that domain.
