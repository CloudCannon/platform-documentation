...
<comp.DocsImage path="assets/diagrams/dam-diagram.svg" alt={"A diagram showing code changes going to the GIT repository and large files going to your DAM"} title="" type="ui-snippet"/>
...
* [Creating a Bynder DAM](/documentation/developer-articles/creating-a-bynder-dam/)
