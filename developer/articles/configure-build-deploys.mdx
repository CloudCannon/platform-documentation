...
---
You can deploy built files from CloudCannon to a Git repository, also called an "output repository". This feature is useful if you want to edit and [build your files](/documentation/developer-articles/what-is-a-site-build/) on CloudCannon, but host your website using a third-party service or private infrastructure.
...
* **Compress** — Deploy files to your output repository after CloudCannon has minified your assets. For more information, please read our documentation on [optimizing your Site](/documentation/developer-articles/optimize-your-site/).
