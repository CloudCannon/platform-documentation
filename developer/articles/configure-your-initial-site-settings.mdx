...
<comp.OptionsTable>
  <comp.OptionsRow label="ssg" type_markdown="String">
  ...
  <comp.OptionsRow label="mode" type_markdown="String">
  ...
  <comp.OptionsRow label="build" type_markdown="Object">
  ...
  <comp.OptionsRow label="build.hugo_version" type_markdown="String">
    This key determines which version of Hugo is installed in your build environment.
  </comp.OptionsRow>
  <comp.OptionsRow label="build.ruby_version" type_markdown="String">
    This key determines which version of Ruby is installed in your build environment.
  </comp.OptionsRow>
  <comp.OptionsRow label="build.node_version" type_markdown="String">
    This key determines which version of Node is installed in your build environment.
  </comp.OptionsRow>
  <comp.OptionsRow label="build.deno_version" type_markdown="String">
