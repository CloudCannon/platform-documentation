...
<comp.DocShot docshot_key="CloudCannon-Documentation-Create-New-Group-Page" alt="A screenshot of the Create A New Group page shows the options to add a name, permissions, and exceptions to a Custom Permission Group." title="The Create a new Group page" type="screenshot" />
