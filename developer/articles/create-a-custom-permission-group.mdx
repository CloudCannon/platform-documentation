...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Settings-Team-Add-Permission-Modal-Global-Scope" alt="A screenshot of the Add permission modal in CloudCannon, showing the Scope dropdown and the resource tree for choosing resources and their actions." title="The Add permission modal" type="screenshot" />
