...
<comp.Notice info_type="info">
  You can only grant permissions that you already hold. CloudCannon will prevent you from creating a Permission Group with a resource you do not hold at the selected scope. For more information, please read our documentation on [selecting resources](/documentation/developer-articles/what-are-custom-permission-groups/#selecting-resources).
</comp.Notice>
