...
_created_at: 2025-11-21T00:14:57Z
details:
...
When you split your configuration, we recommend starting with a single section (e.g., one <comp.GlossaryTerm term="Collection">Collectino</comp.GlossaryTerm> *Collection* under `collections_config` or your *Site*\-scope Inputs under `_inputs`) and testing that the configuration behaves as expected before moving on to other sections.
