...
You can use the top-level `markdown` key in your [global configuration file](/documentation/developer-articles/create-a-global-configuration-file/) to define how CloudCannon should parse and save your Markdown content.
