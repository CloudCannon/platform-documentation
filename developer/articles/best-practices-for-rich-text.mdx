...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Unsupported-HTML" alt="Unsupported HTML in the rich text editor will appear as an uneditable Snippet." title="Uneditable Snippets in rich text" type="ui-snippet"/>
