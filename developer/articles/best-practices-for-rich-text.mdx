...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Snippet-Toolbar" alt="The WYSIWYG toolbar in the Content Editor, showing tools for formatting rich text including the Insert Snippet button." type="ui-snippet" />
