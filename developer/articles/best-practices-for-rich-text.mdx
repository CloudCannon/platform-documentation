...
* Create a [Snippet](/documentation/user-articles/what-is-a-snippet/). Depending on your SSG, there are libraries of Snippets available, or you can create custom Snippets.
...
For more information, please read our [rich text editor reference](/documentation/developer-articles/rich-text-editor-reference/#custom-markup).