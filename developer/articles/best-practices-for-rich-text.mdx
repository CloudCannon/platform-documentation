...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Unsupported-HTML" alt="Unsupported HTML in the rich text editor will appear as an uneditable Snippet." title="Uneditable Snippets in rich text" type="screenshot"/>
...
* Use postprocessing to add the desired HTML during the build (e.g., using Hugo's <a href="https://gohugo.io/templates/render-hooks/" target="_blank" rel="noopener noreferrer">Markdown render hooks</a>).
