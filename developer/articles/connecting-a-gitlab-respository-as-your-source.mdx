...
<comp.DocShot docshot_key="CloudCannon-Documentation-Syncing-Select-GitLab" alt="The Site Settings Syncing page with GitLab repository selected from the provider dropdown and an Authenticate button." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Syncing-GitLab-Repo-Branch-Selected" alt="The Site Settings Syncing page showing a GitLab repository and branch selected." type="screenshot" />
