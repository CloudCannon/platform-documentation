...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Syncing-Select-GitLab-No-Authorization" title="The Syncing page with GitLab selected" alt="The Site Settings Syncing page with GitLab repository selected from the provider dropdown and an Authenticate button." type="screenshot" />
...
See GitLab's <a href="https://docs.gitlab.com/ee/user/group/settings/group_access_tokens.html" target="_blank" rel="noopener noreferrer">Group access tokens</a> documentation for how to create and configure a token.
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Syncing-Select-GitLab-Complete" title="The Syncing page with GitLab connected" alt="The Site Settings Syncing page showing a GitLab repository and branch selected." type="screenshot" />
