...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Syncing-Select-GitLab-No-Authorization" alt="The Site Settings Syncing page with GitLab repository selected from the provider dropdown and an Authenticate button." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Syncing-Select-GitLab-Complete" alt="The Site Settings Syncing page showing a GitLab repository and branch selected." type="screenshot" />
