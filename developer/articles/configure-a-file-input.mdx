...
A [File input](/documentation/articles/what-is-a-file-input/) is an editing interface for file paths, allowing you to upload a file to your repository or [DAM](/documentation/developer-articles/integrating-your-dam-with-cloudcannon/), or add links to external files. By configuring your inputs, you can customize the appearance and functionality for a better editing experience.
...
<comp.DataReference>
  <comp.DataReferenceRow label="paths" type_markdown="Object">
    ...
    * `uploads_use_relative_paths`
    ...
    For more information, please read our documentation on [Rich Text editors](/documentation/developer-articles/what-are-rich-text-editors/) or [File inputs](/documentation/articles/file-inputs/).
