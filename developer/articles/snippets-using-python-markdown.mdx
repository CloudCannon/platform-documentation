...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Snippet-Toolbar" alt="The CloudCannon Content Editor toolbar showing the Insert Snippet button." type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Unknown-HTML-Block" alt="The Content Editor showing an unknown HTML block that cannot be edited." type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Python-Snippet-Glossary" alt="The Content Editor showing a Glossary Snippet block." type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Python-Snippet-Diagram-Edit-Panel" alt="The Content Editor showing a Diagram Snippet block selected with the data editor panel open, displaying the Content input." type="screenshot" />
