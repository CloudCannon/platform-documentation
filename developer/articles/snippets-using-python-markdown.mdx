...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Snippet-Toolbar" title="The Content Editor toolbar" alt="The CloudCannon Content Editor toolbar showing the Insert Snippet button." type="ui-snippet" />
...
The Abbreviation snippet allows you to add standard <a href="https://python-markdown.github.io/extensions/abbreviations/" target="_blank" rel="noopener noreferrer">Python Markdown abbreviations</a> to your content.
...
The Admonition snippet allows you to add standard <a href="https://python-markdown.github.io/extensions/admonition/" target="_blank" rel="noopener noreferrer">Python Markdown admonitions</a> to your content.
In addition, collapsible admonitions from the <a href="https://facelessuser.github.io/pymdown-extensions/extensions/details/" target="_blank" rel="noopener noreferrer">Details extension</a> are supported 
...
the <a href="https://facelessuser.github.io/pymdown-extensions/extensions/inlinehilite/" target="_blank" rel="noopener noreferrer">InlineHilite extension</a> with the
Inline Code snippet:
...
The Tabs snippet supports creating tabbed content using the <a href="https://facelessuser.github.io/pymdown-extensions/extensions/tabbed/" target="_blank" rel="noopener noreferrer">Tabbed extension</a>.
...
The Icon snippet adds support for adding graphics with the <a href="https://facelessuser.github.io/pymdown-extensions/extensions/emoji/" target="_blank" rel="noopener noreferrer">Emoji extension</a>.
...
The Arithmatex snippets allow you to insert LaTeX style math equations which work with the <a href="https://facelessuser.github.io/pymdown-extensions/extensions/arithmatex/" target="_blank" rel="noopener noreferrer">Arithmatex extension</a>.
...
## Custom Snippets
Some Python extensions don't work out of the box and require additional configuration. These are the <a href="https://facelessuser.github.io/pymdown-extensions/extensions/snippets/" target="_blank" rel="noopener noreferrer">Snippet extension</a> and the <a href="https://python-markdown.github.io/extensions/md_in_html/" target="_blank" rel="noopener noreferrer">Markdown in HTML extension</a>.
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Unknown-HTML-Block" title="The Content Editor" alt="The Content Editor showing an unknown HTML block that cannot be edited." type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Python-Snippet-Glossary" title="The Content Editor" alt="The Content Editor showing a Glossary Snippet block." type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Python-Snippet-Diagram-Edit-Panel" title="The Content Editor" alt="The Content Editor showing a Diagram Snippet block selected with the data editor panel open, displaying the Content input." type="screenshot" />

## Snippet options
The following options are available for custom snippets:

<comp.OptionsTable>
  <comp.OptionsRow label="template" type_markdown="String">
    The template that this snippet should inherit, out of the available [Python Markdown Templates](#python-markdown-templates).
  </comp.OptionsRow>
  <comp.OptionsRow label="definitions" type_markdown="Object">
    The variables required for the selected template.
  </comp.OptionsRow>
  <comp.OptionsRow label="inline" type_markdown="Boolean">
  ...
  <comp.OptionsRow label="preview" type_markdown="Object">
  ...
  <comp.OptionsRow label="_inputs" type_markdown="Object">
...
<comp.OptionsTable>
  <comp.OptionsRow label="snippet_name" type_markdown="String">
...
<comp.OptionsTable>
  <comp.OptionsRow label="tag_name" type_markdown="String">
    The HTML tag name of your element.
  </comp.OptionsRow>
  <comp.OptionsRow label="content_key" type_markdown="String">
    The key to use in the data panel for editing the inner contents of the element.
  </comp.OptionsRow>
  <comp.OptionsRow label="tag_attributes" type_markdown="Array of [argument options](#argument-options)">
...
<comp.OptionsTable>
  ...
  <comp.OptionsRow label="optional" type_markdown="Boolean">
  ...
  <comp.OptionsRow label="remove_empty" type_markdown="Boolean">
    Whether this argument should be omitted from the output shortcode if the value is empty.

    Defaults to `false`.
  </comp.OptionsRow>
  <comp.OptionsRow label="allowed_values" type_markdown="Array of values">
