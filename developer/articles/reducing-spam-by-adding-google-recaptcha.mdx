...
author_notes:
  ...
  ui: needs_check
  notes: |
    reCAPTCHA v3 token flow and the Google admin console screenshots haven't
    been refreshed since 2021. Verify the v3 integration pattern and the
    API-key creation walkthrough against Google's current docs.
---
