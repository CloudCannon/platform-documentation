...
<comp.DocsImage path="external_screenshots/hosting-forms-captcha.gif" alt="Gif of Google ReCAPTCHA succesfully verifying" title="" type="screenshot-snippet"/>
...
<comp.DocsImage path="external_screenshots/hosting-forms-401-error.png" alt="Screenshot of form-submission failure screen" title="" type="screenshot"/>
