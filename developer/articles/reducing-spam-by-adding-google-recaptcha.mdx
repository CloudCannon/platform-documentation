...
details:
  ...
  related_articles:
    - _type: developer_articles
      item: a668e5c8-78d3-407a-88cf-c677638b2e98
author_notes:
  docshots: Needs docshots
---
<a href="https://developers.google.com/recaptcha/" target="_blank" rel="noopener noreferrer">reCAPTCHA</a> embeds a CAPTCHA in your page to help prevent spam. <a href="https://developers.google.com/recaptcha/" target="_blank" rel="noopener noreferrer">reCAPTCHA</a> requires additional configuration in the *Site Settings*.

<comp.DocsImage path="assets/external_screenshots/hosting-forms-captcha.gif" alt="Gif of Google ReCAPTCHA successfully verifying" title="" type="ui-snippet"/>

To add <a href="https://developers.google.com/recaptcha/" target="_blank" rel="noopener noreferrer">reCAPTCHA</a> to your site:

1. In your organisation settings, under *Hosting &gt; Forms* either create a new inbox or select *manage* on an existing inbox
2. Select <a href="https://developers.google.com/recaptcha/" target="_blank" rel="noopener noreferrer">reCAPTCHA</a> as your captcha provider.
3. Sign up for an API key at <a href="https://developers.google.com/recaptcha/" target="_blank" rel="noopener noreferrer">https://developers.google.com/recaptcha/</a>
4. Enter your secret as your captcha secret key, and your site key as your captcha site key.
5. Add reCAPTCHA to that form by following the instructions in the <a href="https://developers.google.com/recaptcha/intro" target="_blank" rel="noopener noreferrer">reCAPTCHA documentation</a>

Once configured, any form submissions that fails to validate will return a 401 error page.

<comp.DocsImage path="assets/external_screenshots/hosting-forms-401-error.png" alt="Screenshot of form-submission failure screen" title="" type="screenshot"/>
