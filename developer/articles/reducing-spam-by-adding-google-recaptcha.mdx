...
<comp.DocsImage path="assets/external_screenshots/hosting-forms-captcha.gif" alt="Gif of Google ReCAPTCHA succesfully verifying" title="" type="screenshot-snippet"/>
