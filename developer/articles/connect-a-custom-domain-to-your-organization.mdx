...
If you do not have at least one Custom Domain connected to your Organization, the *Domains* button in the *App Sidebar* opens the *Connect a Domain* page directly, without the *Domains Browser*.
