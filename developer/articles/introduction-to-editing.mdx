...
CloudCannon parses Markdown content into HTML for previewing and editing, and saves it in a format your <comp.GlossaryTerm term="/user/glossary/s/ssg.yml">SSG</comp.GlossaryTerm> recognizes. You can configure the Markdown engine (CommonMark or Kramdown) and its options to control how CloudCannon processes your content.
