...
<comp.DataReference>
  <comp.DataReferenceRow label="_inputs.*.options.allow_resize" type_markdown="Boolean">
    This key toggles the resize handler to vertically resize the text area of the input. Defaults to `true`.
  </comp.DataReferenceRow>
  <comp.DataReferenceRow label="_inputs.*.options.initial_height" type_markdown="Integer">
