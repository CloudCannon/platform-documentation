...
6. If you are adding captcha to prevent spam, follow the documentation (<a href="https://developers.google.com/recaptcha/docs/display" target="_blank" rel="noopener noreferrer">Google reCAPTCHA</a> or <a href="https://docs.hcaptcha.com/#add-the-hcaptcha-widget-to-your-webpage" target="_blank" rel="noopener noreferrer">hCaptcha</a>) to add the required code to your form.
