...
After a successful first build, CloudCannon will build your Site every time it syncs an update from your repository, or when you [choose to trigger a build](/documentation/user-articles/what-is-a-site-build/#starting-a-build). This ensures your most recent content is always live.
