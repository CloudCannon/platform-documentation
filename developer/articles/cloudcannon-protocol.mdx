...
<comp.OptionsTable>
  ...
  <comp.OptionsRow label="slug" type_markdown="string">
    Modelled after <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Property_accessors" target="_blank" rel="noopener noreferrer">JavaScripts property accessors</a>, this is a recursive representation of your desired object target. Starting from the base of your structure, name each item as a step towards your desired object. Each object or property is separated by a dot. An array item is denoted by an open square bracket, an integer starting from 0, followed by a closing square bracket (`[index]`).
  </comp.OptionsRow>
</comp.OptionsTable>
