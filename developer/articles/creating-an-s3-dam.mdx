...
<comp.DocsImage path="assets/external_screenshots/assets-s3-iam_policies.png" alt="Screenshot of IAM Policies dashboard" title="" type="regular"/>
...
<comp.DocsImage path="assets/external_screenshots/assets-s3-iam_users_console.png" alt="Screenshot of the AWS IAM Users dashboard" title="" type="regular"/>
