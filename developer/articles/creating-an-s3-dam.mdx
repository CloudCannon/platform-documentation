...
You will need an AWS account to use S3. If you haven't already, <a href="https://portal.aws.amazon.com/billing/signup" target="_blank" rel="noopener noreferrer">create an AWS account</a>, then sign in to the AWS console.

### Create your S3 bucket

Open the AWS Services menu (in the top left corner), and navigate to *Storage* / *S3*.

<comp.DocsImage path="assets/external_screenshots/assets-s3-aws_console_menu.png" alt="Screenshot of AWS services menu with S3 highlighted" title="" type="screenshot"/>
...
<comp.DocsImage path="assets/external_screenshots/assets-s3-aws_menu_cloudfront.png" alt="Screenshot of AWS Services menu with CloudFront highlighted" title="" type="screenshot"/>
...
<comp.DocsImage path="assets/external_screenshots/assets-s3-cloudfront_distribution_screen.png" alt="Screenshot of AWS CloudFront distribution after being created" title="" type="screenshot"/>

### Create an IAM policy

In the sidebar of the IAM console, navigate to *Access management* / *Policies*, then click **Create Policy**.

<comp.DocsImage path="assets/external_screenshots/assets-s3-iam_policies.png" alt="Screenshot of IAM Policies dashboard" title="" type="ui-snippet"/>
...
<comp.DocsImage path="assets/external_screenshots/assets-s3-aws_menu_iam.png" alt="Screenshot of the AWS Services menu with IAM highlighted" title="" type="screenshot"/>

In the Sidebar, navigate to *Access management* / *Users*, and click **Add users** in the top right of the page.

<comp.DocsImage path="assets/external_screenshots/assets-s3-iam_users_console.png" alt="Screenshot of the AWS IAM Users dashboard" title="" type="ui-snippet"/>
