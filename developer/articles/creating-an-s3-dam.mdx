...
<comp.DocsImage path="external_screenshots/assets-s3-aws_console_menu.png" alt="Screenshot of AWS services menu with S3 highlighted" title="" type="screenshot"/>
...
<comp.DocsImage path="external_screenshots/assets-s3-aws_menu_cloudfront.png" alt="Screenshot of AWS Services menu with CloudFront highlighted" title="" type="screenshot"/>
...
<comp.DocsImage path="external_screenshots/assets-s3-cloudfront_distribution_screen.png" alt="Screenshot of AWS CloudFront distribution after being created" title="" type="screenshot"/>

### Create an IAM policy

In the sidebar of the IAM console, navigate to *Access management* / *Policies*, then click **Create Policy**.

<comp.DocsImage path="external_screenshots/assets-s3-iam_policies.png" alt="Screenshot of IAM Policies dashboard" title="" type="regular"/>
...
<comp.DocsImage path="external_screenshots/assets-s3-aws_menu_iam.png" alt="Screenshot of the AWS Services menu with IAM highlighted" title="" type="screenshot"/>

In the Sidebar, navigate to *Access management* / *Users*, and click **Add users** in the top right of the page.

<comp.DocsImage path="external_screenshots/assets-s3-iam_users_console.png" alt="Screenshot of the AWS IAM Users dashboard" title="" type="regular"/>
