...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Settings-Team-Custom-Group-Members-Tab" alt="A screenshot of the Marketing Team Custom Permission Group page shows the Delete Group button." type="screenshot" />
