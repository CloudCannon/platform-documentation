...
8. Optional. If you also want to edit the contents of each array item in the Visual Editor, add [Text Editable Regions](/documentation/developer-articles/configure-text-editable-regions/) or [Image Editable Regions](/documentation/developer-articles/configure-image-editable-regions/) to the content inside each array item.
