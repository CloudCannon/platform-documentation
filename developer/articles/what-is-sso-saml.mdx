...
_created_at: 2024-05-01T03:59:50.000Z
details:
  ...
  related_articles:
    ...
    - _type: developer_articles
      item: d217df42-89fe-461e-8f35-b439fe3b8592
author_notes:
  docshots: Added!
---
<comp.Notice info_type="pricing">
  **This feature is available on our [Enterprise Plan](https://cloudcannon.com/pricing/).**
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Settings-Single-Sign-On" title="The Single Sign-On page" alt="A screenshot of the Single Sign-On page in Org Settings, where Owners configure SAML authentication for the Organization." type="screenshot" />
