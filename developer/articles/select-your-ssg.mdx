...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Details" alt="A screenshot of the Site Details page shows the dropdown to select a Static Site Generator for this Site." title="The Site Details page" type="screenshot"/>
