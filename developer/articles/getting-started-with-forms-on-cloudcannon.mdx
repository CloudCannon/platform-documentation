...
<comp.Notice info_type="important">
  Forms are only available for Sites hosted through CloudCannon. If you [host your Site externally](/documentation/developer-articles/what-is-external-hosting/), or use CloudCannon in [Headless Mode](/documentation/developer-articles/what-is-headless-mode/), Forms will not work.
</comp.Notice>
