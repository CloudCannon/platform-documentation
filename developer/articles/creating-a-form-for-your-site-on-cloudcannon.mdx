...
author_notes:
  ...
  priority: P2
  notes: |
    Documents the deprecated Legacy CloudCannon Forms (July 2024).
    Migration guide exists; rewrite this page as a redirect to the
    new Forms docs or sunset entirely.
---
