...
author_notes:
  ...
  ui: ok
  notes: |
    July 2024 deprecation of Legacy CloudCannon Forms; migration guide
    linked in the top notice. Rewrite this page as a redirect to the new
    Forms docs or sunset entirely.
---
