...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Schedule-Manual-Builds" title="The Schedule page for manual builds" alt="Manual Builds Schedule interface" type="screenshot" />
