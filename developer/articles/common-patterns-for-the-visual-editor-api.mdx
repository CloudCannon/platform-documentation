...
Each pattern below assumes you have a v1 <comp.GlossaryTerm term="/user/glossary/a/api-object.yml">API Object</comp.GlossaryTerm> available as `api`. The following shows one way to obtain it.
