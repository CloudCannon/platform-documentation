...
<comp.DataReference>
  <comp.DataReferenceRow label="_editables" type_markdown="Object">
    Contains options for the *WYSIWYG toolbar* in the Content Editor and rich text inputs. Read more about the [configuring your rich text toolbar options](/documentation/developer-articles/configuring-toolbars).
