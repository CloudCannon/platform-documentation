...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Authentication-SAML-Empty" alt="A screenshot of the Single Sign-On page shows the configuration details for initial set up of your Identity Provider." type="screenshot" />
