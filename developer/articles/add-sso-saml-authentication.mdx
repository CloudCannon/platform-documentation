...
<comp.Notice info_type="info">
  SAML can be tricky to configure. If you need assistance setting-up SSO/SAML, please don’t hesitate to contact our [support team](https://cloudcannon.com/support/).
</comp.Notice>
