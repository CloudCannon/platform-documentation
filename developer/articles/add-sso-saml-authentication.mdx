...
<comp.Notice info_type="info">
  SAML can be tricky to configure. If you need assistance setting-up SSO/SAML, please don’t hesitate to contact our <a href="https://cloudcannon.com/support/" rel="noreferrer">support team</a>.
</comp.Notice>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Settings-Single-Sign-On" title="The Single Sign-On page" alt="A screenshot of the Single Sign-On page shows the configuration details for initial set up of your Identity Provider." type="screenshot" />
