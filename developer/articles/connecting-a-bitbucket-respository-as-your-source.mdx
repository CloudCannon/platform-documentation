...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Syncing-Select-Bitbucket-No-Authorization" title="The Syncing page with Bitbucket selected" alt="The Site Settings Syncing page with Bitbucket repository selected from the provider dropdown and an Authenticate button." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Syncing-Select-Bitbucket-Complete" title="The Syncing page with Bitbucket connected" alt="The Site Settings Syncing page with a Bitbucket repository selected from the repository dropdown." type="screenshot" />
