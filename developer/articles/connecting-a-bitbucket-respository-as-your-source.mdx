...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Syncing-Select-Bitbucket-No-Authorization" alt="The Site Settings Syncing page with Bitbucket repository selected from the provider dropdown and an Authenticate button." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Syncing-Select-Bitbucket-Complete" alt="The Site Settings Syncing page with a Bitbucket repository selected from the repository dropdown." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Bitbucket-Authenticated" alt="A screenshot of the Organization Settings page for Bitbucket shows the authenticated state with the connected Bitbucket account." title="The Bitbucket Organization Settings page after authentication" type="screenshot"/>
