...
<comp.Notice info_type="important">
  If this Custom Domain uses [CloudCannon DNS](/documentation/developer-articles/configure-cloudcannon-dns/), CloudCannon manages its DNS records. Before you disconnect, [move your DNS to another provider](/documentation/developer-articles/configure-external-dns/) and keep your own copy of your DNS records. CloudCannon-assigned nameservers are not reissued once released, so your website and any custom email addresses on this domain can go down permanently.
</comp.Notice>
