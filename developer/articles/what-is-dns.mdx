...
* **Domain Name** — The unique address to access a website (e.g., <a href="https://cloudcannon.com/" rel="noreferrer">cloudcannon.com</a>).
...
<comp.DocsImage path="assets/diagrams/CloudCannon-Documentation-DNS-Lookup-Diagram.png" alt="A diagram of the DNS lookup process, where the DNS Resolver contacts various servers for the matching IP address for a given domain name." type="ui-snippet" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Domain-DNS-Tab" alt="A screenshot of the DNS tab on the Domain page shows a list of DNS records including A, CNAME, MX, and TXT records." title="The DNS tab on the Domain page" type="screenshot"/>
