...
_created_at: 2024-11-28T21:23:05Z
details:
  title: What is DNS?
  description: >-
...
Every [Custom Domain](/documentation/articles/what-is-a-custom-domain/) needs a DNS Provider.

* **DNS Provider** — A service that assigns IP addresses to domain names and manages DNS records.

When a user enters a domain name into their Internet browser or clicks a link to access a website, the DNS provider will translate (or resolve) the domain name to a machine-friendly IP address in a process called *DNS lookup*.
...
DNS providers allow you to access and edit the DNS records stored on your nameserver.
...
DNS records are instructions for a Domain Name managed by an authoritative nameserver.
...
CloudCannon DNS supports the following DNS record types: *A*, *AAAA*, *CNAME*, *MX*, *NS*, *SPF*, *SRV*, and *TXT*.
...
<comp.Notice info_type="info">
  You can configure NS records in CloudCannon or on your Domain Registrar, depending on the subdomain. For more information, please read our documentation on [configuring CloudCannon DNS](/documentation/articles/configure-cloudcannon-dns/).
</comp.Notice>