...
<comp.DocsImage path="assets/diagrams/CloudCannon-Documentation-DNS-Lookup-Diagram.png" alt="A diagram of the DNS lookup process, where the DNS Resolver contacts various servers for the matching IP address for a given domain name." type="photo" />
