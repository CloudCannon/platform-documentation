...
<comp.DocShot docshot_key="CloudCannon-Documentation-Domain-Settings-CloudCannon-DNS" alt="A screenshot of the Domain Settings page shows the DNS Provider is set to CloudCannon DNS." title="The Domain Settings page" type="screenshot"/>
