...
<comp.DocShot docshot_key="CloudCannon-Documentation-Build-Configuration-Environment-Variables" alt="A screenshot of the Build Configuration page shows a text field for configuring your environment variables and an Add Environment Variable button." title="The Build Configuration page" type="screenshot"/>
