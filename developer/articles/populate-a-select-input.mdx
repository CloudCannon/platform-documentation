...
<comp.DocShot docshot_key="CloudCannon-Documentation-Select-Input-Dropdown-Closed" alt="A screenshot of the Select input in the Data Editor." type="ui-snippet" />
