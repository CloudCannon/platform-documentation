...
<comp.Notice info_type="permissions">
  <p><strong>Permissions required</strong></p><p>Members of the <em>Owners</em>, <em>Developers</em>, and <em>Technical Editors</em> <a href="/documentation/articles/what-are-default-permission-groups/">Default Permission Groups</a>, or <a href="/documentation/articles/what-are-custom-permission-groups/">Custom Permission Groups</a> with the <code>site:source-editor:write</code> and <code>site:file:write</code> permissions, can edit your <em>CloudCannon Configuration File</em>. You can limit permission to specific files using <a href="/documentation/articles/what-are-custom-permission-groups/#specify-a-file-glob">file globs</a>.</p>
</comp.Notice>
