...
<comp.DocShot docshot_key="CloudCannon-Documentation-Collection-Add-Options-Offices" alt="A closeup of the Offices collection Add dropdown shows options for Add Office, Add Office Location, and Open external link." type="ui-snippet" />
