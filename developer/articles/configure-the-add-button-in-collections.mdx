...
<comp.DataReference>
  ...
  <comp.DataReferenceRow label="schema" type_markdown="String">
    ...
    Although useful, it's not required to configure schemas for the [initial contents of new files](/documentation/developer-articles/define-your-default-file-contents/).
  </comp.DataReferenceRow>
