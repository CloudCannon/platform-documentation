...
<comp.DocShot docshot_key="CloudCannon-Documentation-Collection-Add-Options" alt="Screenshot of a collection with add options configured" type="screenshot-snippet" />
