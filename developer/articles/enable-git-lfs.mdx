...
details:
  ...
  description: Git LFS is used to store large files outside your repository, but continue using them as if they were part of it. It's a great way to maintain a small repository size for faster syncing and builds, while keeping the external services you rely on the same.
