...
author_notes:
  docshots:
---
[Structures](/documentation/developer-articles/what-is-a-structure/) are part of the CloudCannon [configuration cascade](/documentation/articles/using-the-configuration-cascade/). You can configure them for your site as a whole and for a specific page or collection. You can define your structures in the following places:
