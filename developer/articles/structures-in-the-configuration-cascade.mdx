...
<comp.DocShot docshot_key="CloudCannon-Documentation-Structure-Page-Builder-Picker" alt="The sidebar of the Content Editor shows a Page Sections array with Hero, Content, and Call to action items, and a dropdown to add more." type="screenshot" />

<comp.DocShot docshot_key="CloudCannon-Documentation-Structure-Page-Builder-Elements-Picker" alt="The sidebar of the Content Editor shows nested structure options within the Content item, with Text and Image sub-elements." type="screenshot" />
