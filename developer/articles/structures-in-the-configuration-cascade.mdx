...
_created_at: 2024-02-13T01:20:26.000Z
details:
  ...
  related_articles:
    ...
    - _type: developer_articles
      item: fa64c62b-e687-4600-9f75-6a8a928dba69
    - _type: developer_articles
...
<comp.Annotation number="1">
  ...
  The key name of your sub-structure. In this code, we have called our sub-structure `elements`. The structures defined under `elements` will only be available within the item "Content" where `page_sections` is used in an array or object input.
</comp.Annotation>
</comp.MultiCodeBlock>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Structure-Page-Builder-Picker" title="The sidebar of the Content Editor" alt="The sidebar of the Content Editor shows a Page Sections array with Hero, Content, and Call to action items, and a dropdown to add more." type="screenshot" />

<comp.DocShot docshot_key="CloudCannon-Documentation-Structure-Page-Builder-Elements-Picker" title="The sidebar of the Content Editor" alt="The sidebar of the Content Editor shows nested structure options within the Content item, with Text and Image sub-elements." type="screenshot" />
