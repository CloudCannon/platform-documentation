...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Structure-Page-Builder" alt="The sidebar of the Content Editor shows a structure with options for Hero, Content, and Call to action." type="ui-snippet" />

<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor-Structure-Page-Builder" alt="The sidebar of the Content Editor shows nested structure options." type="ui-snippet" />
