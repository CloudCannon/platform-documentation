...
* Select which <comp.GlossaryTerm term="/user/glossary/t/team-member.yml">team members</comp.GlossaryTerm> can perform privileged actions, such as managing your billing or approving changes to your live website.
...
* [Managing your team members](/documentation/user-articles/what-is-a-team-member/) — learn what a team member is and how to add or remove them from your Organization.
* [Permission Groups](/documentation/user-articles/what-are-permission-groups/) — learn what a Permission Group is and what permissions are included in CloudCannon’s [Default Permission Groups](/documentation/user-articles/what-are-default-permission-groups/).
...
* [Site Sharing](/documentation/user-articles/share-a-site-with-site-sharing/) — learn how to give a team member permission to access a specific Site in your Organization.
* [Client Sharing](/documentation/user-articles/what-is-client-sharing/) — create a site-specific password to share your content with people outside of CloudCannon.
* [SSO/SAML](/documentation/developer-articles/what-is-sso-saml/) — set up Single Sign-On for greater security.
