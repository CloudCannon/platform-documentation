...
---
React allows you to add the `data-cms-bind` attribute on any DOM element. It is recommended that these are added recursively into each object. If you are using an older version of React, you may need to forward this on differently. Please refer to the <a href="https://reactjs.org/blog/2017/09/08/dom-attributes-in-react-16.html#data-and-aria-attributes" target="_blank" rel="noopener noreferrer">React documentation</a>.
