...
author_notes:
  ...
  ui: ok
  notes: |
    Ownership transfer between *Organizations* — high-stakes and
    irreversible (touches billing, SSL, custom domains, related Sites).
    Style: lines 41 and 55 use role-label phrasing ("owner/administrator",
    "administrator or owner") instead of permission-led language; rewrite
    against the permission system.
---
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Transfer-Site-Page" title="The Transfer Site page" alt="Screenshot of site transfer interface" type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Transfer-Requests-Incoming" title="The Transfer Requests page with incoming requests" alt="Screenshot of site transfer interface with transfer request incoming" type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Transfer-Requests-Outgoing" title="The Transfer Requests page with outgoing requests" alt="Screenshot of site transfer interface with outgoing site transfer" type="screenshot" />
