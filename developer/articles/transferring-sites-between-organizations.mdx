...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Transfer-Site-Page" alt="Screenshot of site transfer interface" type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Transfer-Requests-Incoming" alt="Screenshot of site transfer interface with transfer request incoming" type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Transfer-Requests-Outgoing" alt="Screenshot of site transfer interface with outgoing site transfer" type="screenshot" />
