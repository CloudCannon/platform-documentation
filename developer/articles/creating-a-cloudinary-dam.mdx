...
If you haven't already, <a href="https://cloudinary.com/users/register/free" target="_blank" rel="noopener noreferrer">sign up for a free Cloudinary account</a>. Once you have an account, <a href="https://cloudinary.com/users/login" target="_blank" rel="noopener noreferrer">log in to your Cloudinary management console</a>.
...
<comp.DocsImage path="assets/external_screenshots/assets-cloudinary_dashboard.png" alt="Screenshot of Cloudinary user dashboard" title="" type="screenshot"/>
