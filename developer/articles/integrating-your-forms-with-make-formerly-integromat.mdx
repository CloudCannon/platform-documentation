...
author_notes:
  ...
  ui: needs_check
  notes: |
    Walkthrough uses external screenshots of Make's UI (Integromat era);
    verify against Make's current scenario editor. Top-of-page Notice links
    to a separate `integrating-your-forms-with-integromat` doc — that
    sibling page is now flagged for redirect/sunset, so this link will
...
<comp.DocsImage path="assets/external_screenshots/make-scenarios-add.png" alt="The scenario creation screen from Make" type="screenshot" />
