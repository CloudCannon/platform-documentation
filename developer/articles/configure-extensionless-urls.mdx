...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Routing-Extensionless-URLs" alt="A screenshot of the Routing Page under Site Settings shows the checkboxes for Serve Extensionless URLs and Redirect to Extensionless URLs." type="screenshot" />