...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Routing-Extensionless-URLs" title="The Routing Page under Site Settings" alt="A screenshot of the Routing Page under Site Settings shows the checkboxes for Serve Extensionless URLs and Redirect to Extensionless URLs." type="screenshot" />