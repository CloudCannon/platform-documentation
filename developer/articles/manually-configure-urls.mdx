...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Configuration-Page" alt="A screenshot of the Build Configuration page shows the checkbox for Manually Configure URLs under the Build system options section." type="screenshot" />
