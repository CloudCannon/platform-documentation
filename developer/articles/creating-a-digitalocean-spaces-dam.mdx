...
<a href="https://www.digitalocean.com/products/spaces" target="_blank" rel="noopener noreferrer">DigitalOcean Spaces</a> is a scalable, performant data storage service, built to be compatible with Amazon's S3 interface. 
...
<a href="https://cloud.digitalocean.com/" target="_blank" rel="noopener noreferrer">Sign in to your DigitalOcean account</a>, and navigate to "Spaces" using the sidebar.
...
<comp.DocsImage path="assets/external_screenshots/digitalocean-spaces-create-bucket.png" alt="Screenshot of the bucket creation menu in DigitalOcean" type="screenshot" />
...
<comp.DocsImage path="assets/external_screenshots/digitalocean-spaces-cors-config.png" alt="Screenshot of the CORS policy editor in DigitalOcean" type="screenshot" />
...
<comp.DocsImage path="assets/external_screenshots/digitalocean-spaces-access-key.png" alt="Screenshot of the menu in DigitalOcean for creating API keys" type="screenshot" />
...
DigitalOcean Spaces is compatible with Amazon's S3 API, so you can use the AWS CLI to make changes to your bucket policy. <a href="https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html" target="_blank" rel="noopener noreferrer">See the AWS guide for installing the CLI here</a>.
...
<comp.DocShot docshot_key="CloudCannon-Documentation-DAM-DigitalOcean-Settings" title="The form for authenticating a DigitalOcean DAM" alt="Screenshot of the CloudCannon form for authenticating a DigitalOcean DAM" type="screenshot" />
