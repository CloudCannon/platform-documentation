...
<comp.DocsImage path="external_screenshots/digitalocean-spaces-create-bucket.png" alt="Screenshot of the bucket creation menu in DigitalOcean" type="screenshot" />
...
<comp.DocsImage path="external_screenshots/digitalocean-spaces-cors-config.png" alt="Screenshot of the CORS policy editor in DigitalOcean" type="screenshot" />
...
<comp.DocsImage path="external_screenshots/digitalocean-spaces-access-key.png" alt="Screenshot of the menu in DigitalOcean for creating API keys" type="screenshot" />
