...
<comp.DocShot docshot_key="CloudCannon-Documentation-DAM-DigitalOcean-Settings" alt="Screenshot of the CloudCannon form for authenticating a DigitalOcean DAM" type="screenshot" />
