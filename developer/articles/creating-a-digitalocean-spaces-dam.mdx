...
author_notes:
  ...
  ui: needs_check
  notes: |
    External screenshots show the DigitalOcean Spaces UI from 2023. The
    Spaces console has been reorganised since then; CORS policy and API-key
    creation steps need spot-checking against the current DigitalOcean
    interface.
---
