...
<comp.Notice info_type="pricing">
  **This feature is available on our <a href="https://cloudcannon.com/pricing/" rel="noreferrer">Team and Enterprise plans</a>.**
...
The maximum number of Custom Permission Groups you can create will depend on your <a href="https://cloudcannon.com/pricing/" rel="noreferrer">pricing plan</a>. For more information on Permission Groups in general, please read our documentation on [Permission Groups](/documentation/user-articles/what-are-permission-groups/).
...
Custom Permission Groups do everything Site Sharing does and more. For <a href="https://cloudcannon.com/pricing/" rel="noreferrer">Team and Enterprise customers</a>, we recommend using Custom Permission Groups rather than Site Sharing for finer control over your content.