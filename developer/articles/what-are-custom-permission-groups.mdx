...
For more information, including a complete list of resources available, please read our reference documentation on [permissions](/documentation/developer-articles/permissions-reference/).
...
Using the four Global Default Permission Groups, you cannot limit access to an individual Site. You can address this problem using [Site Sharing](/documentation/developer-articles/sharing-on-a-per-site-basis/) or using Custom Permission Groups.
