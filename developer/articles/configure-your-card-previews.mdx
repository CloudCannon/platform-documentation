...
<comp.DocsImage path="diagrams/preview-options.svg" alt="The anatomy of a card preview" title="" type="regular"/>
...
<comp.DocsImage path="diagrams/metadata.svg" alt="The layout of a cards metadata" title="" type="regular"/>
...
<comp.DocsImage path="diagrams/gallery-load-order.svg" alt="Different states of the gallery option" title="" type="regular"/>
