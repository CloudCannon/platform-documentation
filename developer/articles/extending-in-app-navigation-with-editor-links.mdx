...
details:
  ...
  description: >-
    Learn how to link to CloudCannon pages from the Visual Editor to create edit
    buttons and speed up navigation.
  image: >-
    https://cc-dam.imgix.net/documentation/images/default-thumbnail/2023-Q4/CloudCannon-Documentation-Thumbnail.png
  category: []
  related_articles:
    - _type: developer_articles
      item: 1b2d5441-52ed-470b-93a3-cee60f45865a
author_notes:
  ...
  ui: stale
  notes: |
    October 2025 deprecation pointing to Editable Regions or Bookshop —
    both replacement pages exist. Body still describes Editor Links UI that
    no longer appears in the app after the visual-editing redesign. Page
    title (*Linking to CloudCannon views*) drifts from the feature name
    commonly used elsewhere (*Editor Links*). Plan a sunset / redirect.
---
