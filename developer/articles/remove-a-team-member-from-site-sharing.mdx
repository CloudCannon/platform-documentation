...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Site-Sharing-Context-Menu" alt="A screenshot of the Site Sharing page showing a team member's context menu open, displaying the Remove from Site option." type="screenshot" />