...
The default value of *Delete this site after publishing* on new automatically created *Sites* comes from the [Delete branched site after publishing](/documentation/developer-articles/what-are-branch-defaults/) option in your *Branch Defaults*. To keep a specific *Site* in your *Project* after its *Pull Request* merges, [turn off Delete this site after publishing](/documentation/developer-articles/turn-on-delete-after-publishing/) on that *Site*.
