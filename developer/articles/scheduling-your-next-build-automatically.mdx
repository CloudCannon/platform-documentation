...
details:
  ...
  related_articles:
    ...
    - _type: developer_articles
      item: 1f2e3d4c-5b6a-7c8d-9e0f-1a2b3c4d5e6f
    - _type: developer_articles
...
<comp.Notice info_type="info">
  For Jekyll sites we recommend using our plugin, <a href="https://github.com/CloudCannon/jekyll-cloudcannon-schedule" target="_blank" rel="noopener noreferrer">jekyll-cloudcannon-schedule</a> to generate `_schedule.txt`. This will parse all posts set for the future and generate a build on that date.
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Schedule-Automatic-Builds" title="The Schedule page for automatic builds" alt="Automatic Builds Schedule interface" type="screenshot" />
