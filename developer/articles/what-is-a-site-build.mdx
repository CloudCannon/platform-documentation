...
details:
  ...
  description: Learn about building your Site in CloudCannon, including what happens during an build, how to review build logs, and why building might benefit your Site.
...
<comp.Notice info_type="info">
  Building is an optional step. If your Site is dynamic, or you only want to use CloudCannon as a CMS for your Git repository, you don’t need to build. For more information, please read our guide on using [CloudCannon in Headless Mode](/documentation/developer-guides/headless-starter-guide/).
</comp.Notice>
...
Setting up your first Site build requires some configuration. For more information, please read our documentation on [configuring your first build](/documentation/developer-articles/configuring-your-build/). Once you have completed your first build you can trigger subsequent builds at any time.
