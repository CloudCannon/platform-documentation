...
<comp.DocShot docshot_key="CloudCannon-Documentation-Custom-Domain-Create-Zone" alt="A screenshot of the Domain Settings page shows the DNS Provider dropdown is set to CloudCannon DNS." title="The Domain Settings page" type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Custom-Domain-Add-Initial-Records" alt="A screenshot of the Custom Domain page under Site Settings shows the Unexpected Response Found warning for misconfigured Nameservers." title="The Custom Domain page" type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Custom-Domain-Nameserver-Success" alt="A screenshot of the Custom Domain page under Site Settings shows the Valid Response Found message." title="The Custom Domain page" type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Custom-Domain-Validate-SSL" alt="The Add DNS Record modal on the Domain Settings page shows fields for Type, Name, IPv4 Address and TTL." title="The Domain Settings page" type="screenshot" />
