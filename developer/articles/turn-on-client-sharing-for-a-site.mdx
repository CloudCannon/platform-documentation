...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Client-Sharing-Page" title="The Client Sharing page" alt="A screenshot of the Client Sharing page shows fields for setting the Client password and enabling Client Sharing." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Client-Sharing-Enabled-Password-Tab" title="The Client Sharing page" alt="A screenshot of the Client Sharing page showing options to reset the password and disable Client Sharing." type="screenshot" />
