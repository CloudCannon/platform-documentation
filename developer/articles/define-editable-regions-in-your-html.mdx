...
author_notes:
  ...
  ui: stale
  notes: |
    Page documents the deprecated HTML class-based editable-regions
    mechanism (October 2025 deprecation notice at top, pointing to the new
    Editable Regions and Bookshop). Same deprecation pattern as
    `extending-in-app-navigation-with-editor-links` and
    `legacy-form-documentation` (both P0). Worth considering whether this
    page should be promoted to P0 alongside them for a coordinated sunset.
---
