...
details:
  ...
  related_articles:
    - _type: developer_articles
      item: 9ed938fc-3211-4641-8859-088852b930e4
    - _type: developer_articles
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Domain-Settings-External-DNS" alt="A screenshot of the Domain Settings page shows the DNS Provider dropdown is set to External DNS." title="The Domain Settings page" type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Custom-Domain-Orange-Cloud" alt="A screenshot of the Custom Domain page shows the Cloudflare Proxy with CloudCannon Origin option in the Hosting Setup dropdown." title="The Custom Domain page" type="screenshot" />
...
<comp.Notice info_type="important">
  We do not recommend this option unless you have specific set up requirements. For assistance setting up your DNS, please contact our friendly <a href="https://cloudcannon.com/support/" rel="noreferrer">support team</a>.
</comp.Notice>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Custom-Domain-Single-Origin" alt="A screenshot of the Custom Domain page shows the Single Origin option in the Hosting Setup dropdown." title="The Custom Domain page" type="screenshot" />
