...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Settings-Assets-Dam-Configuration-Tab" alt="The Configuration tab of an Azure DAM shows fields for Name, Base URL, Container name, Storage account name, Storage Access Key, and advanced options." title="The DAM Configuration tab" type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Assets-Update-DAM-Modal" title="The Update site DAM modal" alt="A screenshot of the Update site DAM modal shows fields for configuring a DAM linked to your site, including Reference Key and Uploads Locked options." type="screenshot" />
