...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Assets-Update-DAM-Modal" alt="A screenshot of the Update site DAM modal shows fields for configuring a DAM linked to your site, including Reference Key and Uploads Locked options." type="screenshot" />
