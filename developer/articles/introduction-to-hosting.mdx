...
* Testing Domains — Learn about the free Testing Domain provided by CloudCannon for each of your Sites
...
CloudCannon forms allow you to receive form submissions from visitors without requiring your own backend server. You can view submissions in CloudCannon, forward them to email, or integrate with external providers such as IFTTT, Make, Zapier, or Slack. Forms are only available for Sites hosted through CloudCannon.
