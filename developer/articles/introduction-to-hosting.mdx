...
* Forms — Learn how to collect form submissions in an *Inbox* and forward them on
...
A <comp.GlossaryTerm term="/user/glossary/c/custom-domain.yml">Custom Domain</comp.GlossaryTerm> is a unique address used to identify a website (e.g., <a href="https://cloudcannon.com/">cloudcannon.com</a>). To host your website through CloudCannon, you will need to connect your *Custom Domain* purchased from a *Domain Registrar*.
...
CloudCannon forms let you receive form submissions from visitors to your website without running a backend server. Each *Inbox* stores the submissions its forms receive, and can forward a copy to an email address or an external service such as Slack, Zapier, IFTTT, or Make.
...
* [What is an Inbox?](/documentation/developer-articles/what-is-an-inbox/)
* [How do Inbox limits work?](/documentation/developer-articles/how-do-inbox-limits-work/)
* [Create an Inbox](/documentation/developer-articles/create-an-inbox/)
* [Connect your Site to an Inbox](/documentation/developer-articles/connect-your-site-to-an-inbox/)
* [Create a Form](/documentation/developer-articles/create-a-form/)
* [Reduce spam with a CAPTCHA](/documentation/developer-articles/reduce-spam-with-a-captcha/)
* [What is an Inbox Target?](/documentation/developer-articles/what-is-an-inbox-target/)
* [Add a target to an Inbox](/documentation/developer-articles/add-a-target-to-an-inbox/)