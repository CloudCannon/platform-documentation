...
A <comp.GlossaryTerm term="/user/glossary/c/custom-domain.yml">Custom Domain</comp.GlossaryTerm> is a unique address used to identify a website (e.g., <a href="https://cloudcannon.com/" rel="noreferrer">cloudcannon.com</a>). To host your website through CloudCannon, you will need to connect your *Custom Domain* purchased from a *Domain Registrar*.
