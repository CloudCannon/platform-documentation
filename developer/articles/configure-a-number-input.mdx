...
details:
  ...
  related_articles:
    ...
    - _type: user_articles
      item: 9d8f2e1a-6b3c-4d7e-9f2a-5c1b8d3e4f0a
    - _type: user_articles
...
<comp.ReferenceDataTable>
  <comp.ReferenceDataRow section="type.Configuration" ref_key="type._inputs.*.options.empty_type(number)" />
  <comp.ReferenceDataRow section="type.Configuration" ref_key="type._inputs.*.options.max" />
  <comp.ReferenceDataRow section="type.Configuration" ref_key="type._inputs.*.options.max_message" />
  <comp.ReferenceDataRow section="type.Configuration" ref_key="type._inputs.*.options.min" />
  <comp.ReferenceDataRow section="type.Configuration" ref_key="type._inputs.*.options.min_message" />
  ...
  <comp.ReferenceDataRow section="type.Configuration" ref_key="type._inputs.*.options.step" />
</comp.ReferenceDataTable>
