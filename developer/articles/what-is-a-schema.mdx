...
<comp.DocShot docshot_key="CloudCannon-Documentation-Collection-Add-Options-Dropdown" alt="A closeup of the Collection Browser shows multiple options in the Add dropdown." type="ui-snippet" />
