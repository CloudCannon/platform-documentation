...
For more information, including a list of all keys available for schema configuration, please read our reference documentation for [schemas](/documentation/developer-articles/schemas-reference/).
