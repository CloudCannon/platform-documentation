...
<comp.DocShot docshot_key="CloudCannon-Documentation-Collection-Browser-Controls-Add-Menu-Dropdown" title="The Collection Browser" alt="A closeup of the Collection Browser shows the controls bar and multiple options in the Add dropdown." type="ui-snippet" />
