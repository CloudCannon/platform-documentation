...
<comp.DocShot docshot_key="CloudCannon-Documentation-Org-Settings-Team-Add-Permission-Modal-Global-Scope" title="The Add permission modal" alt="A screenshot of the Add permission modal in CloudCannon, showing the Scope dropdown and the resource permission tree used to choose resources and their actions." type="screenshot" />
