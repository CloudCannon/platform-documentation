...
<comp.DocShot docshot_key="CloudCannon-Documentation-Build-Settings-Sync-Paths" alt="Screenshot of build settings with sync paths configured" type="screenshot" />