...
<comp.DocShot docshot_key="CloudCannon-Documentation-Build-Settings-Sync-Paths" title="The Build Settings sync paths" alt="Screenshot of build settings with sync paths configured" type="screenshot" />