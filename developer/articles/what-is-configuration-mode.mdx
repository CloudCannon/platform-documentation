...
_created_at: 2025-10-06T01:38:29.000Z
details:
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Header-Tools-Post-Build" alt="A screenshot of the Site Header tools shows the Avatar List, Configuration Mode toggle, and the Save button with one unsaved change." title="The Site Header tools" type="ui-snippet"/>
