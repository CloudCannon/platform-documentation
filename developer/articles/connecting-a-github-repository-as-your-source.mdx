...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Syncing-Select-GitHub-No-Authorization" alt="The Site Settings Syncing page with GitHub repository selected from the provider dropdown and an Authenticate button." type="screenshot" />

This redirects you to GitHub. Enter your credentials to continue.

<comp.DocsImage path="assets/external_screenshots/files-source-syncing-github-authentication.png" alt="GitHub authentication screen" type="screenshot" />

Give CloudCannon access to your GitHub Account by clicking **Authorize CloudCannon**.

<comp.DocsImage path="assets/external_screenshots/files-source-syncing-github-authorisation.png" alt="GitHub connection screen" type="screenshot" />

You’ll be redirected back to CloudCannon and asked to install the GitHub App.

<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Syncing-Select-GitHub-Repository-Dropdown" alt="The Site Settings Syncing page with GitHub authenticated and a prompt to install the GitHub App to grant repository access." type="screenshot" />
...
<comp.DocsImage path="assets/external_screenshots/files-source-syncing-github-installing.png" alt="Install GitHub App" type="screenshot" />

You’ll be redirected back to CloudCannon  to pick a repository to connect.

<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Syncing-Select-GitHub-Complete" alt="The Site Settings Syncing page with a GitHub repository selected from the repository dropdown, showing the Configure the GitHub App link." type="screenshot" />
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Syncing-Select-GitHub-Configure-App" alt="The Installed GitHub App modal showing existing installations with a Configure access button." type="screenshot" />
