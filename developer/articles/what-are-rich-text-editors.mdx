...
<comp.DocShot docshot_key="CloudCannon-Documentation-Content-Editor" title="The Content Editor" alt="A screenshot of the Content Editor, an editing interface for content-heavy markup files." type="screenshot" />
