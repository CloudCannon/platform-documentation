...
<comp.DataReference>
  <comp.DataReferenceRow label="_inputs.*.options.format" type_markdown="String">
  ...
  <comp.DataReferenceRow label="_inputs.*.options.alpha" type_markdown="Boolean">
  ...
  <comp.DataReferenceRow label="_inputs.*.options.palette" type_markdown="Array of Strings">
  ...
  <comp.DataReferenceRow label="_inputs.*.options.hide_picker" type_markdown="Boolean">
