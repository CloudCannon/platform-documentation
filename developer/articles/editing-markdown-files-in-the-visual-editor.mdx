...
author_notes:
  ...
  ui: ok
  notes: |
    October 2025 deprecation notice at top, with links to Editable Regions
    and Bookshop. Part of the visual-editing deprecation cluster — plan a
    coordinated sunset / redirect rather than a per-page rewrite.
---
