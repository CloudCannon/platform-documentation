...
_created_at: 2025-09-24T23:06:22Z
details:
  ...
  related_articles:
    - _type: developer_articles
      item: ac8b1ed5-4844-4d1f-a526-dd0486312e43
    - _type: developer_articles
...
Source *Editable Regions* are one type of [Editable Region](/documentation/user-articles/what-are-editable-regions/) you can add to your layout and HTML-like files to enable visual editing. Source *Editable Regions* allow you to edit rich text stored in HTML.
