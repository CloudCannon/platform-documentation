...
<comp.DocShot docshot_key="CloudCannon-Documentation-Dashboard-No-README-Config-On" alt="A screenshot of the Site Dashboard with Configuration Mode on shows a purple + Add README button." title="The Site Dashboard" type="screenshot"/>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Dashboard-README-Config-On" alt="A screenshot of the Site Dashboard with Configuration Mode on shows a purple Edit README button." title="The Site Dashboard with README" type="screenshot"/>