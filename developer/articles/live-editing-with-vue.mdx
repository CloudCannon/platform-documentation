...
For an example integration, check out our <a href="https://cloudcannon.com/community/themes/sendit/" rel="noreferrer">Sendit Nuxt template</a>.
If you have any issues, please <a href="https://cloudcannon.com/support/" rel="noreferrer">contact support</a>, or [raise an issue on the GitHub repository](https://github.com/CloudCannon/visual-editor-connector/issues).
