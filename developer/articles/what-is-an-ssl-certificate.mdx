...
On CloudCannon, any Site with a [Custom Domain](/documentation/developer-articles/what-is-a-custom-domain/) can use an [auto-generated SSL certificate](/documentation/developer-articles/https-support-for-your-sites-hosted-on-cloudcannon/) or a [custom SSL certificate](/documentation/developer-articles/add-a-custom-ssl-certificate/). Auto-generated SSL certificates can be either wildcard or single-domain certificates.
...
For more information, please read our documentation on [adding an auto-generated SSL certificate](/documentation/developer-articles/https-support-for-your-sites-hosted-on-cloudcannon/).
