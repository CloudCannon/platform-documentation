...
author_notes:
  ...
  ui: ok
  notes: |
    The TLS 1.2 minimum / 1.3 available claim and the ZeroSSL + Cloudflare
    auto-generation partnership claims should be verified against the
    current CloudCannon SSL infrastructure before any rewrite.
---
