...
type: minor
---
Cloudinary assets can now be previewed using the CloudCannon browser, instead of the Cloudinary widget. You can toggle this behaviour in your organisation's DAM settings. Read more about this option <a target="_blank" rel="noopener" href="/articles/creating-a-cloudinary-dam/">in our documentation</a>.
