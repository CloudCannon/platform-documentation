...
* When you configure input validation for an input, CloudCannon will require the input value to meet predefined criteria before you can save your changes. If the value of the input does not meet
* CloudCannon will warn you if your input value is invalid and provide directions on how to fix it.
