...
---
This release added Pull Request templates and minor improvements for the Source Editor.
...
* Fixed an issue where you would receive an incorrect error message when CloudCannon detects your *Site* is missing a Cloudflare hostname.