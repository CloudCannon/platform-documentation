---
_schema: default
title: Mandatory SSO or MFA for Enterprise Plans
---
This release added the option to enable mandatory SSO or MFA on Enterprise Plans and Annual payment for Lite Plans. It also updated Markdown configuration options, the Hugo and Node versions, and build image settings.
...
* Added options for configuring the way CloudCannon reads and saves Markdown. Read more about these options <a href="https://savvy-panther.cloudvent.net/documentation/articles/configure-your-markdown-engine" target="_blank" rel="noopener">here</a>.
* Added <a href="https://playwright.dev/" target="_blank" rel="noopener">playwright</a> support to the build image.
* The build image now has the previous hugo version (0.122.0) preinstalled
...
* Fixed an issue requiring you to add the asset source for branched Sites manually.
