...
* Added support for creating new items on the default *Pages* [collection](/documentation/articles/what-is-a-collection/)
...
* Increased limit of [redirect paths](/documentation/articles/configuring-custom-routing/) to 10000
