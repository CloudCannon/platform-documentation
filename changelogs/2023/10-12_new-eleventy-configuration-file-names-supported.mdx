...
* CloudCannon now supports new <a href="https://www.11ty.dev/docs/config/" target="_blank" rel="noopener noreferrer">Eleventy configuration file names</a> (v2.0.0) by default.
