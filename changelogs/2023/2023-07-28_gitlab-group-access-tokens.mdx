...
---
You can now authenticate with GitLab using a group access token, to give CloudCannon access to more finely scoped sets of resources. See [our documentation about this feature](/documentation/developer-articles/connecting-a-gitlab-repository-as-your-source/) for more information.
