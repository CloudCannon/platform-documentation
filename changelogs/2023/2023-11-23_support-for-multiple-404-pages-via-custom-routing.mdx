...
* Fixed an issue preventing the [Hugo shortcode](/documentation/articles/snippets-using-hugo-shortcodes/) `hugo_markdown_shortcode_positional_args` from working.
