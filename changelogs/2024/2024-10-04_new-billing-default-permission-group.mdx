...
date: 2024-10-04T05:00:00+12:00
---
...
* Improved error handling for misconfigured data\_config entries.
* Improved accessibility for the build suggestions section on the *Status* page after a failed build.

## Fixes

* Fixed an issue preventing you from building your Site if you set SYNC\_PATHS to a large directory.
