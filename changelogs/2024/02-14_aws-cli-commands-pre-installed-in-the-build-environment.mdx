...
* <a href="https://github.com/CloudCannon/reader" target="_blank" rel="noopener noreferrer">CloudCannon/reader@latest</a> is now pre-installed in the build environment to improve performance.