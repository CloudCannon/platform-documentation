...
* Added options for configuring the way CloudCannon reads and saves Markdown. Read more about these options [here](/documentation/articles/configure-your-markdown-engine).
* Added <a href="https://playwright.dev/" target="_blank" rel="noopener noreferrer">playwright</a> support to the build image.
