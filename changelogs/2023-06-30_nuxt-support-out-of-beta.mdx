...
type: minor
---
Support for static sites built with Nuxt is now out of beta. See our [starter guide for Nuxt](/documentation/guides/getting-started/), or click the button below to deploy our Sendit template to CloudCannon.
