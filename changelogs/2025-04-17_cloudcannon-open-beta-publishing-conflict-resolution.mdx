...
This release improved our file server performance and reliability, and added the *Use Relative URLs when redirecting* flag, comments for DNS records, and NS DNS records for subdomains.

It also addressed an issue affecting Snippets in Rich Text.
