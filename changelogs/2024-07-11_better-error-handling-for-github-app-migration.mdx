---
_schema: default
title: Better error handling for GitHub app migration
type: minor
---
This release added better error handling for GitHub app migration.
...
* Fixed an issue preventing you from setting input configuration for root-level arrays and objects in the global configuration file.
