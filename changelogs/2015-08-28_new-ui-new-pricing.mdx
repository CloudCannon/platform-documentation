...
type: major
---
Today we introduce a new pricing modal. This creates a better agency flow with less upgrade steps and white-labelling. You can read more about it in our [pricing change announcement](https://cloudcannon.com/blog/).
