...
type: minor
---
You can now add multiple new collection items within the same commit. This release also adds support for the default Docusaurus, and a number of other improvements.
...
* The site status icon is now bigger.
