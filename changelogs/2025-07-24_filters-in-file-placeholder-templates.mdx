...
* You can now use [filters](/documentation/articles/configure-your-template-strings/#filters) in file placeholder templates and reference data values.
...
collections_config:
  blog:
    url___1___: /[full_slug|uppercase]
  articles:
