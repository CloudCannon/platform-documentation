...
* The organization setup task list in the sidebar now links to an app demonstration video and the ability to book a meeting with the CloudCannon team.
* You can now dismiss tasks from the organization setup task list.
* Opening a file in the app now checks for any updates made to structure values since the last time you edited the file. New inputs will appear by default, and you can configure deleted inputs to remove content.
...
* Moved the description paragraphs for 'use an existing branch' and 'create a new branch' next to the associated radio buttons on the Create Site page for better clarity.

**Future Changes:**

In an upcoming release, we will update your Project page so you can create new branches off of existing branches as well as your main branch.