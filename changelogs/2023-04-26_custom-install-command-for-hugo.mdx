...
type: minor
---
This release adds the ability to configure a custom install command for Hugo sites – e.g. if you're use a package manager other than npm. This release also includes several other fixes and improvements.
