...
* Fixed an issue preventing users with Techincal Editor permissions from using the&nbsp;*Sync files*&nbsp;button.
...
* Fixed an issue where some input configuration would not apply to Jekyll drafts.
...
* The&nbsp;*Transfer Requests*&nbsp;list in&nbsp;*Organization Settings*&nbsp;now has pagination and is sorted by newest.
