...
* Streamlined the in-app *Getting Started with CloudCannon* guide after onboarding feedback, including reducing the number of steps, improving messaging, and updating the UI for better task clarity.
