...
It also addressed several issues, including those affecting alignment controls in *Rich Text Editors*, input validation, *Subscription* banners, asset filtering for Cloudinary and Bynder DAMs, SSO enforcement, and cache clearing for *Sites* on a subpath.
...
* Fixed an issue where filtering assets in a Cloudinary or Bynder DAM returned every asset, rather than only the assets matching your search term.
