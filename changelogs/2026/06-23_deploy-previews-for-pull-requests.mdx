...
* Added *Deploy Previews* to the *Project Settings* page, which run automations whenever a *Pull Request* is opened, updated, merged, or closed in your connected *Git Repository*. This feature is available on the <a href="https://cloudcannon.com/pricing/" rel="noreferrer">Team or Enterprise plans</a>. For more information, please read our documentation on [Deploy Previews](/documentation/developer-articles/what-are-deploy-previews/).
...
* Added two new optional *Project* tabs: *Pull Requests* and *Branches*. You can enable these tabs using the *Optional Project Tabs* switches on the *Project Settings Details* page. For more information, please read our documentation on [optional Project tabs](/documentation/user-articles/what-are-the-optional-project-tabs/).
