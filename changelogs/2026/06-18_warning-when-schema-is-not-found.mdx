...
* Added a warning when CloudCannon cannot find the *Schema* for a file. CloudCannon will no longer open files in an *Editing Interface* when the *Schema* is incorrectly defined.
