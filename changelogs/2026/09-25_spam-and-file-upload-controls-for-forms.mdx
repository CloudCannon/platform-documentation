...
* Fixed an issue where, when *Team Members* had already authenticated by another method, signing in with Microsoft Entra through *Single Sign-On* would fail. CloudCannon now accepts a stronger authentication method than the one named in your *AuthnContext* setting, instead of requiring an exact match.
