...
It also addressed several issues, including those affecting bold text in a hyperlink, *Pull Request* inputs on the *Publishing* page, and the *Connect a new GitHub account* flow.
