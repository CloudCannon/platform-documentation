...
---
This release addressed several issues, including those affecting the *Reset using Git repository* option, *Select* fields, the *Choose a collection* modal, and error handling.
