...
For more information about the features included in this Beta, please read our [blog post](https://cloudcannon.com/blog/open-beta-publishing-conflict-resolution/) or check out the [Beta Changelog](/documentation/articles/beta-changelog/).
...
4. Confirm by clicking the *Enter Beta* button on the *Try our new Beta* modal.
