...
* Depending on the input type, can now configure the following keys under `options`:
  ...
  * `pattern`: specify a <a href="https://re2js.leopard.in.ua/" rel="noopener noreferrer" target="_blank">regular expression</a> that the input value must match
...
For more information, please see our documentation on [inputs](/documentation/articles/what-are-inputs/) in general or [inputs reference](/documentation/developer-reference/configuration-file/types/_inputs/) documentation.
