...
* Added custom [Testing Domains](/documentation/articles/what-is-a-testing-domain/) for the [Team and Enterprise plans](https://cloudcannon.com/pricing/) and members of our [Partner Program](https://cloudcannon.com/partner-program/). Custom Testing Domain lets you choose the domain name for your `.cloudvent.net` URL by setting a unique Organization handle for all Testing Domains and entering a unique prefix whenever you create a new Site.
  * Please get in touch with our <a href="https://cloudcannon.com/support/" rel="noreferrer">support team</a> if you would like a custom Testing Domain.
