...
If required, you can return to the Legacy version of the app at any time using the *Enter CloudCannon Legacy* option in the *Account menu*. You can also enable CloudCannon Legacy per Site if you use Client Sharing. CloudCannon Legacy is available for a short time. CloudCannon will support the Legacy app until June 3rd, 2025. If you have any feedback, please get in touch with our <a href="https://cloudcannon.com/support/">support team</a>. or contact us through your dedicated Slack channel.
