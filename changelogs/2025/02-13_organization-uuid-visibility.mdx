...
* Added the Organization UUID and *Copy* button to the *API Keys* page under *Org Settings*.
  * The API feature is currently in private beta. For more information, please contact <a href="https://cloudcannon.com/support/" rel="noreferrer">our friendly support team</a>.
