...
For more information, please read our documentation on [File Inputs](/documentation/articles/what-is-a-file-input/) and [configuring File Inputs](/documentation/developer-articles/configure-a-file-input/).
...
For more information, please read our documentation on [URL Inputs](/documentation/articles/what-is-a-url-input/) and [configuring URL Inputs](/documentation/developer-articles/configure-a-url-input/).
