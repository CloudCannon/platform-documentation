...
type: minor
---
This release adds an option to set a DAM as the main asset source on a site. This means that non-fully qualified URLs will be loaded from the DAM for previews inside CloudCannon, and file paths from that DAM will be saved without the baseurl. [See the documentation](/documentation/articles/managing-your-main-asset-source/) for more details.
