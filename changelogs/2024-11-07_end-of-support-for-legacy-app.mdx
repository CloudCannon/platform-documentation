...
This release added ARIA attributes to the password strength label, new key descriptions for the *Collections* section in the CloudCannon configuration file, and removed the *Recent activity* section for users without permission to read it.
