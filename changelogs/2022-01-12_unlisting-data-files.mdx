...
* Fixed default value for [select type](/documentation/articles/configure-your-select-and-multiselect-inputs/#select) inputs when using allow\_empty
* Fixed issue uploading files on [image inputs](/documentation/articles/configure-your-file-inputs/#image) when using a custom upload directory
