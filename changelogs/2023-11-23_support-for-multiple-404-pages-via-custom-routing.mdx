...
* Fixed an issue preventing hugo\_markdown\_shortcode\_positional\_args from working.
* Fixed an issue where the merge pull request button was briefly available on sites that use the merge immediately publishing mode.
