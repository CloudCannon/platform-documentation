...
It also addressed several issues, including those affecting MFA and Organization-level Flag permissions and form reCAPTCHA.

## Features & Improvements

* Added the *Use Client Sharing to view attached files* option for existing Inboxes and the
