...
* Removed the *Status* page to reduce information redundancy with the *Site Dashboard* and address user confusion about where to find information. Information displayed on the old *Status* page is now available on your *Site Dashboard*.
...
* Added the *Syncs*, *Builds*, *Build Deploys*, and *Usage* tabs to your *Site Dashboard*.
  * x
  * &nbsp;
