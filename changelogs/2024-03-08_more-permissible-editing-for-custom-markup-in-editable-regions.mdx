...
type: minor
---
This release addresses an issue impacting sites that use "custom markup" in editable regions. Custom markup is any HTML or Markdown content you might want to edit in the Content Editor or a rich text input.
...
The rationale for this update was to protect your content from someone unintentionally deleting custom markup. As CloudCannon cannot render custom markup in the rich text editor, there is a risk that someone could accidentally backspace or delete your HTML structures. This risk was present in previous versions of the editing interface, and yesterday's release intended to address this.

We understand that this change caused several concerns for our long-standing customers. We apologize for any interruptions to your work caused by this change and are committed to creating a better experience for customers who rely on custom markup.
...
We are also creating a fix for HTML inputs in the sidebar of the Visual and Content Editor and the Data Editor. Sites that rely on custom markup in these places will have access to an "unsafe editing mode", allowing you to edit at the risk of unintentionally deleting elements that cannot be recreated.

At CloudCannon, we are committed to providing the best support experience possible. If you have any questions or concerns about this issue, [please contact our support team](https://cloudcannon.com/support/). We are happy to assist in any way we can.
