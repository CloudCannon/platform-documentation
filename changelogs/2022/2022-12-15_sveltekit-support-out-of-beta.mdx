...
* New [Create Path](/documentation/developer-articles/set-the-path-for-new-files/) configuration for collections and schemas to control where new collection files are created and named.
