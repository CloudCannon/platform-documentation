...
type: minor
date: 2022-04-26T05:00:00+00:00
---
...
* Collection-level option called [schemas](/documentation/developer-articles/create-a-schema/) to define one or more types in a collection. Used for the initial contents of new files, and keeping existing files up to date.
