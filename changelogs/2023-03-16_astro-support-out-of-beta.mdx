...
Try our [Sendit template](https://app.cloudcannon.com/editor#sites/connect/github/CloudCannon/sendit-astro-template/main), a fully featured Astro template optimized for visual editing in CloudCannon. Check out [our starter guide for Astro](/documentation/guides/getting-started-with-editing/) here.
