...
* Added the `strip_leading_date` and `substring` filters for template strings.
  * The `strip_leading_date` filter removes three numbers up to four characters long and separated by hyphens, underscores, or commas from the front of a string (e.g., `03-07-99`, `2022_31_12`, `18,04,1700`, etc.).
