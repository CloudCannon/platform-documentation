...
* Updated the way CloudCannon generates SSL certificates. Rather than checking the certificate every 20 minutes, CloudCannon will now use an exponential back-off model.
