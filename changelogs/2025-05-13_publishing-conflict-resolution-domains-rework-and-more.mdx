...
<comp.DocsImage path="" alt="summary tab" title="" type="screenshot"/>

* The *Changes* tab lists all the files with saved changes on your Site.

<comp.DocsImage path="" alt="changes tab" title="" type="screenshot"/>
...
<comp.DocsImage path="" alt="commits tab" title="" type="screenshot"/>
