...
<comp.DocsImage path="https://cc-dam.imgix.net/documentation/images/change-log/2025-05/CloudCannon-Changelog-May2025-Publish-Button-Publishing-Conflict-Notification.png" alt="A screenshot of the Publish Button shows a red Publishing Conflict warning notification." title="The Publish Button" type="ui-snippet"/>
