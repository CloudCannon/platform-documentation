...
If required, you can return to the Legacy version of the app at any time using the *Enter Legacy* button in the *App sidebar*. CloudCannon Legacy is available for a short time. CloudCannon will support the Legacy app until June 3rd, 2025. If you have any feedback, please get in touch with our [support team](/support/) or contact us through your dedicated Slack channel.
