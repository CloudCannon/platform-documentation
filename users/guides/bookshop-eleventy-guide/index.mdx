...
[CloudCannon Structures](/documentation/articles/create-a-structure/) for each of your components,
...
Using this, Bookshop can subscribe to data in the CMS using the [CloudCannon Visual Data Preview API](/documentation/articles/what-are-visual-data-previews/)
