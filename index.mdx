...
content_blocks:
  ...
  - _component_type: leftrightblock
    left:
      ...
      description: Our Publishing Conflict Resolution Beta is now open to everyone! Read our Changelog and supporting documentation to find out more about our upcoming features.
      buttons:
        - button_text: Read more
          button_link: https://community.cloudcannon.com/
    right:
      block_type: image
      image: /uploads/banner-with-faces-no-grid.png
---
