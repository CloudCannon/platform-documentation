...
import type { Helpers, Details, Page } from '../../_types.d.ts';
                            ...
                            <li className="t-docs-nav__main-list__item guide">
                                <ol className="t-docs-nav__sub-list">
                                    {guideArticles.map((data, i) => {
                                        ...
                                        const isCompleted = !isCurrent && (data.details?.order || 0) < (page?.data?.details?.order || 0);
                                        let completeClass = '';
                                        if (isCurrent) {
                                            ...
                                            <li key={i}>
                                                ...
                                                >
                                                    <div className="t-docs-nav__sub-list__connector-group">
                                                        ...
                                                        {(data.details?.order || 0) < guideArticles.length && (
