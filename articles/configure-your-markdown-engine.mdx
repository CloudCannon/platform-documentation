...
These options are used for [visual data previews](/documentation/articles/what-are-visual-data-previews/) in the [Visual Editor](/documentation/articles/the-visual-editor/), [comments on inputs](/documentation/articles/configure-your-inputs/#comment), and [descriptions on collections](/documentation/articles/define-your-collections/#description).
