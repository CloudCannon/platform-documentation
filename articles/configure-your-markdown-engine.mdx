...
Some Markdown options transform your content to render displays but should not affect the saved content in your files. For this reason, CloudCannon will use some options in `markdown.options` for display only.
