...
Display-only options facilitate [visual data previews](/documentation/articles/what-are-visual-data-previews/) in the [Visual Editor](/documentation/articles/what-is-the-visual-editor/), [comments on inputs](/documentation/articles/configure-your-inputs/#comment), and [descriptions for collections](/documentation/articles/configure-your-collections/#description).
