...
Editor Links allow you to link to other sections of the CloudCannon interface from within the [Visual Editor](/documentation/articles/what-is-the-visual-editor/). Use them to create edit buttons for your collection items and blog posts to quickly navigate the app. You can also add front matter Editor Links to open the front matter Editor at specified fields.
