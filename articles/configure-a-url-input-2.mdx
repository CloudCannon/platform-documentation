...
<comp.DataReference>
  ...
  <comp.DataReferenceRow label="required" type_markdown="Boolean">
    This key toggles whether CloudCannon requires this input to have a value. Defaults to `false`.
  </comp.DataReferenceRow>
  <comp.DataReferenceRow label="max_length" type_markdown="Number">
    This key defines the maximum string length allowed. Has no default.
  </comp.DataReferenceRow>
  <comp.DataReferenceRow label="min_length" type_markdown="Number">
    This key defines the minimum string length required. Has no default.
  </comp.DataReferenceRow>
  <comp.DataReferenceRow label="pattern" type_markdown="String">
    This key defines a regular expression that the input value must match. Has no default.
  </comp.DataReferenceRow>
  <comp.DataReferenceRow label="pattern_message" type_markdown="String">
    This key defines the message shown when the input value doesn't match the pattern. Has no default.
  </comp.DataReferenceRow>
</comp.DataReference>
