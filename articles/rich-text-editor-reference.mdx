...
<comp.DataReference>
  <comp.DataReferenceRow label="image_size_attributes" type_markdown="Boolean">
    ...
    <comp.Notice info_type="important">
          This defaults to `true` for sites created before June 23 2023, in order to keep those sites working. Use the [Image Size Attributes Default](/documentation/articles/legacy-option-flags/#image-size-attributes-default-behaviour) flag to update this for your site, if needed.
        </comp.Notice>
