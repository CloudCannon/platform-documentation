...
<comp.DocsImage path="ye_olde_images/tint-component.png" alt={"A screenshot of the \"tint\" component in the Content Editor, with the editing panel open showing the snippet data"} title="" type="regular"/>
...
<comp.DocsImage path="ye_olde_images/callout-component.png" alt={"A screenshot of the \"callout\" component in the Content Editor, with the editing panel open showing the snippet data"} title="" type="regular"/>
