...
title: Best practice for splitting your Configuration Files
nav_title: Best practice for splitting your Configuration Files
published: true
image: >-
...
author_notes:
 docshots_status:
---
On CloudCannon, you can [split your *Site* configuration](/documentation/articles/split-your-configuration-file/) across multiple *Configuration Files*.
...
1. Make sure the
2. &nbsp;
3. **Use consistent naming**: Follow the recommended naming convention (`.cloudcannon.{section}.yml`) for better tooling support
4. **Keep it readable**: Don't split too granularly - find a balance between organization and maintainability
