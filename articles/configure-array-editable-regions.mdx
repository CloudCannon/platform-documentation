...
These instructions assume you know if you have a simple or complex array, have configured your [build settings](/documentation/articles/configure-your-first-build/), and are comfortable editing HTML layouts, either in CloudCannon's [Source Editor](/documentation/articles/what-is-the-source-editor/) or your local development environment.
...
2. If you have a complex array, you must register each type of array item as a component. For more information, please read our documentation on [configuring Component Editable Regions](/documentation/articles/configure-component-editable-regions/).
...
11. Optional. If you also want to edit the contents of each array item in the Visual Editor, add [Text Editable Regions](/documentation/articles/configure-text-editable-regions/) or [Image Editable Regions](/documentation/articles/configure-image-editable-regions/) to the content inside each array item.
