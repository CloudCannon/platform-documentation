...
<comp.DocsImage path="/uploads/inputs/text/text.png" alt="Screenshot of text input field" type="screenshot-snippet"/>
...
<comp.DocsImage path="/uploads/inputs/text/textarea.png" alt="Screenshot of large text input field" type="screenshot-snippet"/>
...
<comp.DocsImage path="/uploads/inputs/text/email.png" alt="Screenshot of two email input fields using the email and email_address keys" type="screenshot-snippet"/>
