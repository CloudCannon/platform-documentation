...
<comp.KeyReferenceTable>
  <comp.KeyReferenceTableRow key="_keys/collection-groups.yml" />
  <comp.KeyReferenceTableRow key="_keys/collections-config-add-options-collection.yml" />
  <comp.KeyReferenceTableRow key="_keys/base-url.yml" />
</comp.KeyReferenceTable>
