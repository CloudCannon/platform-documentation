...
Commit templates are configured with template strings. See [this article](/documentation/articles/configure-your-template-strings/) for more information about this.
