...
An output URL is the URL your SSG outputs your files to during a [Site build](/documentation/articles/what-is-a-site-build/). CloudCannon automatically determines the likely output URL to match [output files](/documentation/articles/what-is-a-output-file/) to source files and enable the [Visual Editor](/documentation/articles/what-is-the-visual-editor/) and screenshots in the *Collection Browser*.
