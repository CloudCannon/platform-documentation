  ...
  * `source` from the `--input` CLI option or `dir.input` in `.eleventy.js` options
  ...
  <comp.Tabs label="Configuration">
   <comp.Tab name="Automatic install">
      ...
      Automatically installed is the recommended default with **Manage eleventy-plugin-cloudcannon manually** disabled in your [build configuration](/documentation/articles/ssg-plugins-and-cloudcannon-reader/).
    ...
    <comp.Tab name="Manual install">
      ...
      Applicable if you have **Manage eleventy-plugin-cloudcannon manually** enabled in your [build configuration](/documentation/articles/ssg-plugins-and-cloudcannon-reader/).
