...
For sites that have not yet migrated to Unified Configuration, [view this page on our legacy documentation site](https://legacy.cloudcannon.com/documentation/articles/create-a-global-configuration-file/).
</comp.Notice>
