...
By default, CloudCannon's authentication methods affect every page on your Site. However, you can require authentication for a specific subset of pages using [authenticated routes](/documentation/articles/configure-authenticated-routes/) or by hosting your Site on a [subpath](/documentation/articles/add-a-custom-domain-to-your-site/).
