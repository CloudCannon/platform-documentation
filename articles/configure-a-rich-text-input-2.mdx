...
<comp.DataReference>
  <comp.DataReferenceRow label="allow_resize" type_markdown="Boolean">
    This key determines whether users can resize the text area. Defaults to `true`.
  </comp.DataReferenceRow>
  <comp.DataReferenceRow label="initial_height" type_markdown="Number">
    This key determines the initial height of the text area in pixels. Defaults to `100`.
  </comp.DataReferenceRow>
  <comp.DataReferenceRow label="paths" type_markdown="Object">
    This key defines paths for uploading assets through this input. The following nested keys are available:
    * `dam_uploads` - path for uploading new DAM files
    * `dam_uploads_filename` - filename template for uploaded DAM files
    * `uploads` - path for uploading new files
    * `uploads_filename` - filename template for uploaded files
  </comp.DataReferenceRow>
