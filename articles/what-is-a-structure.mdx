...
related_links: []
---
A structure is a predefined, custom template that determines what should populate an [Array](/documentation/articles/configure-your-array-inputs/) or [object input](/documentation/articles/object-inputs/). With the click of a button, you can easily add fields to an array or object from your list of predefined structures.
