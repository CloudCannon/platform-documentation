...
<comp.Notice info_type="info">
  Alternatively, [configure inline Array inputs](/documentation/articles/what-is-an-array-input/#inline-values) to set which input is used for array items. Inline array inputs also allow an array to be empty.
</comp.Notice>
