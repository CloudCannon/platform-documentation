...
<comp.DocsImage path="" alt="A close up of an email input in the Data Editor shows a label, comment, text field, and context dropdown." title="An email input" type="ui-snippet"/>
...
Add a comment to your input if you need a subtitle. You can use a limited selection of Markdown formatting to create your comment: links, bold, italic, subscript, superscript, and inline code.

You can provide context for each input, such as instructions for your team members on how to use an input. The context of an input appears as a gray dropdown underneath the input field.
...
* [Code](/documentation/articles/code-inputs/) —
...
* [Object](/documentation/articles/object-inputs/) —
* [Array](/documentation/articles/array-inputs/) —
