...
* Per input with inputs configuration:
  * [File input options](/documentation/articles/file-inputs/#options).
  * [URL input options](/documentation/articles/url-inputs/#options).
  * [Rich Text input options](/documentation/articles/rich-text-inputs/#options).
