...
* Per input with inputs configuration:
  * [File input options](/documentation/articles/configure-your-file-inputs/#options).
  * [URL input options](/documentation/articles/configure-your-url-inputs/#options).
  * [Rich Text input options](/documentation/articles/configure-your-rich-text-inputs/#options).
