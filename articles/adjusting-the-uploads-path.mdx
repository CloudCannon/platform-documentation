...
You can use filters to transform these placeholders. For example `[asset_filename|slugify].[asset_ext]` with turn "My Document.pdf" into "my-document.pdf". You can read more about using placeholders, and see a list of all available filters, [in this article](/documentation/articles/configuring-with-placeholders/).
