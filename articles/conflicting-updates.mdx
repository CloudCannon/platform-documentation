...
To address conflicting updates, click the *Resolve conflicts* button in the *Site navigation* or open the *Review changes* modal using the *Save* button.

Select how to resolve your conflicting updates. You can either:

* Attempt to merge your unsaved changes with the incoming changes by saving the affected files OR
* Remove the conflict by discarding any unsaved changes in the affected files.

If your merge attempt fails, you will need to speak with a developer on your team to merge these files manually.