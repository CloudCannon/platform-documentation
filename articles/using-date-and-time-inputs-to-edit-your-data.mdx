...
title: Using Date and Time Inputs to edit your data
nav_title: Date and Time
published: true
image: >-
...
<comp.DocsImage path="/documentation/static/inputs/date-and-time/datetime.png" alt="Screenshot of datetime input field unfocused" type="screenshot-snippet"/>

<comp.DocsImage path="/documentation/static/inputs/date-and-time/date-picker.png" alt="Screenshot of datetime input field with date picker open"/>
...
<comp.DocsImage path="/documentation/static/inputs/date-and-time/date.png" alt="Screenshot of date input field unfocused" type="screenshot-snippet"/>

<comp.DocsImage path="ye_olde_images/date-open.png" alt="Screenshot of date input field focused" type="screenshot-snippet"/>
...
<comp.DocsImage path="/documentation/static/inputs/date-and-time/time.png" alt="Screenshot of time input field" type="screenshot-snippet"/>
