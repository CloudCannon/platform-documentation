...
<comp.DocsImage path="/uploads/inputs/code/code-block.png" alt="Screenshot of a code block" type="screenshot-snippet"/>

<comp.DocsImage path="/uploads/inputs/code/example-ruby-code-block.png" alt="Screenshot of a code block with Ruby syntax highlighting" type="screenshot-snippet"/>
