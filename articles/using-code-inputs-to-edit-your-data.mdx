...
title: Using Code Inputs to edit your data
nav_title: Code
published: true
...
<comp.DocsImage path="/documentation/static/inputs/code/code-block.png" alt="Screenshot of a code block" type="screenshot-snippet"/>

<comp.DocsImage path="/documentation/static/inputs/code/example-ruby-code-block.png" alt="Screenshot of a code block with Ruby syntax highlighting" type="screenshot-snippet"/>
