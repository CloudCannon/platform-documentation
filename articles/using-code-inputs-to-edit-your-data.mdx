...
<comp.DocsImage path="ye_olde_images/code.png" alt="Screenshot of a code block" type="screenshot-snippet" />

<comp.DocsImage path="ye_olde_images/code-ruby.png" alt="Screenshot of a code block with Ruby syntax highlighting" type="screenshot-snippet" />
