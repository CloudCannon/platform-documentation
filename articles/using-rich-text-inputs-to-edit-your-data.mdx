...
<comp.DocsImage path="https://dam-cdn.cloudcannon.com/documentation/images/editing/inputs/rich-text/html.png" alt="Screenshot of HTML Rich text input field" type="screenshot-snippet"/>
...
<comp.DocsImage path="https://dam-cdn.cloudcannon.com/documentation/images/editing/inputs/rich-text/markdown.png" alt="Screenshot of Markdown Rich text input field" type="screenshot-snippet"/>
...
<comp.DataReference>
 <comp.DataReferenceRow label="image_size_attributes" type_markdown="Boolean">
    Instructs the editor to save `width` and `height` on the image elements added to this input. This can [prevent pop-in](/documentation/articles/why-cloudcannon-injects-width-and-height-onto-images/) as a page loads. Defaults to `true`.
 </comp.DataReferenceRow>
