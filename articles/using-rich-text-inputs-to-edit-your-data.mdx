...
* `html`
* `*_html`
<comp.DocsImage path="ye_olde_images/html.png" alt="Screenshot of HTML Rich text input field" type="screenshot-snippet"/>
...
* `markdown`
* `*_markdown`
<comp.DocsImage path="ye_olde_images/markdown.png" alt="Screenshot of Markdown Rich text input field" type="screenshot-snippet"/>
<comp.MultiCodeBlock language="yaml" translate_into={["json", "toml"]} source="Naming convention">
```
markdown: |
  # Animals
