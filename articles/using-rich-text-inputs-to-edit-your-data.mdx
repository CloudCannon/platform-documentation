...
<comp.DocsImage path="/uploads/inputs/rich-text/html.png" alt="Screenshot of HTML Rich text input field" type="screenshot-snippet"/>
...
<comp.DocsImage path="/uploads/inputs/rich-text/markdown.png" alt="Screenshot of Markdown Rich text input field" type="screenshot-snippet"/>
