...
In CloudCannon, you can use the [Visual Editor](/documentation/articles/what-is-the-visual-editor/) to visually edit any file that outputs to an HTML webpage at [build time](/documentation/articles/what-is-a-site-build/).
...
For more information about Site builds, please read our documentation on [builds](/documentation/articles/what-is-a-site-build/) in general, [configuring your first site build](/documentation/articles/configure-your-first-build/), or consider following our [Set up Visual Editing](/documentation/guides/set-up-visual-editing/) guide.
