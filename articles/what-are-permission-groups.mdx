...
* **Scope** — Define how broadly a permission is applied. There are five levels of scope (Global, Project, Site, Group, and Base Domain). How many levels of scope are available will depend on whether you are using [Default](/documentation/articles/what-are-default-permission-groups/) or [Custom Permission Groups](/documentation/articles/what-are-custom-permission-groups/).
...
Using Custom Groups, you can add multiple permissions to a Group and alter the scope of each permission from Global to Project, Site, Group, or Base Domain. You can also define exceptions for each Group for more precise permissions.
