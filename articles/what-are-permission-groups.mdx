...
The Editors Group does not contain the permission `site:source-editor:read`, which means members of this Group cannot open any files in [the Source Editor](/documentation/articles/what-is-the-source-editor/). The option to open a file in the Source Editor will not appear in the CloudCannon interface, including in:
