...
<comp.DataReference>
  ...
  <comp.DataReferenceRow label="_inputs.*.options.hide_link_to_telephone" type_markdown="boolean">
    ...
    By default, this key is false (i.e., the option is visible), except for Sites created before 20 August 2025. See our [documentation on legacy flags](/articles/legacy-option-flags) for more information about the default behavior.
  </comp.DataReferenceRow>
</comp.DataReference>
