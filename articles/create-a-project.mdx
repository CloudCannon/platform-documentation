...
### Branching from other sites

There is also an option in your *Project Settings* to allow all branching. This means any site in the Project can be branched by any team member. When the branch site is published, the changes will be saved back into the site they branched from.
...
4. Now in the Projects site list, you can click the context menu on each site and see an option to create a branch from that site.