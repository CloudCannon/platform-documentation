...
<comp.DocsImage path="https://cc-dam.imgix.net/documentation/images/editing/delete-files/2023-Q4/CloudCannon-Documentation-Deleted-File-Banner.png" alt="The Content Editor in the CloudCannon app shows a 'This file has been deleted' banner with the option to 'Restore file'." title="Deleted file banner in the editing interface" type="screenshot"/>
