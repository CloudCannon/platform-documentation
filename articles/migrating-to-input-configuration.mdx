...
You can now choose the structures (separately from the naming convention) for an [array input](/documentation/articles/array-inputs/) with structures. Either define the values directly:
