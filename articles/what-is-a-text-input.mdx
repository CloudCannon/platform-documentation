...
Depending on how your developer configured the input, your Text input may have different...
...
For more information, please read our developer documentation on [configuring a Text input](/documentation/articles/configure-a-text-input/) for configuration options, valid input values, and unconfigured input behavior.
