...
6. If you are adding captcha to your form to prevent spam, follow the documentation to add the required code to your form.&nbsp;<br>\- <a target="_blank" rel="noopener" href="https://developers.google.com/recaptcha/docs/display">Google reCAPTCHA</a>&nbsp;<br>\- <a target="_blank" rel="noopener" href="https://docs.hcaptcha.com/#add-the-hcaptcha-widget-to-your-webpage">hCaptcha</a>&nbsp;
