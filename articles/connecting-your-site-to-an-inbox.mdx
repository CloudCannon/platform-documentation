...
6. If you are using hCaptcha, follow the <a target="_blank" rel="noopener" href="https://docs.hcaptcha.com/#add-the-hcaptcha-widget-to-your-webpage">documentation</a> to add the required code to your form.&nbsp;
7. If you are using Google reCAPTCHA, follow the <a target="_blank" rel="noopener" href="https://developers.google.com/recaptcha/docs/display">documentation</a> to add the required code to your form.&nbsp;
