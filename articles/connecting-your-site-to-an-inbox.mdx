...
If your form submissions are intended for anyone who uses Client Sharing, they will need to log in via the Client Sharing interface. When creating a new Inbox target, you can set the *Use Client Sharing to view attached files* option. If enabled, this option will ensure that all links to form submission files will use the Client Sharing interface. You can also toggle this option by clicking *File attachment settings* in the context menu for an existing Inbox target.
