...
6. If you are adding captcha to prevent spam, follow the documentation ([Google reCAPTCHA](https://developers.google.com/recaptcha/docs/display), [hCaptcha](https://docs.hcaptcha.com/#add-the-hcaptcha-widget-to-your-webpage)) to add the required code to your form.&nbsp;
