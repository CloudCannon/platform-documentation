...
* [Using rich text inputs](/documentation/articles/configure-your-rich-text-inputs/#image-options)
* [Using upload inputs](/documentation/articles/configure-your-file-inputs/)