...
When you create a file using a schema, a hidden `_schema` input is added to the front matter of that file. This input is visible in the [Source Editor](/documentation/articles/what-is-the-source-editor/) but hidden in the sidebar of the Visual or Content Editor, and contains the name of the schema a file uses.
