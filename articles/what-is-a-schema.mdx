...
<comp.Notice info_type="info">
  Schemas are a good place to configure your [inputs](/documentation/articles/what-are-inputs/). Inputs configured in your schema will only affect files created with that schema.
</comp.Notice>
