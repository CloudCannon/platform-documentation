...
title: "Editing with Hugo Shortcodes"
...
<comp.DocsImage path="ye_olde_images/unknown-shortcode.png" alt="A screenshot of an unknown shortcode displayed as a block in the CloudCannon Content Editor" type="regular" />
...
<comp.DocsImage path="ye_olde_images/tint-shortcode.png" alt={"A screenshot of the \"tint\" shortcode in the Content Editor, with the editing panel open showing the snippet data"} type="regular" />
...
<comp.DocsImage path="ye_olde_images/callout-shortcode.png" alt={"A screenshot of the \"callout\" shortcode in the Content Editor, with the editing panel open showing the snippet data"} type="regular" />
...
<comp.DataReference>
  ...
  <comp.DataReferenceRow label="preview" type_markdown="Object">
    A preview definition for displaying this shortcode in the CloudCannon editor. See the [preview options documentation](/documentation/articles/changing-how-cards-preview-your-data/).
  </comp.DataReferenceRow>
  <comp.DataReferenceRow label="_inputs" type_markdown="Object">
    Input configurations for the keys contained in this shortcode. See the [input configuration documentation](/documentation/articles/how-to-choose-what-input-is-used-in-the-data-editor/).
  </comp.DataReferenceRow>
</comp.DataReference>
