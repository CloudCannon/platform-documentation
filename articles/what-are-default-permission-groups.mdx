...
* Trigger builds, syncs, build deploys for each Site, and view logs associated with these functions.
...
* Manage Permission Groups, including adding and removing team members and editing the Permission Group of team members. If you have <a href="/documentation/articles/what-are-custom-permission-groups/" target="_blank" rel="noopener">Custom Permission Groups</a>, Developers can also create new Groups.
