...
* Datetime - Choose both a date and time
* Date - Choose a date only
* Time - Choose a time only
...
Specific configuration options for Date and Time inputs include defining the timezone, date range restrictions, and how CloudCannon handles empty values. You can also add input validation to require a value or match a regular expression.
