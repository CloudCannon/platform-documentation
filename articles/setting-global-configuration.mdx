...
Global configuration files contain your global CloudCannon configuration, and top-level values for the [configuration cascade](/documentation/articles/using-the-configuration-cascade/).
