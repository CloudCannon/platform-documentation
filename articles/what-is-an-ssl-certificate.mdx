...
* If you are using an [external DNS provider](/documentation/articles/configure-external-dns/), some additional configuration is required. For more information, please read our documentation on [adding TXT DNS records](https://daring-train.cloudvent.net/documentation/articles/add-an-auto-generated-ssl-certificate/#add-txt-dns-records).
