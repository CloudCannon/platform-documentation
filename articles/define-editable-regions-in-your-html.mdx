...
One way to fix this would be to add the `styles` configuration to include these class names. [Read more about this option here](https://cloudcannon.com/documentation/articles/rich-text-inputs/#styles-and-alignment).
