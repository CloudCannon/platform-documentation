...
Once your SSG has built your *Site*, CloudCannon automatically output files with their corresponding source files by determining the likely output URL for each file.
