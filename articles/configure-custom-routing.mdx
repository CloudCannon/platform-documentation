...
You can create a build process generate your routing file with the correct content, depending on the environment. In this case, the build process should generate the file in  `_cloudcannon/routing.json` . CloudCannon will use this file instead of  `.cloudcannon/routing.json` from your source.
