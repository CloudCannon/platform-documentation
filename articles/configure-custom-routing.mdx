...
<comp.Notice info_type="info">
  You can use routing to load a single HTML file on multiple URL routes and use JavaScript to load different content.
</comp.Notice>
