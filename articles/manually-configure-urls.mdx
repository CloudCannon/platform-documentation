...
<comp.Notice info_type="important">
  Before disabling CloudCannon's automatic URL detection, you must configure the [collections\_config.\[\*\].url](t/documentation/articles/collections-reference/#url) key for all output [Collections](/documentation/articles/what-is-a-collection/).
</comp.Notice>
