...
<comp.DataReference>
  <comp.DataReferenceRow label="step" type_markdown="Number">
    This key determines the increment between valid values. Defaults to `1` for integers and `0.1` for decimals.
  </comp.DataReferenceRow>
  <comp.DataReferenceRow label="min" type_markdown="Number">
    This key determines the minimum value that can be entered. Has no default.
  </comp.DataReferenceRow>
  <comp.DataReferenceRow label="max" type_markdown="Number">
    This key determines the maximum value that can be entered. Has no default.
  </comp.DataReferenceRow>
...
Here are some examples of valid values for Number inputs.
