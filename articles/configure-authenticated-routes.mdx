...
description: >-
  Auth routes allow you to specify the routes you want to be authenticated and
  keep the rest public.
tags:
  - authentication
  - security
related_articles:
...
For example, you may want to hide a 'staff-only' section of your site behind [password authentication](/documentation/articles/enable-password-authentication/).
