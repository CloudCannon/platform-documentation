...
There are three types of File input you can configure:

* File — For uploading any type of file
* Document — For uploading document files (e.g., PDFs, DOCs)
* Image — For uploading image files
