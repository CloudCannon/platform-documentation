...
related_links: []
---
A file input lets your team members upload a file to your repository or [DAM](/documentation/articles/integrating-your-dam-with-cloudcannon/), and reference the filepath for existing assets. File inputs have a file preview in the Data Editor and sidebar of the Visual and Content Editors, as well as a repository or DAM browser for searching assets.
