...
For each input, you can configure the default path for uploading assets, which MIME types an input will accept, which DAMs you can upload to and browse, and determine how to handle null values. For inputs that accept images, you can configure how CloudCannon resizes images, MIME type, and whether CloudCannon creates additional images of different sizes when you upload a new asset.
