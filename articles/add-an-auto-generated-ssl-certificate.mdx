...
By default, CloudCannon will automatically generate an SSL certificate for all Sites hosted on CloudCannon through ZeroSSL and Cloudflare. This can be a wildcard SSL certificate or a single-domain SSL certificate. These certificates renew each year automatically, so your Site is never unsecure.
...
Once your wildcard SSL certificate is enabled, user can visit your Site on the more secure [HTTPS](/documentation/articles/what-is-an-ssl-certificate/#http-vs-https) URL. Any users who have copied or bookmarked the previous HTTP URL should be redirected.
...
<comp.DocsImage path="https://cc-dam.imgix.net/documentation/images/hosting/add-an-ssl-certificate/2024-12/CloudCannon-Documentation-Routing-Page.png" alt="A screenshot of the Routing page shows the Redirect all HTTP traffic to HTTPS checkbox is ticked" title="The Routing page" type="screenshot"/>