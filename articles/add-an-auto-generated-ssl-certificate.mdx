...
<comp.Notice info_type="info">
  Wildcard SSL certificates are not available for [Sites hosted on a subdomain](/documentation/articles/add-a-custom-domain-to-your-site/). If you have a CloudCannon Site hosted on your base domain, add a wildcard SSL certificate to that Site.
</comp.Notice>
