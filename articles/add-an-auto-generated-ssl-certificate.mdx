...
Once your wildcard SSL certificate is enabled, users can visit your Site on the more secure [HTTPS](/documentation/articles/what-is-an-ssl-certificate/#http-vs-https) URL. Any users who have copied or bookmarked the previous HTTP URL should be redirected.
