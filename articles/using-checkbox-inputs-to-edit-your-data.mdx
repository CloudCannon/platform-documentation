...
title: Using Boolean Inputs to edit your data
nav_title: Boolean
published: true
image: >-
...
<comp.DocsImage path="/documentation/static/inputs/boolean/checkbox.png" alt="Screenshot of checkbox input field" type="screenshot-snippet"/>
...
<comp.DocsImage path="/documentation/static/inputs/boolean/switch.png" alt="Screenshot of switch input field" type="screenshot-snippet"/>
