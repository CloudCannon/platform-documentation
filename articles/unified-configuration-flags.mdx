...
<comp.Notice info_type="important">
  <p>As of October 2024, CloudCannon uses the Unified Configuration format for your CloudCannon configuration file by default for all new Sites. Site created before this data can also upgrade to the Unified Configuration format.</p><p>For more information, please read our guide on <a href="/documentation/guides/unified-configuration-migration-guide/">migrating to Unified Configuration</a> or contact our friendly <a href="/support/">support team</a>.</p>
</comp.Notice>
