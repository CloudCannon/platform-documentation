...
Array inputs can contain a mixture of inline and nested values simultaneously. By default, text, number, and boolean values are inline.
...
staff:
  - name: Karen Kay
    ...
    image: /images/team/karen_kay.jpg
    quote:
  - name: Holly James
