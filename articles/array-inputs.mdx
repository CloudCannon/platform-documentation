...
You can populate an Array input by defining an entry input type or by using predefined templates called structures. For more information on structures, please read our [structures](/documentation/articles/create-a-structure/) documentation.
