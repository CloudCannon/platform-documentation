...
DNS records are instructions for a Domain Name, managed by an authoritative nameserver. These instructions contain important information including a domain's IP address, email routing, owner validation, and more.
