...
On CloudCannon, any Site with a [Custom Domain](/documentation/articles/what-is-a-custom-domain/) can use [CloudCannon DNS](/documentation/articles/using-cloudcannon-dns-to-configure-your-custom-domain/) or an [external DNS](/documentation/articles/using-external-dns-to-configure-your-custom-domain/).

* **CloudCannon DNS** —
* **External DNS** —

CloudCannon offers free DNS services by default through Cloudflare. For more information, please read our documentation on [configuring CloudCannon DNS](/documentation/articles/using-cloudcannon-dns-to-configure-your-custom-domain/).

You can also use an external DNS provider for your Sites on CloudCannon. For more information, please read our documentation on [configuring external DNS](/documentation/articles/using-external-dns-to-configure-your-custom-domain/).
