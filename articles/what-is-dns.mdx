...
* **CloudCannon DNS** — Manage your DNS records through CloudCannon (recommended). Using CloudCannon DNS enables you to use an [auto-generated SSL certificate](/documentation/articles/add-an-auto-generated-ssl-certificate/).
