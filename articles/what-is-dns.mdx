...
* **CloudCannon DNS** — Manage your DNS records through CloudCannon (recommended). Using CloudCannon DNS enables you to use a [wildcard SSL certificate](/documentation/articles/add-an-auto-generated-ssl-certificate/).
