...
* **CloudCannon DNS** — Manage your DNS records through CloudCannon (recommended). Using CloudCannon DNS enables you to use a [wildcard SSL certificate](/documentation/articles/add-a-wildcard-ssl-certificate/).
