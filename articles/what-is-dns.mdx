...
<comp.DocsImage path="https://cc-dam.imgix.net/documentation/images/hosting/what-is-dns/2024-12/CloudCannon-Documentation-DNS-Lookup-Diagram.png" alt="A diagram of the DNS lookup process, where the DNS Resolver contacts various servers for the matching IP address for a given domain name." title="DNS Lookup Diagram" type="ui-snippet"/>
...
* **Sender Policy Framework (SPF) Record** — Specifies which servers are authorized to send emails from a given Domain Name. "SPF" stands for "sender policy framework".
