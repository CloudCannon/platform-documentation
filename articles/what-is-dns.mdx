...
You can also use an external DNS provider for your Sites on CloudCannon. An external DNS provider may be right for you if you have an existing DNS provider.
