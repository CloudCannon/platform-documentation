...
<comp.DocsImage path="https://cc-dam.imgix.net/documentation/images/editing/snippets/2024-06/CloudCannon-Documentation-Snippet-Modal.png" alt="A closeup of the Snippets pop-up modal in the Content Editor shows a selection of Snippets available to insert into rich text." title="The Snippets pop-up modal" type="screenshot"/>
