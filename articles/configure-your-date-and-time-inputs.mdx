...
title: Configure your Date and Time inputs
nav_title: Configure your Date and Time inputs
published: true
image: >-
...
For each input, you can configure the timezone and how CloudCannon handles empty values. You can also use the [general configuration options](/documentation/articles/configure-your-inputs/#general-configuration-options) available for all inputs.
