...
* **Inbox** — If your Site has a [form](/documentation/articles/what-is-a-form/), this button opens the *Inbox* page for your form. If you have multiple forms, each inbox will appear as separate items in your *Site Navigation* under the *Inboxes* heading.
