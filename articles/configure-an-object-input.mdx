...
<comp.Notice info_type="info">
  If you want to configure the root Object in a Structure, please configure the `tabbed` (replaces the `subtype` key on Object inputs), `groups`, `place_groups_below`, `preview`, and `empty_type` on the [structure](/documentation/articles/structures-reference/#tabbed) itself.
</comp.Notice>
