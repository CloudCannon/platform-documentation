...
<comp.DataReference>
  ...
  <comp.DataReferenceRow label="glob" type_markdown="Array of Strings">
    ...
    For more information about developer file, please read our documentation on the [include_developer_files](/documentation/articles/define-your-collections/#include_developer_files) key.
