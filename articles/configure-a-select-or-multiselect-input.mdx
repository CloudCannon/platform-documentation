...
description: >-
  Learn how to configure Select and Multiselect inputs to select from fixed or
...
These keys configure the appearance and functionality of Select or Multiselect inputs in CloudCannon.
