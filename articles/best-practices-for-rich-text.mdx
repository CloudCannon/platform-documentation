...
CloudCannon uses the [js-xss library](https://github.com/leizongmin/js-xss) to sanitize rich text this way.
...
If you need custom markup in your rich text content, you might be able to configure snippets to provide a safe, structured way to edit that content.