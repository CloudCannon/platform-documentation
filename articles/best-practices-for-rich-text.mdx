...
![script and style elements replaced with boxes](/documentation/static/boxed-xss-elements.png)

CloudCannon uses the [js-xss library](https://github.com/leizongmin/js-xss) to remove sanitize rich text this way.
...
The simplest solution is to ensure that all markup in your rich text content can be rendered and edited in CloudCannon.

If you need custom markup in your rich text content, consider configuring snippets to provide a safe, structured way to edit that content.