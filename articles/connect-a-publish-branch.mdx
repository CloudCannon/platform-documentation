...
tags:
  ...
  - publish
related_articles:
  - articles/merging-and-pull-requests.mdx
...
* **Branch Site** — This is the site on which you test your changes. This could be your staging site.
...
CloudCannon offers two publishing modes: merge immediately or pull request.
...
1. Navigate to the *Publishing* tab under *Site Settings*.
2. Check or uncheck the box labeled