...
You can update your site to match the changes made to your Publish Branch to see how your pending changes and updates from other branches work together. We recommend updating if you have long-lived branches or are working on the same files across different branches.&nbsp;

To update your site to match your Publish Branch:

1. Click on the&nbsp;*Publish*&nbsp;button in the&nbsp;*Site navigation*.​​​​​​<!-- notionvc: f8f46c3c-d711-45a2-b552-aaa25ff32987 -->
