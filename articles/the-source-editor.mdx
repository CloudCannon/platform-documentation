...
The Source Editor is used to edit the raw content of text-based files. [Client Sharing](/documentation/articles/share-a-site-with-client-sharing/) users and team members in the [Editors Default Permission Group](/documentation/articles/what-are-default-permission-groups/#editors) do not have access to it.
