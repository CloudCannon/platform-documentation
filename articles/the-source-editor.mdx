...
description: >-
  ...
  interface is an in-browser code editor, great for making small, quick changes.
tags:
  - Beginner
related_articles: []
related_links:
...
The Source Editor is used to edit the raw content of text-based files. [Client Sharing](/documentation/articles/giving-clients-access-to-update-a-site/) users and [editor-level team members](/documentation/articles/managing-your-team-members/) do not have access to it.
