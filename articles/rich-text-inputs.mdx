...
<comp.DataReference>
  ...
  <comp.DataReferenceRow label="paths" type_markdown="Object">
    This key enables you to define the default paths for your assets. Each path is relative to global site `source`. If undefined, the paths default to those configured in the [configuration file](/documentation/articles/create-a-global-configuration-file/). The following nested keys are available:
