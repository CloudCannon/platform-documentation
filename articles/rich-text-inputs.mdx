...
For each input, you can configure the type (HTML or Markdown), whether your team members are allowed to resize the text area, how CloudCannon saves an empty value, the initial height of the text area, and the upload paths or filenames for any assets uploaded through this input. You can also use the [general configuration options](https://bubblegum-dugong.cloudvent.net/documentation/articles/configure-your-inputs/#general-configuration-options) available for all inputs**.**
...
You can configure a HTML input using the `type` key with the value `html`. Define the `type` key under your input key name within `_inputs`. For more information, please read our documentation on [configuring your inputs](https://bubblegum-dugong.cloudvent.net/documentation/articles/configure-your-inputs/).
...
You can configure a Markdown input using the `type` key with the value `markdown`. Define the `type` key under your input key name within `_inputs`. For more information, please read our documentation on [configuring your inputs](https://bubblegum-dugong.cloudvent.net/documentation/articles/configure-your-inputs/).
