...
description: >-
  Single line input for relative, absolute and fully qualified URLs. URL inputs
...
<comp.DocsImage path="/documentation/static/inputs/url/external.png" alt="external_url key shown as a url input" type="screenshot-snippet"/>

<comp.DocsImage path="/documentation/static/inputs/url/internal.png" alt="internal_url key shown as a url input" type="screenshot-snippet"/>

<comp.DocsImage path="/documentation/static/inputs/url/link.png" alt="link key shown as a url input" type="screenshot-snippet"/>
