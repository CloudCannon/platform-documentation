...
<comp.DocsImage path="/uploads/inputs/url/external.png" alt="external_url key shown as a url input" type="screenshot-snippet"/>

<comp.DocsImage path="/uploads/inputs/url/internal.png" alt="internal_url key shown as a url input" type="screenshot-snippet"/>

<comp.DocsImage path="/uploads/inputs/url/link.png" alt="link key shown as a url input" type="screenshot-snippet"/>
