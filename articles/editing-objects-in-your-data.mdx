...
Adding a new entry creates an empty `time` input, and prompts you to enter the new key. This object can have no entries, since the type is configured for the entries.
