...
CloudCannon offers free wildcard SSL certificates for all Sites hosted on CloudCannon through ZeroSSL and Cloudflare. These certificates renew automatically each year, so you Site is never unsecure.
