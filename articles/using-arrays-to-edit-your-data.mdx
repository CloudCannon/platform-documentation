...
<comp.DocsImage path="/uploads/inputs/array/array.png" alt="The array editor with draggable handles, individual menus, and a button at the bottom to add a new item." type="screenshot-snippet"/>
...
<comp.DocsImage path="/uploads/inputs/structures/structure.png" alt="The array editor with a list of staff members including their thumbnail image and name" type="screenshot-snippet"/>

<comp.DocsImage path="/uploads/inputs/structures/structure-item-menu.png" alt="The array editor with a list of staff members including their thumbnail image and name" type="screenshot-snippet"/>
