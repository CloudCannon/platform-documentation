...
<comp.DocsImage path="ye_olde_images/simple-array.png" alt="The array editor with draggable handles, editable text and an option to add new content." type="screenshot-snippet" />
...
<comp.DocsImage path="ye_olde_images/object-array.png" alt="The array editor with a list of staff members including their thumbnail image and name" type="screenshot-snippet" />

<comp.DocsImage path="ye_olde_images/object-array-dropdown.png" alt="The array editor with a list of staff members including their thumbnail image and name" type="screenshot-snippet" />
