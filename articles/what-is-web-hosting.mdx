...
explicit_canonical:
---
Web hosting is where, after a successful [build](/documentation/articles/what-is-a-site-build/), all your files are stored on a web server and made available to the public on the Internet. You can host your Site through CloudCannon or an [external service](/documentation/articles/what-is-external-hosting/).
...
<comp.Notice info_type="info">
  If you want to [host your Site externally](/documentation/articles/what-is-external-hosting/), you can also disable builds on CloudCannon. For more information, please read our documentation on [Headless Mode](/documentation/articles/what-is-headless-mode/).
</comp.Notice>
