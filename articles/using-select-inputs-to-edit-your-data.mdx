...
<comp.DocsImage path="/uploads/inputs/select/color-select.png" alt="Color select input" type="screenshot-snippet"/>

<comp.DocsImage path="/uploads/inputs/select/ssg-select.png" alt="SSG select input" type="screenshot-snippet"/>
...
<comp.DocsImage path="/uploads/inputs/select/colors-multiselect.png" alt="Color multiselect input" type="screenshot-snippet"/>

<comp.DocsImage path="/uploads/inputs/select/colors-multiselect.png" alt="Ssg multiselect input" type="screenshot-snippet"/>
...
<comp.DocsImage path="/uploads/inputs/select/choice.png" alt=""/>
...
<comp.DocsImage path="/uploads/inputs/select/multichoice.png" alt=""/>
