...
<comp.DocsImage path="ye_olde_images/select-color.png" alt="Color select input" type="screenshot-snippet" />

<comp.DocsImage path="ye_olde_images/select-ssg.png" alt="SSG select input" type="screenshot-snippet" />
...
<comp.DocsImage path="ye_olde_images/select-multi-ssg.png" alt="SSG multiselect input" type="screenshot-snippet" />

<comp.DocsImage path="ye_olde_images/select-multi-color.png" alt="Color multiselect input" type="screenshot-snippet" />
