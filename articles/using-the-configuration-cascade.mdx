...
<comp.DataReference>
  ...
  <comp.DataReferenceRow label="_select_data" type_markdown="Object">
    ...
    For more information, please read our documentation on [Select and Multiselect inputs](/documentation/articles/configure-your-select-and-multiselect-inputs/).
  </comp.DataReferenceRow>
