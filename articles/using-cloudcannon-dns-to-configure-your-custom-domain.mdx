...
title: "Using CloudCannon DNS to configure your custom domain"
nav_title: "Using CloudCannon DNS"
published: true
...
<comp.DocsImage path="ye_olde_images/hosting-domains-cloudcannon-dns.png" alt="Screenshot of CloudCannon DNS interface with incorrectly configured DNS" type="screenshot" />
