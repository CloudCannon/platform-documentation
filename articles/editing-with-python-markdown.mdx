...
<comp.DataReference>
  ...
  <comp.DataReferenceRow label="preview" type_markdown="Object">
    A preview definition for displaying this snippet in the CloudCannon editor. See the [preview options documentation](/documentation/articles/changing-how-cards-preview-your-data/).
  </comp.DataReferenceRow>
  <comp.DataReferenceRow label="_inputs" type_markdown="Object">
    Input configurations for the keys contained in this snippet. See the [input configuration documentation](/documentation/articles/how-to-choose-what-input-is-used-in-the-data-editor/).
  </comp.DataReferenceRow>
</comp.DataReference>
