...
tags: ["content editor","snippets","python"]
...
To enable editing and provide the custom snippet in the toolbar, your custom snippet must be configured using the `_snippets` object in your CloudCannon global config file. CloudCannon Snippets can be built from scratch to support nearly any syntax or SSG, but importing a Snippet configuration provides a set of snippet templates for common use cases in MDX.
...
Each snippet definition lives under a top level key, `glossary` in this example. This is the unique name that CloudCannon uses to identify this snippet, but is otherwise unused in the component configuration itself.
...
<comp.DataReference>
  ...
  <comp.DataReferenceRow label="preview" type_markdown="Object">
    A preview definition for displaying this component in the CloudCannon editor. See the [preview options documentation](/documentation/articles/changing-how-cards-preview-your-data/).
  </comp.DataReferenceRow>
  <comp.DataReferenceRow label="_inputs" type_markdown="Object">
    Input configurations for the keys contained in this component. See the [input configuration documentation](/documentation/articles/how-to-choose-what-input-is-used-in-the-data-editor/).
  </comp.DataReferenceRow>
</comp.DataReference>
