...
A [Select or Multiselect input](/documentation/articles/what-is-a-select-input/) is an editing interface for selecting values from predefined lists. By configuring your inputs, you can customize the appearance and functionality for a better editing experience.
