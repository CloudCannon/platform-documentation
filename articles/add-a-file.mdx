...
<comp.Notice info_type="info">
  If your workflow requires many files with similar contents, we recommend setting up a [Schema](/documentation/articles/create-a-schema/).
</comp.Notice>
