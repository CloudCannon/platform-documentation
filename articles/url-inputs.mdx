...
For each input, you can configure how CloudCannon handles empty values. You can also use the [general configuration options](/documentation/articles/configure-your-inputs/#general-configuration-options) available for all inputs.
...
<comp.DataReference>
  ...
  <comp.DataReferenceRow label="hide_link_to_file" type_markdown="boolean">
    This key determines if this input has the "Link to a file" option available.
  </comp.DataReferenceRow>
  <comp.DataReferenceRow label="hide_link_to_page" type_markdown="boolean">
    This key determines if this input has the "Link to a page" option available.
  </comp.DataReferenceRow>
  <comp.DataReferenceRow label="hide_link_to_email_address" type_markdown="boolean">
    This key determines if this input has the "Link to a email address" option available.
  </comp.DataReferenceRow>
</comp.DataReference>
