...
* Snippets with invalid states need to be more obvious.
...
* The "Switch to editing" button in the banner at the bottom of an editing interface does not work.
  * Workaround: Please use the *Editing/Viewing* dropdown in the the top right of the *Editing interface navigation*.
* In the Visual Editor, images that use class=”editable” have unexpected behavior.
* In the Visual Editor, the editable region toolbar does not appear correctly if it is at the top of the screen.
