...
To use different 404 pages for parts of your site, you can use the `404` status code in a [routing.json](/documentation/articles/configure-custom-routing/) file.
