...
<comp.Notice info_type="info">
  Alternatively, you can add a new permission by cloning an existing permission. This method is more efficient when you need to create many similar permissions (e.g., several permissions with a Site scope targeting different Sites). To clone permission, click on the *Context menu* and select *Clone permission*. You can now edit the cloned permission.
</comp.Notice>
