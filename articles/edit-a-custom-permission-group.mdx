...
To add a permission to an existing custom Permission Group:
...
## Delete a permission to a custom Permission Group
...
CloudCannon will delete permission from your custom Permission Group. All members of that group will automatically lose the permission.

## Edit a permission to a custom Permission Group
