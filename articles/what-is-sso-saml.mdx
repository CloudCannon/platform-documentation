...
* **Identity Provider** — The cloud software that will authenticate the user’s identity. An Identity Provider could be an internal software or an [external service](/documentation/articles/what-is-external-hosting/), like Google. A member of your Organization already has a login for this software.
