...
Structured Object inputs appear similar to the default input.
...
Because structured Object inputs have a list of predefined templates, CloudCannon

However, unlike the default Object input, a structured Object input

appear as a [card](https://bubblegum-dugong.cloudvent.net/documentation/articles/configure-your-card-previews/) in the Data Editor or sidebar of the Visual or Content Editor, previewing some of the content it contains.
...
You can configure an Object input using the `structures` key. The value of the `structures` key can be a string or an object. If you have defined your structures elsewhere, under the `_structures` key, you can reference

&nbsp;

Define the `structures` key under `options` within your input key name.
