...
The Object input provides a user interface for a group of inputs. Object inputs appear as a [card](/documentation/articles/what-are-cards/) in the Data Editor or sidebar of the Visual or Content Editor, previewing some of the content it contains.
