...
The Object input provides a user interface for nested keys. Object inputs appear as a [card](/documentation/articles/configure-your-card-previews/) in the Data Editor or sidebar of the Visual or Content Editor, previewing some of the content it contains.
