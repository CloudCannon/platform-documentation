...
---
An Object input lets your team members

There are two subtypes of Object input:

* Structured Object
* Mutable Object

For each input type, you can configure
...
The Object input provides an user interface for nested keys.

<comp.DocsImage path="https://cc-dam.imgix.net/documentation/images/editing/inputs/object/2024-07/CloudCannon-Documentation-Object-Input-Closed.png" alt="" title="" type="screenshot"/>

&nbsp;

<comp.DocsImage path="https://cc-dam.imgix.net/documentation/images/editing/inputs/object/2024-07/CloudCannon-Documentation-Object-Input-Open.png" alt="" title="" type="screenshot"/>
