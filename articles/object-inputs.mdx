...
Additionally, you can create sets of different keys to populate an Object, allowing your team to choose from several predefined [structures](/documentation/articles/create-a-structure/), or create their own as needed.
