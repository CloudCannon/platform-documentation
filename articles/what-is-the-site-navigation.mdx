...
The *Publishing* page is...

If you have configured a branched publishing workflow and have a [Publish Branch](/documentation/articles/what-is-a-publish-branch/) connected to your *Site*, a link to the publishing page will appear in your *Site Navigation*. For more information about publishing, please read our documentation on...

The *Inbox* page is...

If you have multiple forms, each inbox will appear as a separate item in your *Site Navigation* under the *Inboxes* heading. For more information about *Inboxes*, please read our documentation on [forms](/documentation/articles/getting-started-with-forms-on-cloudcannon/).
...
The *File Browser* allows you to see all the website files CloudCannon has synced from your Git provider. You can browse, sort, and filter these files, as well as open them directly in the Source Editor.

The *Site Settings* page

settings for your files, builds, hosting, sharing, and more.