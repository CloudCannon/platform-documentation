...
author_notes: {}
---
On the left of your Site, just in from the *App sidebar*, is your *Site Navigation* in gray. This UI element links to important pages on your Site. Depending on your configuration, this can include your *Dashboard*, *Publishing* page, Collections, Inboxes, and *Developer* pages like *File Browser* and *Site Settings*.
