...
These instructions assume that you know how you want to populate the values of your Array input, and where you want to configure it in the configuration cascade. For more information, please read our documentation on [inputs](/documentation/articles/what-are-inputs/) in general, [populating an Array input](), and the [configuration cascade](/documentation/articles/using-the-configuration-cascade/).
