...
These keys configure how the Collection functions in CloudCannon.
...
<comp.DataReference>
  ...
  <comp.DataReferenceRow label="disable_file_actions" type_markdown="Boolean">
    This key toggles whether team members can use file actions in the *Context menu*, at the top right of a file [Card](/documentation/articles/configure-your-card-previews/) in the *Collection browser*. File actions are *Move*, *Clone*, *Rename*, and *Delete*. This key does not affect file actions in the *File browser*.
  ...
  <comp.DataReferenceRow label="new_preview_url" type_markdown="String">
    This key defines a new URL for previewing your unbuilt pages in the [Visual Editor](/documentation/articles/the-visual-editor/). The Visual Editor will load the new preview URL and use Data Bindings and Previews to render your page your page without saving or building.
  
    <comp.Notice info_type="important">
      For more information on this key, please read our documentation on Bookshop.
    </comp.Notice>
