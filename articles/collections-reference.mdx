...
<comp.DataReference>
  ...
  <comp.DataReferenceRow label="url" type_markdown="String">
      This key defines the output URL for files in a given Collection. CloudCannon uses the output URL in the [Visual Editor](/documentation/articles/the-visual-editor/), and on your [Testing Domain](/documentation/articles/what-is-a-testing-domain/) and [Custom Domain](/documentation/articles/what-is-a-custom-domain/).
