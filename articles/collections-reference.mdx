...
<comp.DataReference>
  ...
  <comp.DataReferenceRow label="preview" type_markdown="Array of Objects">
    This key defines the appearance of a Card. You can configure Card preview for [Collections](/documentation/articles/what-is-a-collection/), [Object inputs](/documentation/articles/object-inputs/), [Array inputs](/documentation/articles/array-inputs/), [Select and Multiselect
...
<comp.DataReference>
  ...
  <comp.DataReferenceRow label="_enabled_editors" type_markdown="Array">
    ...
    Values can be one of the following: `visual`, `content`, or `data`. Specifying one or more editing interfaces will disable all unspecified editinginterfaces. You cannot disable the Source Editor with this key.
