...
<comp.DataReference>
  ...
  <comp.DataReferenceRow label="preview" type_markdown="Object">
    ...
    inputs](/documentation/articles/configure-your-select-and-multiselect-inputs/), [Structures](/documentation/articles/what-is-a-structure/), the Structure modal, [Snippets](/documentation/articles/what-is-a-snippet/), and the Snippet modal.
...
<comp.DataReference>
  ...
  <comp.DataReferenceRow label="_select_data" type_markdown="Object">
    ...
    For more information, please read our documentation on [Select and Multiselect inputs](/documentation/articles/configure-your-select-and-multiselect-inputs/#fixed-data-sets).
  </comp.DataReferenceRow>
