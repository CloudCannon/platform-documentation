...
<comp.DataReference>
  ...
  <comp.DataReferenceRow label="url" type_markdown="String">
    ...
    Values for this key should begin and end with the `/` character.
  ...
  <comp.DataReferenceRow label="disable_url" type_markdown="Array of Objects">
    This key defines
  </comp.DataReferenceRow>
  <comp.DataReferenceRow label="include_developer_files" type_markdown="Array of Objects">
    This key defines
  </comp.DataReferenceRow>
</comp.DataReference>
