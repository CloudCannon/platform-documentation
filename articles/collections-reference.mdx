...
<comp.DataReference>
  ...
  <comp.DataReferenceRow label="add_options.href" type_markdown="String">
    This key defines the link for a URL option in the *\+ Add* button dropdown. You must define this key for the option to appear.
        ...
        team:
          add_options:
            - name: Office Locations
              icon: map
              href: https://www.example.com/our-offices
      ``````````
      </comp.MultiCodeBlock>
    </comp.Example>
  </comp.DataReferenceRow>
