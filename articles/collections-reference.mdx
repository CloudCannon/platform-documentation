...
Your Collections have the following options available:
...
<comp.DataReference>
  ...
  <comp.DataReferenceRow label="glob" type_markdown="Array of Strings">
    ...
    <comp.Example>
      To show all files in the `data` folder except for the `secret.yml` file:
      ...
      To show only `.yml` files within the `data` folder or any nested folders:
      ...
      To show only `.yml` files, except for the `secret.yml` file:
  ...
  <comp.DataReferenceRow label="url" type_markdown="Array of Objects">
    This key defines
  </comp.DataReferenceRow>
