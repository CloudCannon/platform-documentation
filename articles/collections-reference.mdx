...
<comp.DataReference>
  ...
  <comp.DataReferenceRow label="icon" type_markdown="String">
    This key defines the icon for a Collections. Collection icons appear in the *Site Navigation* and are the default icon for Collection file [Cards](/documentation/articles/configure-your-card-previews/) if you have not defined `preview.icon`.
