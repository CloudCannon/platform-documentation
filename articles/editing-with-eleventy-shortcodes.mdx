...
title: "Editing with Eleventy Snippets"
nav_title: "Eleventy Snippets"
published: true
...
<comp.DocsImage path="ye_olde_images/unknown-shortcode.png" alt="A screenshot of an unknown Snippet displayed as a block in the CloudCannon Content Editor" type="regular" />
...
<comp.DocsImage path="ye_olde_images/callout-shortcode.png" alt={"A screenshot of the \"callout\" include in the Content Editor, with the editing panel open showing the snippet data"} type="regular" />
