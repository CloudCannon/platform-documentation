...
You can discard unsaved changes using the *Context menu* in the top right of the file card. When you are happy with the changes made to your site, click the *Save changes* button in the bottom right of the modal.
