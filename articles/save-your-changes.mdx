...
<comp.DocsImage path="https://cc-dam.imgix.net/documentation/images/editing/save-changes/2023-Q4/CloudCannon-Documentation-Commit-Message.png" alt="The r" title="Review changes modal with commit message field" type="ui-snippet"/>
