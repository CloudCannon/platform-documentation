...
<comp.DocsImage path="https://cc-dam.imgix.net/documentation/images/editing/save-changes/2023-Q4/CloudCannon-Documentation-Review-Changes-Modal.png" alt="The Review changes modal with unsaved changes to three files." title="Unsaved changes in the Review changes modal"/>
