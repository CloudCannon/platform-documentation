...
We can reference a structure in any number of array or object inputs. Referencing the same structure in many inputs allows you to:

* Maintain consistency across your site.
* Configure context specific input names and descriptions without affecting the underlying structure
...
</comp.Annotation> <comp.Annotation number="1">
...
_inputs: #1
  header_social_media: #2
    type: array
    options: #3
      structures: _structures.links #4
      preview:
          text:
            - key: name
            - Employee
