...
<comp.Annotation number="1">
  ...
  The key name of your array or object input. In this code, we have called our input `array_one`. You can name your structure anything you want.
</comp.Annotation> <comp.Annotation number="3">
...
<comp.DocsImage path="https://cc-dam.imgix.net/documentation/images/editing/structures/2024-Q1/CloudCannon-Documentation-References-Structures-Multiple-Inputs.png" alt="" title="" type="ui-snippet"/>
