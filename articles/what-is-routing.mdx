...
By default, when visitors enter a URL or click on a link, they will see the content for the file with a file name that matches the URL slug. In most cases, default routing will deliver the correct content to your user. However, you should employ custom routing to avoid the following pitfalls:
...
* Use [geolocation](/documentation/articles/enable-geolocation/) to detect which country your visitors are from.
