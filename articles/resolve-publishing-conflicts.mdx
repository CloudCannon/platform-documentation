...
Publishing conflicts occur when changes to a file on your Site conflict with incoming changes to the same file from your [Publish Branch](/documentation/articles/what-is-a-publish-branch/). CloudCannon can detect publishing conflicts after you try to [update your Site from its Publish Branch](/documentation/articles/update-from-a-publish-branch/).
