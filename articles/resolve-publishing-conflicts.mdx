...
CloudCannon will complete the update from your Publish Branch, including all

<comp.DocShot docshot_key="" alt="" title=""/>

If you do not want to resolve your publishing conflicts immediately, you can abandon the update attempt. Abandoning an update attempt will allow you to save changes to your Site and dismiss the warnings about publishing conflicts. However, you will lose all your unsaved changes.
