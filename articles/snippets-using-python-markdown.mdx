...
<comp.Notice info_type="important">
  If you have already customized which options are available via `_editables` in your CloudCannon config, you will need to include `snippet: true` for Snippets to be available. See the [Editables options documentation](/documentation/articles/define-editable-regions-in-your-html/#options) for more details.
</comp.Notice>
