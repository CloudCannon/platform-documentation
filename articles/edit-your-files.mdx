...
* The *Save* button — When you are ready to [save the changes to your site](/documentation/articles/save-your-changes/), the *Save* button will open the *Review changes* modal. Saving your changes allows you to see them live on your [Testing Domain](/documentation/articles/testing-domain/) or [custom domain](/documentation/articles/hosting-your-site-on-a-custom-domain/).
...
* *Preview live site* — Open this file’s webpage in another tab, using your [Testing Domain](/documentation/articles/testing-domain/) or [custom domain](/documentation/articles/hosting-your-site-on-a-custom-domain/). This will only show your [saved changes](/documentation/articles/save-your-changes/).
