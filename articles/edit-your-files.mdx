...
* *Preview live site* — Open this file’s webpage in another tab, using your [Testing Domain](/documentation/articles/testing-domain/) or [Custom Domain](/documentation/articles/what-is-a-custom-domain/). This will only show your [saved changes](/documentation/articles/save-your-changes/).
