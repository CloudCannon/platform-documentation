...
CloudCannon supports twelve types of input: [Boolean](/documentation/articles/boolean-inputs/), [Code](/documentation/articles/code-inputs/), [Color](/documentation/articles/color-inputs/), [Date and Time](/documentation/articles/date-and-time-inputs/), [File](/documentation/articles/file-inputs/), [Number](/documentation/articles/number-inputs/), [Object](/documentation/articles/object-inputs/), [Array](/documentation/articles/array-inputs/), [Select and Multiselect](/documentation/articles/select-and-multiselect-inputs/), [Text](/documentation/articles/text-inputs/), [Rich text](/documentation/articles/rich-text-inputs/), and [URL](/documentation/articles/url-inputs/).
...
Boolean inputs have the following options available:
