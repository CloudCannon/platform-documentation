...
<comp.DataReference>
  ...
  <comp.DataReferenceRow label="_inputs.[*].options.start_from" type_markdown="String">
    ...
    If `options.end_before` is also defined, this key cannot be a later date and time.
  ...
  <comp.DataReferenceRow label="_inputs.[*].options.end_before" type_markdown="String">
    ...
    If `options.start_from` is also defined, this key cannot be an earlier date and time.
