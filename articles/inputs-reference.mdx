...
All Collections options are configured within the `_inputs` key in your [CloudCannon configuration file](/documentation/articles/what-is-the-cloudcannon-configuration-file/).
...
<comp.DataReference>
  ...
  <comp.DataReferenceRow label="url" type_markdown="String">
      This key defines the output URL for files in a given Collection. CloudCannon uses the output URL in the [Visual Editor](/documentation/articles/the-visual-editor/), and on your [Testing Domain](/documentation/articles/testing-domain/) and [Custom Domain](/documentation/articles/what-is-a-custom-domain/).
...
<comp.DataReference>
  ...
  <comp.DataReferenceRow label="new_preview_url" type_markdown="String">
    ...
    This key does not affect the URL for your [Testing Domain](/documentation/articles/testing-domain/) or [Custom Domain](/documentation/articles/what-is-a-custom-domain/).
