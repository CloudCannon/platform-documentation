...
---
An Input is an editing interface for structured data in your data files or the front matter of markup files. Inputs appear in the [Data Editor](/documentation/articles/what-is-the-data-editor/), as well as in the sidebar and data panels of the [Content](/documentation/articles/what-is-the-content-editor/) and [Visual Editors](/documentation/articles/what-is-the-visual-editor/).
