...
This behavior is convenient if you have simple inputs, or do not want to configure inputs. It is also beneficial for new websites on CloudCannon that do not have any CloudCannon-specific configuration yet.
