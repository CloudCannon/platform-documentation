...
2. Snippet Picker
3. [Structures](/documentation/articles/create-a-structure/)
...
You can use [template strings](/documentation/articles/configure-your-template-strings/) in your card preview. Template strings are a mixture of literal text and dynamic placeholders that are replaced with data when CloudCannon reads them. You can use template strings to populate your card previews with more complex strings.
