...
title: Configure your Object inputs
nav_title: Configure your Object inputs
published: true
image: >-
...
You can configure a tabbed Object input using the `type` key with the value `object`, and the `subtype` key with the value `object`. Define the `type` key under your input key name within `_inputs` and the `subtype` key under `options`. For more information, please read our documentation on [inputs](/documentation/articles/what-are-inputs/).
...
You can configure a tabbed Object input using the `type` key with the value `object`, and the `subtype` key with the value `tabbed`. Define the `type` key under your input key name within `_inputs` and the `subtype` key under `options`. For more information, please read our documentation on [inputs](/documentation/articles/what-are-inputs/).
...
You can configure a tabbed Object input using the `type` key with the value `object`, and the `subtype` key with the value `mutable`. Define the `type` key under your input key name within `_inputs` and the `subtype` key under `options`. For more information, please read our documentation on [inputs](/documentation/articles/what-are-inputs/).
...
The entry input type defines what type of input CloudCannon should use to populate an Object or [Array](/documentation/articles/configure-your-array-inputs/). Configuring the entry input type allows an Object input to be empty without becoming misconfigured. All new nested keys added to an Object input will match the input type specified by the entry input type. Additionally, CloudCannon can repopulate the input if you delete the contents of the Object or create a new instance of that input.
  ...
  example:
    ...
    options:
      ...
      entries:
        ...
        documentation:
          url: https://cloudcannon.com/documentation/articles/configure-your-object-inputs/
          text: Documentation
          icon: help
