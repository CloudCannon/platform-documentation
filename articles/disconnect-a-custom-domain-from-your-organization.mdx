...
<comp.DocShot docshot_key="CloudCannon-DocumentationDomain-Domain-Settings-Tab-Danger" alt="A screenshot of the Domain Settings tab on the Domain page shows the Disconnect Domain button and a warning notification." title="The Domain page Domain Settings tab" type="screenshot"/>