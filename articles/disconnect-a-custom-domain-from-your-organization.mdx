...
A Custom Domain is a unique address used to identify a website (e.g., [cloudcannon.com](https://cloudcannon.com/)). If you have [connected a Custom Domain to your Organization](/documentation/articles/connect-a-custom-domain-to-your-organization/) and [added the Custom Domain to your Site](/documentation/articles/add-a-custom-domain/), CloudCannon will host your website content at that web address.
