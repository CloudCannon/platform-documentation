...
<comp.DocShot docshot_key="Site-Settings-Authentication-Account-Enter-Email" alt="A screenshot of the Authentication page shows a text field where you can enter the email address of the person you want to invite." title="The Authentication Page" type="screenshot"/>
...
Once a user has set their personal password for your Site, CloudCannon will update the

<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Authentication-Account-User-Card" alt="" title="" type="ui-snippet"/>
