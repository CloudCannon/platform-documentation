...
You can add custom message classes to communicate to your users when they use your form, such as error handling messages and success notifications. CloudCannon highly recommends specific message classes, which are detailed in the sections below.
