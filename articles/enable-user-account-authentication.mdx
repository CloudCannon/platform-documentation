...
This page requires form inputs for email and password. We also highly recommend the message class `has-incorrect-login` to communicate to the visitor when they have entered the incorrect login details. A form action is not required for this page.
...
The login page allows visitors to your Site to enter a username and password to view your content. This page must be named `set-password.html`.
