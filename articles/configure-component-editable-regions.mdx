...
These instructions assume you have configured your [build settings](/documentation/articles/configure-your-first-build/), are comfortable editing HTML layouts, either in CloudCannon's [Source Editor](/documentation/articles/what-is-the-source-editor/) or your local development environment, and are using Astro or React components.

To configure Component *Editable Regions* in the [Visual Editor](/documentation/articles/what-is-the-visual-editor/):
...
7. Add the `data-prop=""` HTML attribute to the same DOM element, or to the `<editable-component>` web component. The value of `data-prop` should be the path of the data property you want to edit.
