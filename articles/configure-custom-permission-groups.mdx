...
At the highest level, you can add all resources to a Permission Group, giving members of that Group permission to interact with everything (as is the case with the Owners default Permission Group). At the next tier of the resource tree, you can add all resources under a broad heading, including Organization, Projects, Sites, Permission Groups, and Base Domains.
