...
Using default permission groups, you cannot limit access to an individual site. You can address this problem using [Site Sharing](/documentation/articles/share-a-site-with-site-sharing/) or using custom permission groups.
