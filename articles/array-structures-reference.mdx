...
related_links: []
---
A [structure](/documentation/articles/create-a-structure) is a predefined, custom template that determines what should populate an [array](/documentation/articles/using-arrays-to-edit-your-data/) or [object input](/documentation/articles/object-inputs/).
