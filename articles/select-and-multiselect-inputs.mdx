...
A filter allows you to limit the available values for a Select or Multiselect input to a a subset of possible values. Filters are available for fixed data sets defined under `_select_data`, Collections, or data files.
