...
**By default, CloudCannon does not read data files during your build. To use this option source, instruct CloudCannon to read it by** [**defining your data**](https://bubblegum-dugong.cloudvent.net/documentation/articles/define-your-data/)**.**
