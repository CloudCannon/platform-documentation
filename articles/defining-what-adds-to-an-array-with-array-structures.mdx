...
<comp.DocsImage path="/uploads/inputs/structures/add-array-item.png" alt="An array with the add button highlighted" type="screenshot-snippet"/>
...
<comp.DocsImage path="/uploads/inputs/structures/empty-structure.png" alt="An empty array with the option to add an item" type="screenshot-snippet"/>
...
<comp.DocsImage path="/uploads/inputs/structures/dropdown-selector.png" alt="An empty array with two add options in a dropdown" type="screenshot-snippet"/>

<comp.DocsImage path="/uploads/inputs/structures/structure-with-values.png" alt="An array with two add options in a dropdown and two existing items" type="screenshot-snippet"/>
