...
explicit_canonical:
---
A “build” is when CloudCannon converts all your Site files into a single, functional program. By building your Site in CloudCannon, you can make the most of features such as:

* [The Visual Editor](/documentation/articles/the-visual-editor/)
* Preview screenshots for pages in your [Collection](/documentation/articles/define-your-collections/) browser
* The [Test Domain](/documentation/articles/viewing-your-site-on-a-testing-domain/)
