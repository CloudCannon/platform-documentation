...
While CloudCannon is building your Site, you can read the *Build output* files by clicking on the *Build output* button in the notification at the bottom right of the app.
