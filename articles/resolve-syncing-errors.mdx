...
2. Under the *Syncing Error resolution options* section, click the *Push changes to a new branch* button under the *Create a new branch from CloudCannon changes* heading. CloudCannon will open the *Create a new branch* model.
...
1. Navigate to the *Source Syncing* page, under *Site Settings*.
2. Under the *Syncing Error resolution options* section, click the *Reset to origin* button under the *Reset your Site using origin* heading. CloudCannon will open the *Reset to origin?* model.
3. Click the *Reset to origin* button.
...
1. Navigate to the *Source Syncing* page, under *Site Settings*.
2. Under the *Syncing Error resolution options* section, click the *Switch branch* button under the *Switch this Site to a different branch* heading. CloudCannon will open the *Switch branch* model.
