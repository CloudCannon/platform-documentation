...
1. Navigate to the *Syncing* page, under *Site Settings*.
2. Under the *Syncing Error resolution options* section, click the *Reset using Git repository* button under the *Reset your Site using the Git repository branch* heading. CloudCannon will open the *Reset using Git repository* model.
