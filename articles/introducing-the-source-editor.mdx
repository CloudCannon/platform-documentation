...
title: Introducing the Source Editor
...
<comp.DocsImage path="ye_olde_images/editing-editors-source-editor.png" alt="Screenshot of source editor with an html file open" type="screenshot" />

## Configuring the Source Editor


The [Source Editor](/documentation/articles/introducing-the-source-editor/) is used to edit the raw content of text-based files. [Client Sharing](/documentation/articles/giving-clients-access-to-update-a-site/) users and [editor-level team members](/documentation/articles/managing-your-team-members/) do not have access to it.
...
<comp.DocsImage path="ye_olde_images/editing-editors-source-editor-customisation.png" alt="Screenshot of the Source Editor with a custom theme set" type="screenshot" />

The [Source Editor](/documentation/articles/introducing-the-source-editor/) has the following options available:
