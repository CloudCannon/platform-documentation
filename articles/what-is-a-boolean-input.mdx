...
For more information, please read our documentation on [configuring a boolean input](/documentation/articles/configure-a-boolean-input/), [configuring your inputs](/documentation/articles/configure-your-inputs/) in general, or our [inputs reference](/documentation/articles/inputs-reference/) for a complete list of available configuration keys.

For a complete list of available configuration keys, please read our [input reference](https://vestal-rook.cloudvent.net/documentation/articles/inputs-reference/) documentation.
