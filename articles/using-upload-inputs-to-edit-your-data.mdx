...
<comp.DocsImage path="/uploads/inputs/file/file.png" alt="Screenshot of file input field with a CSS file selected" type="screenshot-snippet"/>
...
<comp.DocsImage path="/uploads/inputs/file/image.png" alt="Screenshot of image upload field with an image file selected" type="screenshot-snippet"/>
...
<comp.DocsImage path="/uploads/inputs/file/document.png" alt="Screenshot of Document input field with a PDF file selected" type="screenshot-snippet"/>
