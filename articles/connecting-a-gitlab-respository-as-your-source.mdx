...
This option will redirect you to GitLab. Log in and authorize CloudCannon access to your GitLab account. You'll be redirected back to CloudCannon to pick a repository to connect.

 

<comp.DocsImage path="ye_olde_images/files-source-syncing-gitlab-oauth.png" alt="ZAMZAMZAM" type="screenshot" />
...
<comp.DocsImage path="ye_olde_images/files-source-syncing-gitlab-token.png" alt="ZAMZAMZAM" type="screenshot" />
...
<comp.DocsImage path="ye_olde_images/files-source-syncing-gitlab-branch-select.png" alt="ZAMZAMZAM" type="screenshot" />
