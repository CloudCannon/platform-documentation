...
<comp.DocShot docshot_key="CloudCannon-Documentation-File-Input-Dropdown" alt="A screenshot of the Add file dropdown on a File Input shows the Upload a new file and Select an existing file options." title="The File Input Select File dropdown" type="ui-snippet"/>
