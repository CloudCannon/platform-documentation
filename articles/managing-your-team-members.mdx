...
<comp.Notice info_type="info">
  If you want to give someone permission to access a site without making them a member of your Organization, you can use Site Sharing or Client Sharing.

  In Site Sharing, Collaborators are added to site-specific permission groups with the same permissions as the default Editor and Techincal Editor permission groups.

  In Client Sharing, Clients can access a site using a site-specific password without creating a CloudCannon account.
