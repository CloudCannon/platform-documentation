...
<comp.Notice info_type="info">
  If you want to give someone permission to access a site without making them a member of your Organization, you can use Client Sharing. Clients have permission to access a single site using a site-specific password. For more information, read our documentation on [client sharing](/documentation/articles/giving-clients-access-to-update-a-site/).
</comp.Notice>
