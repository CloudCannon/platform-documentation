...
<comp.Notice info_type="info">
  If you want to give someone permission to access a site without making them a member of your Organization, you can use Site Sharing or Client Sharing. Using Site Sharing, Collaborators are added to site-specific permission groups with the same permissions as the default Editor and Techincal Editor permission groups. Using Client Sharing, Clients can access a site using a site-specific password without creating a CloudCannon account.

  For more information, read our documentation on [Site Sharing](/documentation/articles/sharing-on-a-per-site-basis/) and [Client Sharing](/documentation/articles/giving-clients-access-to-update-a-site/).
</comp.Notice>
...
<comp.Notice info_type="info">
  ...
  * All the team members you want to remove from your Organization are only members of a single permission group.
  ...
  For more information, read our documentation on [creating a permission group](/documentation/articles/create-a-permission-group/).
</comp.Notice>