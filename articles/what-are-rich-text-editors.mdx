...
* [Editable Regions](/documentation/articles/define-editable-regions-in-your-html/) in the [Visual Editor](/documentation/articles/what-is-the-visual-editor/)
* [Rich Text Inputs](/documentation/articles/what-is-a-rich-text-input/)
...
Each rich text editor has different defaults when editing custom markup. To configure how CloudCannon handles custom markup in your rich text editors, please read our reference documentation on [custom markup in rich text editors](/documentation/articles/rich-text-editor-reference/#wysiwyg-toolbar).