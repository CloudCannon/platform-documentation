...
1. Identify the file you want to which you want to add a Image *Editable Regions*. We recommend any layout files that contain templating that is populated by content files at build time.
