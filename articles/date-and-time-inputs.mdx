...
For each input, you can configure the timezone and null value. You can also use the [general configuration options](/documentation/articles/configure-your-inputs/#general-configuration-options) available for all inputs.
...
<comp.Notice info_type="info">
  A common use of Date and Time inputs is to record the time when you create a new file. To record the date and time of file creation (i.e., TODAY), add `instance_value: NOW` under your input key name.

  For more information about the `instance_value` key, please read our documentation on [general configuration options](/documentation/articles/configure-your-inputs/#general-configuration-options).
</comp.Notice>
