...
author_notes:
  doc_shots: false
---
A Structure is a predefined, custom template that determines what should populate an [Array](/documentation/articles/configure-your-array-inputs/) or [object input](/documentation/articles/object-inputs/).
