...
<comp.DataReference>
  <comp.DataReferenceRow label="icon" type_markdown="String">
    This key defines the icon for a given value in a Structure. This key is the default icon for item [Cards](/documentation/articles/configure-your-card-previews/) in an Object or Array input or the Structure modal, if you have not defined `preview.icon`.
