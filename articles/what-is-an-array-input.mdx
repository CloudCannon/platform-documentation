...
Array inputs need a method for populating new entries. CloudCannon will populate new entries in one of three ways: by cloning the format of the most recent entry in the Array and removing the data content, using a predefined [Structure](/documentation/articles/what-is-a-structure/) as a template, or using a predefined Entry Input Type.
