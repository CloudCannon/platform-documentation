...
<comp.DocShot docshot_key="CloudCannon-Documentation-Array-Input" alt="A screenshot of the Array Input in the Data Editor shows a two preview cards in a list." title="The Array input" type="ui-snippet"/>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Array-Input-Inline" alt="A screenshot of the Array Input in the Data Editor shows a several inline cards in a list." title="The Array input" type="ui-snippet"/>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Array-Input-Dropdown-Open" alt="A screenshot of the Context Menu on an Array Input shows several entry options." title="The Array Input entry context menu" type="ui-snippet"/>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Array-Input-Open" alt="A screenshot of the nested content within an Array Input in the Data Editor." title="The Array input" type="ui-snippet"/>

Depending on how your developer has configured the Array input, clicking the *\+ Add* button will either clone the last entry in the Array, allow you to choose from predefined [Structures](/documentation/articles/what-is-a-structure/), or add an entry that matches the Entry Input Type.
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Array-Input-Context" alt="A screenshot of the Array Input in the Data Editor with a Context Box underneath the text area." title="Array Input with Context Box" type="ui-snippet"/>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Array-Input-Preview" alt="A screenshot of the Array Input in the Data Editor shows an icon, icon color, and subtext." title="Array Input with Preview" type="ui-snippet"/>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Array-Input-Unique" alt="A screenshot of the Array Input in the Data Editor shows an error message as there are non-unique values." title="The Array Input" type="ui-snippet"/>
...
<comp.DocShot docshot_key="CloudCannon-Documentation-Array-Input-Misconfigured" alt="A screenshot of a misconfigured Array input in the Data Editor shows an orange warning box." title="A misconfigured Array Input" type="ui-snippet"/>
