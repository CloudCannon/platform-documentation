...
If your Array input uses a Structure, you can select a predefined template to populate a new entry. If your developer has configured multiple Structures, you can select the one that

If your Array input uses an entry Input type
