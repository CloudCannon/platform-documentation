...
At the top of you Cloudinary console, navigate to **Dashboard** at the top of page. You should see a dashboard which lists your Cloud Name, API Key, and API Secret.
