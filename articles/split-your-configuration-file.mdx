...
* Check where you have defined you configuration. If you have defined a configuration key multiple times at the same level of the [configuration cascade](/documentation/articles/using-the-configuration-cascade/), CloudCannon will preferentially use the configuration defined in files later in the [import order](/documentation/articles/why-split-your-configuration-file/#what-happens-when-you-define-the-same-key-in-multiple-files) (i.e., inline configuration first, followed by configuration from other files in Unicode order).
