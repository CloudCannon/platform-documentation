...
related_links:
  ...
  - name: Zapier Documentation
    url: https://zapier.com/help/create/code-webhooks
  - name: IFTTT
    url: https://ifttt.com/
  - name: IFTTT FAQ
    url: https://help.ifttt.com/hc/en-us/articles/115010230347-The-Webhooks-Service
---
<comp.Notice info_type="important">
  From July 2024, CloudCannon cannot guarantee support for this feature. This is a deprecated feature that only applies to Legacy CloudCannon forms. Please consider migrating to our new form configuration with the (Legacy Form Migration Guide)[/documentation/articles/legacy-forms-migration-guide/].
</comp.Notice>
