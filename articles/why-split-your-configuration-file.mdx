...
``````````
<comp.Annotation number="2">
  In `boardMember.cloudcannon.structure-value.yml`, there is one array item, "Board". CloudCannon will append this value after the inline values defined in the main *Configuration File*.
</comp.Annotation>
</comp.MultiCodeBlock>
