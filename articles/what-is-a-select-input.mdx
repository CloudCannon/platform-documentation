...
If your input configuration allows you to create new values in Select and Multiselect inputs, and you enter a value under the minimum or over the maximum character count, CloudCannon will display an error message in red text under the input field.
