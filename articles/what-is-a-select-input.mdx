...
If your Multiselect or Multichoice input requires unique values, CloudCannon will warn you when two or more values are not unique.

<comp.DocShot docshot_key="CloudCannon-Documentation-Multiselect-Input-Unique" alt="A screenshot of the Multiselect Input in the Data Editor shows an error message as there are non-unique values." title="The Multiselect Input" type="ui-snippet"/>
