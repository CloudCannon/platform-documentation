...
<comp.DocShot docshot_key="CloudCannon-Documentation-Choice-Input-Max-Length" alt="A screenshot of the Choice Input in the Data Editor shows an error message as the value is too many characters." title="The Choice Input" type="ui-snippet"/>
