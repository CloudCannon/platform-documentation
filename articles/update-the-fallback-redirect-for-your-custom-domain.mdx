...
4. &nbsp;Click the *Update fallback redirect* button under the *Fallback redirect* heading on the *Network* tab. CloudCannon will open the *Update your fallback redirect* modal.
5. &nbsp;Select the subdomain
