...
<comp.DocShot docshot_key="CloudCannon-Documentation-Domains-Network-Tab" alt="A screenshot of the Network tab on the Domain page shows the fallback redirect section and Update fallback redirect button." title="The Domain page Network tab" type="screenshot"/>

<comp.DocShot docshot_key="CloudCannon-Documentation-Domains-Network-Tab-Fallback-Redirect-Modal" alt="A screenshot of the Update your fallback redirect modal on the Network tab shows a Subdomain dropdown for selecting a new fallback redirect." title="The Domain page Network tab" type="screenshot"/>
