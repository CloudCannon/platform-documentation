...
To use a Custom Domain on CloudCannon you can [connect a Custom Domain to your Organization](/documentation/articles/connect-a-custom-domain-to-your-organization/), then [add a Custom Domain to your Site](/documentation/articles/add-a-custom-domain/). Every time you [save changes](/documentation/articles/save-your-changes/) to your Site's content, CloudCannon will [build your Site](/documentation/articles/what-is-a-site-build/) and serve the new content on your Custom Domain.
