...
For more information, please read our documentation on [adding a subdomain](/documentation/articles/add-a-custom-domain-to-your-site/#use-a-subdomain) and [hosting your Site on a subpath](/documentation/articles/add-a-custom-domain-to-your-site/#use-a-subpath).