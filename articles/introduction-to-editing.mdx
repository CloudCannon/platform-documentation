...
* [Commit your changes](/documentation/articles/formatting-your-commit-messages/) — learn how to write commit messages and save your work to your git repository.
* [Inputs](/documentation/articles/how-to-choose-what-input-is-used-in-the-data-editor/) — configure your structured data to create an intuitive interface.
* Structures — create predefined objects to add to your content.
