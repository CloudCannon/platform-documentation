...
* Editing interfaces — the [Visual](/documentation/articles/the-visual-editor/), [Content](/documentation/articles/the-content-editor/), [Data](/documentation/articles/the-data-editor/), and [Source](/documentation/articles/the-source-editor/) Editors.
...
<comp.Conditional ssgs={["Jekyll"]}>
  The `.js` and `.cjs` file types are not supported in Jekyll.
</comp.Conditional>
...
The Source Editor is an in-browser code editor that is great for making minor changes to any of your files. CloudCannon automatically applies syntax highlighting to your files based on the file extension. This editing interface does not require configuration and will work out of the box for any SSG. This editing interface is available to users with [Owner, Developer, and Technical Editor permission levels](/documentation/articles/managing-your-team-members/).
...
* [The Data Editor](/documentation/articles/the-data-editor/)
* [The Source Editor](/documentation/articles/the-source-editor/)
...
We currently support Snippets for the following:
