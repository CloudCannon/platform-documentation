...
* [Create a Snippet](/documentation/articles/create-a-snippet/) — create structured components in Markup using [Docusaurus](/documentation/articles/snippets-using-docusaurus-components/), [Eleventy](/documentation/articles/snippets-using-eleventy-shortcodes/), [Hugo Shortcodes](/documentation/articles/snippets-using-hugo-shortcodes/), [MDX](/documentation/articles/snippets-using-mdx-components/), or [Python Markdown](/documentation/articles/snippets-using-python-markdown/).
...
For a more in-depth explanation, including how to create a snippet, read our documentation:

* [Create a Snippet](/documentation/articles/create-a-snippet/)