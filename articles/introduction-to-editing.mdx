...
For a more in-depth explanation of our editing interfaces, including how to configure each interface and customize the default editor for a given Collection or specific file type, read our documentation:
