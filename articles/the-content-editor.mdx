...
related_links:
---
The Content Editor is a rich text editor for clean, distraction-free editing of content-heavy files. This editing interface is most useful for markup and combination files, such as Markdown, MDX, and Markdown/MDX files with front matter.
...
You can open or close the sidebar using the arrow button on the right on the panel. The sidebar in the [Visual](/documentation/articles/the-visual-editor/) and Content Editor shows the same information as the [Data Editor](/documentation/articles/the-data-editor/).
...
For more information, read our documentation [introducing snippets](/documentation/articles/introducing-snippets/).