...
An [output URL](/documentation/articles/what-is-an-output-url/) is the URL your SSG outputs your files to during a [Site build](/documentation/articles/what-is-a-site-build/). CloudCannon automatically determines the output URL to match a webpage preview to a file for the [Visual Editor](/documentation/articles/what-is-the-visual-editor/) and screenshots in the *Collection Browser*.
