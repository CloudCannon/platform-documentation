...
* You cannot release a domain from your Organization if it is connected to any Sites.
...
* If you don't have a domain connected to your Site, the Custom Domain page will allow you to add an existing domain from your Organization, or create a domain using the *Base Domain* dropdown.
