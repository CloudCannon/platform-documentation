...
<comp.DocsImage path="https://cc-dam.imgix.net/documentation/images/change-log/2025-03/CloudCannon-Changelog-Content-Editor-Context-Menu.png" alt="" title="The file Context Menu" type="ui-snippet"/>
