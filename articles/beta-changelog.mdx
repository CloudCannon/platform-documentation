...
### Content Editor *Context Menu* updates

We added a new file action, *View diff*, to the *Context Menu* in the Content Editor, and changed the behavior of the *Clone* file action.
...
* Fixed an issue where the gallery preview on an Image snippet in the Content Editor would disappear on click or drag.
