...
* Fixed an issue where, when you tried to select an image for an Image input, gallery previews on the cards in the *Files* modal would not display correctly.
