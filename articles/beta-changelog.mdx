...
* The *Publishing* page will show you a list of all files with incoming changes, including files with conflicts. When you click on the card for a conflicted file, CloudCannon will open the Source Editor and highlight the conflicted sections.
...
* The changes in the file from your current branch are highlighted in red, and the incoming changes from the Publish Branch are highlighted in green.
* &nbsp;

Conflict you can't resolve in the Source Editor (e.g., an image)
