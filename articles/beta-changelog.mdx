...
* &nbsp;You can see the *Domain* page when you click on a domain card in the *Domains browser*. The *Domain* page allows you to review and manage all settings for a given domain.
* The *Domain* page has four tabs: the *Network* tab, the *DNS* tab, the *Sites* tab, and the *Domain Settings* tab.
  * The *Network* tab
  * The *DNS* tab
  * The *Sites* tab
  * The *Domain Settings* tab.
