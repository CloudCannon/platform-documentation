...
<comp.DocShot docshot_key="CloudCannon-Documentation-Site-Settings-Editing-Page" alt="A screenshot of the Editing page in Site Settings shows the Edit your configuration file button." title="The Editing page" type="screenshot"/>