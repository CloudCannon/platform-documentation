...
CloudCannon automatically adds size attributes (width, height, sizes) to the HTML for images uploaded in the [Content Editor](/documentation/articles/introducing-the-content-editor/) and [Editable Regions](/documentation/articles/define-editable-regions-in-your-html/).
