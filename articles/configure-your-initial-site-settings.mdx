...
1. Using your local development environment, navigate to the `.cloudcannon` folder in your root directory, or create one.
...
<comp.DataReference>
  ...
  <comp.DataReferenceRow label="build.manually_configure_urls" type_markdown="Boolean">
    This key toggles whether CloudCannon will skip automatic URL detection and rely on the URLs specified in your CloudCannon configuration file.
