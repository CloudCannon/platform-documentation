...
1. Using your local development environment, navigate to the `.cloudcannon` folder in the root of your repository, or create one.
2. Create a new file named `initial-site-settings.json`.
3. Configure your settings.
4. Save your initial Site settings file to your Git repository.
