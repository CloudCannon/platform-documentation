...
CloudCannon will show the minimum or maximum character count underneath the code area. This text will be red if you have not matched the character requirements.
