...
* The *Edited* badge indicates a file’s content has been updated or files within a folder have been added, edited, or marked for deletion. The *Edited* badge will also appear on site cards in the sites list when there are unsaved changes on that site.
