...
<comp.Notice info_type="important">
  From July 2024 CloudCannon cannot guarantee support for this input. This is a deprecated input. Please consider using a [Text](/documentation/articles/what-is-a-text-input/) or [URL input](/documentation/articles/configure-your-url-inputs/).
</comp.Notice>
