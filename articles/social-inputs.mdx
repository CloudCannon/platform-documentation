...
<comp.Notice info_type="important">
  From July 2024 CloudCannon cannot guarantee support for this input. This is a deprecated input. Please consider using a [Text](/documentation/articles/configure-your-text-inputs/) or [URL input](/documentation/articles/url-inputs/).
</comp.Notice>
