...
<comp.Notice info_type="important">
  From July 2024 CloudCannon cannot guarantee support for this input. This is a deprecated input. Please consider using a [Text](/documentation/articles/configure-your-text-inputs/) or [URL input](/documentation/articles/configure-your-url-inputs/).
</comp.Notice>
...
<comp.DocsImage path="/documentation/static/inputs/social/facebook.png" alt="Screenshot of a two Facebook input. The first input uses a Facebook username, and the second input uses a full URL to a Facebook page as values" title="" type="screenshot-snippet"/>
...
<comp.DocsImage path="/documentation/static/inputs/social/twitter.png" alt="Screenshot of three Twitter inputs. The first and third inputs use Twitter usernames, while the second input uses a full URL to a Twitter page as values" title="" type="screenshot-snippet"/>
...
<comp.DocsImage path="/documentation/static/inputs/social/instagram.png" alt="Screenshot of two Instagram inputs. The first input uses a full URL to an Instagram page, and the second input uses the name of an Instagram handle as the value" title="" type="screenshot-snippet"/>
...
<comp.DocsImage path="/documentation/static/inputs/social/github.png" alt="Screenshot of three GitHub username inputs. The first input uses a GitHub username, the second input uses a full URL to a GitHub user, and the third input uses a full URL to a GitHub repository as values" title="" type="screenshot-snippet"/>
...
<comp.DocsImage path="/documentation/static/inputs/social/pinterest.png" alt="Screenshot of three Pinterest inputs. The first and second inputs use a Pinterest username, and the third input uses a full URL to Pinterest user" title="" type="screenshot-snippet"/>
