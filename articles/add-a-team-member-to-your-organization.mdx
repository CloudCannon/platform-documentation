...
CloudCannon will email anyone who does not yet have a CloudCannon account and invite them to create one. While you wait for them to accept the invitation, their name will appear in the list of *Pending members* under the *Members* tab of the *Team* page.
