...
<comp.DocsImage path="https://cc-dam.imgix.net/documentation/images/sharing/permission-groups/2024-05/CloudCannon-Documentation-Add-Member-To-Group-Modal.png" alt="A screenshot of the Developers Permission Group page shows the Add Members to Group modal with a field for names." title="The Add Members to Group modal" type="screenshot"/>