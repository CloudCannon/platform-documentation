...
related_links:
  - name: iwantmyname DNS Documentation
    url: >-
      https://help.iwantmyname.com/hc/en-gb/categories/360002768037-DNS-Nameservers
  - name: Namecheap FreeDNS
    url: https://www.namecheap.com/domains/freedns.aspx
  - name: GoDaddy DNS Documentation
    url: https://www.godaddy.com/help/managing-dns-for-your-domain-names-680
---
...
To switch to External DNS for a Site hosted on CloudCannon, you can edit the settings on the *Domain Settings* page.
