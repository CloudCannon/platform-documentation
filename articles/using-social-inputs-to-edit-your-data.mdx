...
<comp.DocsImage path="/uploads/inputs/social/facebook.png" alt="Screenshot of a two Facebook input. The first input uses a Facebook username, and the second input uses a full URL to a Facebook page as values" type="screenshot-snippet"/>
...
<comp.DocsImage path="/uploads/inputs/social/twitter.png" alt="Screenshot of three Twitter inputs. The first and third inputs use Twitter usernames, while the second input uses a full URL to a Twitter page as values" type="screenshot-snippet"/>
...
<comp.DocsImage path="/uploads/inputs/social/instagram.png" alt="Screenshot of two Instagram inputs. The first input uses a full URL to an Instagram page, and the second input uses the name of an Instagram handle as the value" type="screenshot-snippet"/>
...
<comp.DocsImage path="/uploads/inputs/social/github.png" alt="Screenshot of three GitHub username inputs. The first input uses a GitHub username, the second input uses a full URL to a GitHub user, and the third input uses a full URL to a GitHub repository as values" type="screenshot-snippet"/>
...
<comp.DocsImage path="/uploads/inputs/social/pinterest.png" alt="Screenshot of three Pinterest inputs. The first and second inputs use a Pinterest username, and the third input uses a full URL to Pinterest user" type="screenshot-snippet"/>
