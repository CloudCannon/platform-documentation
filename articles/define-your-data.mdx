...
Your data file or folder is now available for [Select and Multiselect](/documentation/articles/what-is-a-select-input/) inputs configured with this data key.
