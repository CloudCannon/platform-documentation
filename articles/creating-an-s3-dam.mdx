...
**(Optional)** Edit the *AllowedOrigins* key to include only your sites. Origins can either match single URLs `https://my-site.com` or multiple URLs using wildcards `https://*.my-site.com`.
