...
related_links:
---
You can configure your inputs to determine how you store structured data in your data files or front matter. You can also customize the appearance and functionality of each input to improve the experience for your team members.
...
Once we add the above code to our global configuration file, we need to add the input to the front matter of our blog file.
...
Once we save our changes to both files, opening our blog file will show the input `blog_tags` we configured in the Data Editor or the sidebar of the Visual or Content Editor.
