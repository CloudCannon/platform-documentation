...
There are multiple ways to configure your rich text editors, depending on which editor you want to configure: [the Content Editor](/documentation/articles/what-is-the-content-editor/), [editable regions](/documentation/articles/define-editable-regions-in-your-html/) in the [Visual Editor](/documentation/articles/what-is-the-visual-editor/), or [Rich Text inputs](/documentation/articles/what-is-a-rich-text-input/).
...
<comp.Annotation number="3">
  This input is an HTML Rich Text input. For more information, please read our documentation on [Rich Text inputs](/documentation/articles/what-is-a-rich-text-input/).
</comp.Annotation>
