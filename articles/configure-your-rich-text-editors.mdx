...
<comp.Annotation number="3">
  This input is an HTML Rich Text input. For more information, please read our documentation on [Rich Text inputs](/documentation/articles/configure-your-rich-text-inputs/).
</comp.Annotation>
