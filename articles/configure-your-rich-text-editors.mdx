...
You can configure editable regions anywhere in the [configuration cascade](https://hopeful-taro.cloudvent.net/documentation/articles/using-the-configuration-cascade/), but for this example we'll use the global configuration file.
