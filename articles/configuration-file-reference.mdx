...
<comp.DataReference>
  ...
  <comp.DataReferenceRow label="_structures" type_markdown="Object">
    This key defines which structures are available for [Object inputs](/documentation/articles/object-inputs/) and [Array inputs](/documentation/articles/array-inputs/).
