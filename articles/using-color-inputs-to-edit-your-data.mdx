...
title: Using Color Inputs to edit your data
nav_title: Color
published: true
image: >-
...
<comp.DocsImage path="/documentation/static/inputs/color/color.png" alt="Screenshot of color input unfocused" type="screenshot-snippet"/>

<comp.DocsImage path="/documentation/static/inputs/color/color-picker.png" alt="Screenshot of color input field focused" type="screenshot-snippet"/>
