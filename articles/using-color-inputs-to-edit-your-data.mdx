...
<comp.DocsImage path="/uploads/inputs/color/color.png" alt="Screenshot of color input unfocused" type="screenshot-snippet"/>

<comp.DocsImage path="/uploads/inputs/color/color-picker.png" alt="Screenshot of color input field focused" type="screenshot-snippet"/>
