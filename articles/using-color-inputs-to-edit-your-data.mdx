...
<comp.DocsImage path="ye_olde_images/color.png" alt="Screenshot of color input unfocused" type="screenshot-snippet" />

<comp.DocsImage path="ye_olde_images/color-open.png" alt="Screenshot of color input field focused" type="screenshot-snippet" />
