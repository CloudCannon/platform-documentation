...
<comp.DataReference>
 ...
 <comp.DataReferenceRow label="raw" type_markdown="boolean">
    A stricter version of `allow_nested: false` that performs no processing of the inner text.
    Useful to improve the performance of the content parser in some instances.
 </comp.DataReferenceRow>
