...
<comp.DataReference>
  ...
  <comp.DataReferenceRow label="model.forbidden_tokens" type_markdown="array of strings">
    Stops parsing as soon as one of these tokens is encountered.
    Useful when the parser is being greedy and consuming more input than intended, or when the parser doesn't seem to be functioning.
