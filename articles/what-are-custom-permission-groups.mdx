...
* Define file globs exceptions for each Group for more precise permissions.
...
By specifying a file glob, you can implement fine-grain control over reading and editing site files. A glob is a pattern used to identify matching files. With file globs, you can can specify which collections, folders, filenames, and file extensions a team member is allowed to read or edit.
...
For example, if we add a permission to write the file glob `/posts/**/*.md`, CloudCannon will allow members of this Permission Group to read and edit any Markdown files within any subfolders of the Collection "Posts".
...
For best practices and examples of how to use file globs, please read our documentation on [file glob best practices](/documentation/articles/best-practices-for-file-globs/).
