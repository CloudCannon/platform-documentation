...
To prevent incoming changes from your Git repository from overwriting your unsaved changes, CloudCannon will stop attempting to sync your files and alert you to the syncing conflict. You need to
