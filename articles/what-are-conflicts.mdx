...
There are two types of conflicts you can encounter in CloudCannon: Publishing Conflicts and Syncing Conflicts.
...
* **Syncing conflict** — When incoming changes to a file from a different CloudCannon Site or your git repository conflict with unsaved changes to the same file on your Site.
...
CloudCannon will notify you about a Publishing Conflict using the *Conflicts* warning notification above the *Publish* button in your *Site Navigation*. For more information, please read our documentation on <a href="/documentation/articles/resolve-publishing-conflicts/" target="_blank" rel="noopener">resolving publishing conflicts</a>.
...
Before we can save any changes to other files, CloudCannon requires you to choose which version of the file to keep by attempting to merge the incoming changes with the unsaved changes or discarding your unsaved changes.
...
CloudCannon will notify you about a *Syncing Conflict* using the *Conflicts* warning notification above the *Save* button in your *Site Navigation*. For more information, please read our documentation on [resolving syncing conflicts](/documentation/articles/resolve-syncing-conflicts/).