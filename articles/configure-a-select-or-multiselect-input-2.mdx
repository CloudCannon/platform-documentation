...
A [Select or Multiselect input](/documentation/articles/what-are-select-and-multiselect-inputs/) is an editing interface for selecting values from predefined lists. By configuring your inputs, you can customize the appearance and functionality for a better editing experience.
...
These instructions assume that you know what type of Select or Multiselect input you want to configure, how you want to populate the values of your input, and where in the configuration cascade. For more information, please read our documentation on [inputs](/documentation/articles/what-are-inputs/) in general, [populating a Select or Multiselect input](/documentation/articles/populate-a-select-or-multiselect-input/), and the [configuration cascade](/documentation/articles/using-the-configuration-cascade/).
...
7. (Optional.) Add any specific configuration keys under `_inputs.*.options` (e.g., `preview`, `value_key`, `allow_empty`).
8. &nbsp;
