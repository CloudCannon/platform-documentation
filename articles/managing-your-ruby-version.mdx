...
description: "CloudCannon supports Ruby versions using rbenv. Jekyll sites without the version specified use the default version which changes periodically."
