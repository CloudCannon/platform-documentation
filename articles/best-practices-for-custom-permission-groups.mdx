...
### Minimum set of resources required to load a Site

x

<comp.Notice info_type="info">
  **Why is there not a single resource for loading a Site in CloudCannon?**

  We separated the resources required to load a Site to support future API access. The CloudCannon API will be able to access any subset of resources without loading everything. The CloudCannon API is currently in early access.
</comp.Notice>
...
Specifying a file glob in a permission or an exception will override any selections made in the resource tree.
