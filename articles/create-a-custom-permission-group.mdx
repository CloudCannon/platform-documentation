...
10. If you want to include any [exceptions](/documentation/articles/what-are-custom-permission-groups/#exceptions) in your Permission Group, click the *Add exception* button to open the *Add exception* modal.
