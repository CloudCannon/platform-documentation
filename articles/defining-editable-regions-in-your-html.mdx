...
<comp.DataReference>
 <comp.DataReferenceRow label="image_size_attributes" type_markdown="Boolean">
  ...
  <comp.DataReferenceRow label="allowed_sources" type_markdown="Array">
   ...
   You can refer to a DAM with the **Key** field from the Organization-level DAM configuration.

   You can refer to your site files with `site_files`. If this is omitted from the array, site files will not be available as an asset source for this input.
 </comp.DataReferenceRow>
</comp.DataReference>
