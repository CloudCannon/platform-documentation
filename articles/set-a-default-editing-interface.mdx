...
This option is set in the front matter of specific files. You can also set this [globally](/documentation/articles/introduction-to-editing/), or for all files in a collection when [configuring your collections](/documentation/articles/configure-your-collections/).
...
<comp.DataReference>
  <comp.DataReferenceRow label="_enabled_editors" type_markdown="Array of strings">
    ...
    * `visual` for the [Visual Editor](/documentation/articles/what-is-the-visual-editor/)
    * `content` for the [Content Editor](/documentation/articles/what-is-the-content-editor/)
    * `data` for the [Data Editor](/documentation/articles/what-is-the-data-editor/)

    The [Source Editor](/documentation/articles/what-is-the-source-editor/) is always available for those with permission.
