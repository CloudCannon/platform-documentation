...
author_notes: {}
---
When you [connect a Custom Domain to your Organization](/documentation/articles/connect-a-custom-domain-to-your-organization/), CloudCannon requires you to select a [DNS](/documentation/articles/what-is-dns/) provider. DNS providers manage and host the DNS records for your Custom Domain.
...
**an organization that manages and hosts the Domain Name System (DNS) records for a domain name**

<comp.Notice info_type="info">
  When you [connect a Custom Domain to your Organization](/documentation/articles/connect-a-custom-domain-to-your-organization/), CloudCannon requires you to select a DNS provider. It is important to understand how DNS works
</comp.Notice>
