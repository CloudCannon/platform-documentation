...
In the previous section of this guide, we created our <a target="_blank" rel="noopener" href="https://cloudcannon.com/documentation/articles/setting-global-configuration/">CloudCannon configuration file</a>, `cloudcannon.config.yaml`. The sidebar prompt to create the configuration file has disappeared.
