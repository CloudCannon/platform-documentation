...
parameters:
  SSG Name:
    ...
    type: text
  Build Command:
    comment: Enter a custom configured build command (i.e. `hugo build`).
    type: text
...
* Output Path: Configure the path to the output folder you are building into. CloudCannon needs to know which folder to treat as the static output of your site.&nbsp;<comp.CommonParam parameters={parameters} parameter="Default Build Folder" />
