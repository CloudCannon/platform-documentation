...
![An app pop-up with two options for creating a new site in CloudCannon, 'Edit with a template' or 'Build with your own files'.](https://cc-dam.imgix.net/documentation/CloudCannon-Setup-Guide-Own-Files.png "Build a new site with your own files")
