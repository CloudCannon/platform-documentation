...
![The CloudCannon app shows a field for your new site's name and a drop-down menu to select your git platform.](https://cc-dam.imgix.net/documentation/CloudCannon-Setup-Guide-File-Source.png "Select your site name and git platform")
...
![The CloudCannon app shows a field for your new site's git repository.](https://cc-dam.imgix.net/documentation/CloudCannon-Setup-Guide-Select-Repository.png "Select your site repository")
...
![The CloudCannon app shows a new or existing branch selector and a drop-down menu to select an existing branch.](https://cc-dam.imgix.net/documentation/CloudCannon-Setup-Guide-Select-Branch.png "Select your site branch")
...
![The CloudCannon app shows a green tick to indicate that your build was successful.](https://cc-dam.imgix.net/documentation/CloudCannon-Setup-Guide-Successful-Build.png "Successful build")
