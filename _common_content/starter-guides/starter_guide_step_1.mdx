...
<comp.DocsImage path="https://cc-dam.imgix.net/documentation/CloudCannon-Getting-Started-Own-Files.png" alt="An app pop-up with two options for creating a new site in CloudCannon, 'Edit with a template' or 'Build with your own files'." title="Build a new site with your own files" type="screenshot"/>
