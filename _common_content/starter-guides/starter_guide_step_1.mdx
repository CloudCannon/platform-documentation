...
parameters:
  ...
  Default_Build_Folder:
    ...
    type: markdown
---
Learn how to set up your website on the CloudCannon <comp.CommonParam parameters={parameters} parameter="SSG_Name" /> CMS.
...
<img src="/documentation/uploads/cloudcannon-getting-started-select-branch.png" width="1920" height="931" alt="The CloudCannon app shows a new or existing branch selector and a drop-down menu to select an existing branch." title="Select your site branch" />
...
<comp.Slot name="Image: Enter SSG appropriate png named CloudCannon-Getting-Started-Build..."></comp.Slot>
