...
<comp.Slot name="Input-configuration">
  ...
  * [URL](https://beta.cloudcannon.com/documentation/articles/url-inputs/) — Add a relative or absolute URL.
  ...
  In the previous step of this guide, we created a new blog post using a schema.
  ...
  Let's configure a new input for our Site. You can follow along and create the same input as we go, or create a different input type using the documentation linked above.
