...
<comp.Slot name="Structure-configuration">
  ...
  A [structure](/documentation/articles/what-is-a-structure/) is a predefined, custom template that determines what should populate an [Array input](/documentation/articles/configure-your-array-inputs/) or [Object input](/documentation/articles/object-inputs/).
