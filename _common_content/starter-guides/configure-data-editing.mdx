...
<comp.Slot name="Structure-configuration">
  ...
  A [structure](/documentation/articles/what-is-a-structure/) is a predefined, custom template that determines what should populate an [Array input](/documentation/articles/what-is-an-array-input/) or [Object input](/documentation/articles/what-is-an-object-input/).
