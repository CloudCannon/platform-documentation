...
3. Within a [Schema](/documentation/developer-articles/what-is-a-schema/)
4. Within the front matter of a file
5. Within a [Structure](/documentation/developer-articles/what-is-a-structure/)
...
<comp.Slot name="Structure-configuration">
  ...
  A [structure](/documentation/developer-articles/what-is-a-structure/) is a predefined, custom template that determines what should populate an [Array input](/documentation/articles/configure-your-array-inputs/) or [Object input](/documentation/articles/configure-your-object-inputs/).
  ...
  * Any repeated component or content block, such as testimonials or a gallery.
  ...
  For more examples, visit our documentation on [structures](/documentation/developer-articles/what-is-a-structure/).
...
Once you have finished editing your [CloudCannon configuration file](/documentation/developer-articles/create-your-cloudcannon-configuration-file/), you can save your changes using the *Save* button at the top right of the Data Editor.
