...
In this step of the guide we'll focus on configuring the appearance and functionality of markup editing interfaces in the [Visual Editor](/documentation/articles/the-visual-editor/), the [Content Editor](/documentation/articles/the-content-editor/), the [Data Editor](/documentation/articles/the-data-editor/).
