...
* 
* Front matter
* Containing [structure](/documentation/articles/create-a-structure/)
...
CloudCannon [structures](/documentation/articles/create-a-structure/) are an easy way to support a set of predefined objects. For example, you might have a structure that allows your content team to add photo galleries, testimonials, image and text blocks, or CTAs to a page.
...
For more examples, visit our documentation on [defining your structures](/documentation/articles/create-a-structure/).
