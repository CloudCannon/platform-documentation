...
<comp.DocsImage path="https://cc-dam.imgix.net/documentation/CloudCannon-Getting-Started-Structure-Modal.png" alt="" title="Structure modal for adding snippets" type="ui-snippet"/>
