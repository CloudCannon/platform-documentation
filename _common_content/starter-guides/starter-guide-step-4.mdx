...
The global configuration file is one of many places to set your website’s configuration. This file is the broadest in scope and the lowest priority - configurations setting specified here affect the entire site, but more specific settings from other sources can override these. This [configuration cascade](https://cloudcannon.com/documentation/articles/using-the-configuration-cascade/) allows you to have fine control over your site configuration.

The configuration cascade sources are as follows, from lowest priority to highest:

* [Global configuration](https://cloudcannon.com/documentation/articles/setting-global-configuration/)
* [Collection configuration](https://cloudcannon.com/documentation/articles/defining-your-collections/)
* [Schema configuration](https://cloudcannon.com/documentation/articles/creating-collection-schemas/)
* Front matter
* Containing&nbsp;[structure](https://cloudcannon.com/documentation/articles/defining-what-adds-to-an-array-with-array-structures/)
...
Let’s set up a `cloudcannon.config.yaml` global configuration file in your source directory using the CloudCannon configuration GUI.
...
The first section of the configuration GUI will help you [define your collections](https://cloudcannon.com/documentation/articles/defining-your-collections/). Each section of the GUI links to the CloudCannon documentation for that feature.
...
For more examples, visit our documentation on [customizing your inputs](https://cloudcannon.com/documentation/articles/how-to-choose-what-input-is-used-in-the-data-editor/).
...
Read our documentation on [input types](https://cloudcannon.com/documentation/articles/how-to-choose-what-input-is-used-in-the-data-editor/#type) for a complete list of our naming conventions.
...
CloudCannon&nbsp;[Structures](https://cloudcannon.com/documentation/articles/defining-what-adds-to-an-array-with-array-structures/)&nbsp;are an easy way to support a set of predefined objects. For example, you might have a structure that allows your content team to add photo galleries, testimonials, image and text blocks, or CTAs to a page.
...
For more examples, visit our documentation on [defining your structures](https://cloudcannon.com/documentation/articles/defining-what-adds-to-an-array-with-array-structures/).
...
Use [schemas](https://cloudcannon.com/documentation/articles/creating-collection-schemas/) to keep your files consistent. Configuring your schemas for each collection will help you to:
...
In your schema, you [define the inputs for the front matter of all files using this schema](https://cloudcannon.com/documentation/articles/defining-the-default-contents-of-new-files/).
...
Once you have created your schemas, you can configure each collection to reference a particular schema in the configuration GUI. New files in that collection will automatically have the correct front matter. When you edit an existing file in a collection with a defined schema, the front matter will update to <a rel="noopener noreferrer" href="https://cloudcannon.com/documentation/articles/keeping-content-consistent-across-files-in-a-collection/">keep data consistent</a>.
...
You can further [customize your ‘+ Add’ button](https://cloudcannon.com/documentation/articles/defining-more-ways-to-add-new-files/) through `add_options`; however, this isn’t necessary to get started on CloudCannon.
...
Once you have finished making edits to your [CloudCannon configuration file](https://cloudcannon.com/documentation/articles/setting-global-configuration/), you can save your changes using the ‘Save’ button in the top right corner of the configuration GUI.

CloudCannon will push your `cloudcannon.config.yaml` file back to your repository, and your site will rebuild automatically!
