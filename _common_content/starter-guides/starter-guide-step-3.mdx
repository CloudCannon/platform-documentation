...
parameters:
  SSG_Name:
    ...
    type: text
---
<comp.Slot name="SSG_Organization_Structure_Strict"></comp.Slot>

<comp.Slot name="SSG_Organization_Structure_Flexible"></comp.Slot>
...
If you need another supported format, [get in touch with our support team](https://cloudcannon.com/documentation/support/), and we would be happy to look into it.
