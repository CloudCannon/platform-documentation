...
<comp.Slot name="Intro-and-Hosting-paragraphs">
  ...
  All sites receive an SSL certificate, can easily scale to handle any amount of traffic, and offer [custom routing](/documentation/articles/configure-custom-routing/), [form submissions](/documentation/articles/what-is-a-form/), and [various authentication options](/documentation/articles/what-is-authentication/).
</comp.Slot>
