...
<comp.Slot name="Intro-and-Hosting-paragraphs">
  ...
  All sites receive an SSL certificate, can easily scale to handle any amount of traffic, and offer [custom routing](/documentation/articles/configure-custom-routing/), <a href="https://cloudcannon.com/documentation/articles/getting-started-with-forms-on-cloudcannon/" target="_blank" rel="noopener">form submissions</a>, and [various authentication options](/documentation/articles/what-is-authentication/).
</comp.Slot>
