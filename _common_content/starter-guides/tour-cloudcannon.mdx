...
<comp.Slot name="Site-Navigation-tour">
  ...
  * **The Live site preview button** — Opens your [Testing Domain](/documentation/articles/testing-domain/) or your [Custom Domain](/documentation/articles/what-is-a-custom-domain/), if you have one.
