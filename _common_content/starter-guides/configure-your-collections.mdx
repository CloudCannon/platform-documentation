...
<comp.Slot name="Collection-appearance-configuration">
  ...
  Here's an example. On this Site, we have five Collections, three of which output to pages on our website (Pages, Blog, and Products) and two containing data files (Data and Staff Members). Let's configure how these Collections appear in the *Site Navigation*. You can follow along and update the appearance of your own Collections as we go.
  ...
  To add Collection Groups, navigate to the *Collection Groups*
  ...
  Click the *\+ Add Collection* button to create a new Text input in the *Collections* array. Enter the Collection key name (i.e., not the display name) for each Collection you want to include in the

  You can reorder the Collections in this array to control the order in your *Site Navigation*.
