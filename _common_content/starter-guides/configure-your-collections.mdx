...
<comp.Slot name="Collection-appearance-configuration">
  ...
  First, let's open the Staff Members Collection. There are four sections inside each Collection: *Collection setup*, *Collection display*, *Collection editing interfaces*, and *Creating and updating pages*.
...
<comp.Slot name="Schema-configuration">
  ...
  A <a href="/documentation/articles/what-is-a-schema/" target="_blank" rel="noopener">schema</a> is a predefined template determining what should populate a Collection file. You can configure several schemas for each Collection, creating a list of file templates for you and your team. You can select a schema using the *\+ Add* button dropdown in the top right of your *Collection browser*. In the image below, "Blog Post" and "Customer Story" are two schemas for the Blog Collection.
  ...
  Next, let's connect our `blog-post.md` schema to to the Blog Collection.
  ...
  Click the *\+ Add Schema* button to open the *Add Schema* modal. Enter the name of your Schema in the *New key name* text input, and click the *Add* button.

  &nbsp;

  Let's open the Blog Collection.
</comp.Slot>
