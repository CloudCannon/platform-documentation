...
<comp.Slot name="Schema-configuration">
  ...
  CloudCannon will automatically show your connected Schema in the *\+ Add* button dropdown for the relevant Collection, prefixed by the word "Add". CloudCannon will create a new file with the correct front matter fields when you click on this Schema option.
