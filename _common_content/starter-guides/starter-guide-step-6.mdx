...
If you are on a Team or Enterprise plan, you can also customize your own Permission Groups. [Custom Permission Groups](/documentation/articles/what-are-custom-permission-groups/) give you full control over which resources are in each Group and enable extra options for scope and exceptions.
