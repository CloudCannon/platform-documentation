...
/**
 * CodeBlockCopyButton - Copy to clipboard button for code blocks
 * 
 * Displays a copy button with an SVG icon that copies the provided code to clipboard
 * and shows a "copied" toast notification.
 */
export default function CodeBlockCopyButton({ codeEncoded }: CodeBlockCopyButtonProps) {
    return (
        <div className="c-code-block__copy">
            ...
            >
                <svg width="15" height="17" viewBox="0 0 15 17" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
