            ...
            <ul key={colIndex}>
              {column.items?.map((link, linkIndex) => (
                <li key={linkIndex}>
                  ...
                  {link.external && (
                    <img
                      src={helpers.icon("launch:outlined", "material")}
                      inline="true"
                    />
                  )}
                </li>
      ...
      >
        ...
        >
          ...
          <div className="status-message" alpine:class="indicator">
            ...
            <span x-text="`App Status: ${description}`">
              App Status: Check status page
            </span>
            <img
              src={helpers.icon("arrow_forward:filled", "material")}
              inline="true"
            />
          </div>
        </a>
        <div className="l-footer__banner--links">
          <div className="l-footer__banner--links-container">
            <div className="l-footer__banner--links__copyright">
              {footernav?.copyright}
            </div>
