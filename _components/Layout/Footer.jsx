export default function Footer({ footernav, helpers }) {
    const links = footernav?.links || [];
    const informationalLinks = footernav?.informational_links || [];
    const socialLinks = footernav?.social_links || [];
    
    return (
        <footer className="l-footer">
            <div className="l-footer__inner">
                <a href="https://cloudcannon.com" className="l-footer__emblem" aria-label="Go to cloudcannon.com">
                    <img src="/assets/img/cc-docs-logo.svg" className="l-footer__logo" alt="Go to cloudcannon.com" inline="true" />
                </a>
                        ...
                        <ul key={colIndex}>
                            {column.items?.map((link, linkIndex) => (
                                <li key={linkIndex}>
                                    ...
                                    {link.external && (
                                        <img src={helpers.icon("launch:outlined", "material")} inline="true" />
                                    )}
                                </li>
                            ))}
                        </ul>
            ...
            >
                ...
                <div className="l-footer__banner--links">
                    <div className="l-footer__banner--links-container">
                        <div className="l-footer__banner--links__copyright">{footernav?.copyright}</div>
                        <div className="l-footer__banner--links__informational-links">
                    ...
                    <div className="l-footer__banner--links__socials">
                        {socialLinks.map((link, index) => (
                            <a key={index} href={link.href}>
                                <img src={helpers.icon(`${link.logo}:brands`, "fontawesome")} inline="true" />
                            </a>
                        ))}
                    </div>
                </div>
