...
export function slugify(
  ...
  const shouldPrependLeadingUnderscore = options?.preserveLeadingUnderscore &&
    stringToSlugify.startsWith("_");
  const shouldAppendDash = options?.preserveTrailingDash &&
    stringToSlugify.endsWith("-");
