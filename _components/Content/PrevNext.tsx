...
import type { Helpers, Details } from '../../_types.d.ts';
...
export default function PrevNext({ prev, next, guideIcon, guideTitle, details, totalPages, helpers }: PrevNextProps) {
    return (
        <>
            ...
            <div className="c-prev-next-mobile">
                ...
                <div className="c-prev-next-mobile__info">
                    <div className="c-prev-next-mobile__pages">
                        {guideIcon && <img src={guideIcon} />} <span>{guideTitle}</span> ({details?.order}/{totalPages})
                    </div>
