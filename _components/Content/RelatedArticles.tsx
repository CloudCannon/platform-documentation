...
import type { Helpers, Details, PageSearch, ArticlePage } from '../../_types.d.ts';
...
export default async function RelatedArticles({ details, search, helpers }: RelatedArticlesProps) {
