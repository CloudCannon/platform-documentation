/**
 * TabsCopyButton - Copy to clipboard button for tabs content
 *
 * Unlike CodeBlockCopyButton which takes pre-encoded content,
 * this component extracts text from the currently visible tab panel at runtime.
 */
export default function TabsCopyButton() {
  // Alpine.js expression to find visible panel and copy only the code content
  const copyHandler = `
